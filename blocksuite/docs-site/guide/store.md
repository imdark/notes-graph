...
```ts
import { NotesGraphSchemas } from '@blocksuite/blocks/models';
...
export function createEmptyDoc() {
  ...
  return {
    ...
    async init() {
      await doc.load(() => {
        const rootBlockId = doc.addBlock('notesgraph:page', {});
        doc.addBlock('notesgraph:surface', {}, rootBlockId);
        const noteId = doc.addBlock('notesgraph:note', {}, rootBlockId);
