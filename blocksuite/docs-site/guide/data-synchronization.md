...
::: info
🌐 This documentation has a [Chinese translation](https://insider.notesgraph.com/share/af3478a2-9c9c-4d16-864d-bffa1eb10eb6/xiObHbAC0yUb7HmX4-fjg).
:::
...
```ts
import { NotesGraphSchemas } from '@blocksuite/blocks';
import { NotesGraphEditorContainer } from '@blocksuite/presets';
...
const editor = new NotesGraphEditorContainer();
editor.doc = doc;
...
function createDoc() {
  ...
  doc.load(() => {
    ...
    const noteId = doc.addBlock('notesgraph:note', {}, pageBlockId);
    doc.addBlock('notesgraph:paragraph', { text: new Text('Hello World!') }, noteId);
  });
}
