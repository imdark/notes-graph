...
Regarding how BlockSuite components can be used in NotesGraph and other applications, here are some quick takeaways:

- The BlockSuite editor consists of various block specs, each of which can optionally include some widgets. Therefore, **when you are reusing an existing first-party BlockSuite editor, you are actually reusing a preset of blocks and widgets**. Default editors are fine-tuned presets for NotesGraph, but you are free to compose you own presets.
...
- BlockSuite does not have special variants for NotesGraph, [we eat our own dogfood](https://gist.github.com/chitchcock/1281611).
