...
import type { BaseSelection, Workspace } from '@blocksuite/notesgraph/store';
...
export function mockDocModeService(editor: TestNotesGraphEditorContainer) {
...
export function mockNotificationService(editor: TestNotesGraphEditorContainer) {
