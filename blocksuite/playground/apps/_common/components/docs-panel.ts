...
import { GenerateDocUrlProvider } from '@blocksuite/notesgraph/shared/services';
import { createDefaultDoc } from '@blocksuite/notesgraph/shared/utils';
import { ShadowlessElement } from '@blocksuite/notesgraph/std';
import type { Doc, Workspace } from '@blocksuite/notesgraph/store';
...
export class DocsPanel extends WithDisposable(ShadowlessElement) {
  static override styles = css`
    ...
    .delete-doc-icon svg {
      width: 14px;
      height: 14px;
      color: var(--notesgraph-secondary-color);
      fill: var(--notesgraph-secondary-color);
    }
    .new-doc-button {
      margin-bottom: 16px;
