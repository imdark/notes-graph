import type { StoreExtensionManager } from '@blocksuite/notesgraph/ext-loader';
import { NotesGraphSchemas } from '@blocksuite/notesgraph/schemas';
import { nanoid, Schema, Transformer } from '@blocksuite/notesgraph/store';
import {
  createAutoIncrementIdGenerator,
  type DocCollectionOptions,
  TestWorkspace,
} from '@blocksuite/notesgraph/store/test';
import {
  type BlobSource,
  ...
  IndexedDBBlobSource,
  MemoryBlobSource,
} from '@blocksuite/notesgraph/sync';
...
export function createStarterDocCollection(
  ...
  window.blockSchemas = NotesGraphSchemas;
