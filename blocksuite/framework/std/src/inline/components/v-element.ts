...
> extends SignalWatcher(LitElement) {
  ...
  override async getUpdateComplete(): Promise<boolean> {
    ...
    // The inner span / its child can be absent when this v-element is being
    // rendered while detached (e.g. a source block's inline editor updated by a
    // cross-doc write during a kanban card drag). Guard rather than throw, which
    // would abort the render and leave the UI un-updated.
