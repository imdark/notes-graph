...
export type InlineMarkdownMatchAction<
  // @ts-expect-error We allow to covariance for NotesGraphTextAttributes
  in NotesGraphTextAttributes extends BaseTextAttributes = BaseTextAttributes,
> = (props: {
...
export type InlineMarkdownMatch<
  NotesGraphTextAttributes extends BaseTextAttributes = BaseTextAttributes,
> = {
  name: string;
  pattern: RegExp;
  action: InlineMarkdownMatchAction<NotesGraphTextAttributes>;
};
