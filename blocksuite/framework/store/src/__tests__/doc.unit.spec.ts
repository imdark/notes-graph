...
test('query', () => {
  ...
  const page = store1.addBlock('notesgraph:page');
  const note = store1.addBlock('notesgraph:note', {}, page);
  const paragraph1 = store1.addBlock('notesgraph:paragraph', {}, note);
  const list1 = store1.addBlock('notesgraph:list' as never, {}, note);
  ...
  const list2 = store1.addBlock('notesgraph:list' as never, {}, note);
