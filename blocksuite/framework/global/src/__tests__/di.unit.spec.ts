...
describe('di', () => {
  ...
  test('scope', () => {
    ...
    expect(root.get(System).appName).toEqual('notesgraph');
    ...
    expect(workspace.get(System).appName).toEqual('notesgraph');
    ...
    expect(page.get(System).appName).toEqual('notesgraph');
