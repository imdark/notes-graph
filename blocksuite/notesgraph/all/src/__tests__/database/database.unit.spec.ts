...
describe('DatabaseManager', () => {
  ...
  const selection = [
    { id: '1', value: 'Done', color: 'var(--notesgraph-tag-white)' },
    { id: '2', value: 'TODO', color: 'var(--notesgraph-tag-pink)' },
    { id: '3', value: 'WIP', color: 'var(--notesgraph-tag-blue)' },
  ];
  ...
  beforeEach(() => {
    ...
    noteBlockId = doc.addBlock('notesgraph:note', {}, rootId);
