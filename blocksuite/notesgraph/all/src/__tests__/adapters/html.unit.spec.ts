import { DefaultTheme, NoteDisplayMode } from '@blocksuite/notesgraph-model';
import {
...
describe('snapshot to html', () => {
  ...
  const paragraphTemplate = (html: string) =>
    `<div class="notesgraph-paragraph-block-container">${html}<div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div>`;
  ...
  test('paragraph', async () => {
    ...
    const html = template(
      `<div class="notesgraph-paragraph-block-container"><p>aaa</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"><div class="notesgraph-paragraph-block-container"><p>bbb</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div><div class="notesgraph-paragraph-block-container"><p>ccc</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"><div class="notesgraph-paragraph-block-container"><p>ddd</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div><div class="notesgraph-paragraph-block-container"><p>eee</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div><div class="notesgraph-paragraph-block-container"><p>fff</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div></div></div><div class="notesgraph-paragraph-block-container"><p>ggg</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div></div></div><div class="notesgraph-paragraph-block-container"><p>hhh</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div>`
    );
  ...
  test('bulleted list', async () => {
    ...
    const html = template(
      `<ul class="bulleted-list"><li class="notesgraph-list-block-container">aaa<ul class="bulleted-list"><li class="notesgraph-list-block-container">bbb<ul class="bulleted-list"><li class="notesgraph-list-block-container">ccc</li></ul></li><li class="notesgraph-list-block-container">ddd</li></ul></li><li class="notesgraph-list-block-container">eee</li></ul>`
    );
  ...
  test('different list', async () => {
    ...
    const html = template(
      `<ul class="bulleted-list"><li class="notesgraph-list-block-container">aaa</li></ul><ul style="list-style-type: none; padding-inline-start: 18px;" class="todo-list"><li class="notesgraph-list-block-container"><input type="checkbox"><label style="margin-right: 3px;"></label></input>bbb</li></ul><ul class="bulleted-list"><li class="notesgraph-list-block-container">ccc</li></ul>`
    );
  ...
  test('code inline', async () => {
    ...
    const html = template(
      `<div class="notesgraph-paragraph-block-container"><p>aaa <code>bbb</code> ccc</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div>`
    );
  ...
  test('link', async () => {
    ...
    const html = template(
      `<div class="notesgraph-paragraph-block-container"><p>aaa <a href="https://notesgraph.com/">bbb</a> ccc</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div>`
    );
  ...
  test('bold', async () => {
    ...
    const html = template(
      `<div class="notesgraph-paragraph-block-container"><p>aaa<strong>bbb</strong>ccc</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div>`
    );
  ...
  test('italic', async () => {
    ...
    const html = template(
      `<div class="notesgraph-paragraph-block-container"><p>aaa<em>bbb</em>ccc</p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div>`
    );
  ...
  test('image', async () => {
    ...
    const html = template(
      `<figure class="notesgraph-image-block-container"><img src="assets/YXXTjRmLlNyiOUnHb8nAIvUP6V7PAXhwW9F5_tc2LGs=.blob" alt="YXXTjRmLlNyiOUnHb8nAIvUP6V7PAXhwW9F5_tc2LGs=.blob" title="aaa"></figure><div class="notesgraph-paragraph-block-container"><p></p><div class="notesgraph-block-children-container" style="padding-left: 26px;"></div></div>`
    );
  ...
  describe('embed link block', () => {
    ...
    for (const testCase of embedTestCases) {
      test(testCase.name, async () => {
        ...
        const html = template(
          `<div class="notesgraph-paragraph-block-container"><a href="${testCase.url}">${testCase.title}</a></div>`
        );
                  ...
                  },
                  {
                    ...
                    data: {
                      options: [
                        {
                          id: 'TKip9uc7Yx',
                          color: 'var(--notesgraph-tag-white)',
                          value: 'TODO',
                        },
                        {
                          id: 'F2bgsaE3X2',
                          color: 'var(--notesgraph-tag-green)',
                          value: 'In Progress',
                        },
                        {
                          id: 'y3O1A2IHHu',
                          color: 'var(--notesgraph-tag-gray)',
                          value: 'Done',
                        },
                      ],
                    },
                      ...
                      options: [
                        {
                          id: '73UrEZWaKk',
                          value: 'test2',
                          color: 'var(--notesgraph-tag-purple)',
                        },
                        {
                          id: '-2_QD3GZT1',
                          value: 'test1',
                          color: 'var(--notesgraph-tag-teal)',
                        },
                      ],
                    },
                    id: 'block:DPhZ6JBziD',
  ...
  test('linked doc block', async () => {
    ...
    const html = template(
      '<div class="notesgraph-paragraph-block-container"><a href="https://example.com/4T5ObMgEIMII-4Bexyta1?mode=page&#x26;blockIds=abc%2C123&#x26;elementIds=def%2C456&#x26;databaseId=deadbeef&#x26;databaseRowId=123">Test Doc</a></div>'
    );
  ...
  test('synced doc block', async () => {
            ...
            props: {
              ...
              edgeless: {
                style: {
                  ...
                  borderSize: 4,
                  borderStyle: 'solid',
                  shadowType: '--notesgraph-note-shadow-box',
                },
              },
            },
            children: [
      ...
      blocks: {
        ...
        children: [
          ...
          },
          {
            ...
            props: {
              xywh: '[0,0,800,95]',
              background: '--notesgraph-note-background-blue',
              index: 'a0',
              hidden: false,
              displayMode: 'both',
              edgeless: {
                style: {
                  ...
                  borderSize: 4,
                  borderStyle: 'none',
                  shadowType: '--notesgraph-note-shadow-sticker',
                },
              },
            },
            children: [
    ...
    const docHtml = template(
      paragraphTemplate('<p>Hello</p>') +
        syncedDocHtml +
        '<div class="notesgraph-paragraph-block-container"><p>Deepest Doc</p></div>' +
