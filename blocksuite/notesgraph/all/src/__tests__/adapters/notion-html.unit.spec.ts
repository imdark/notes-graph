...
import { DEFAULT_IMAGE_PROXY_ENDPOINT } from '@blocksuite/notesgraph-shared/consts';
import {
  AssetsManager,
  type BlockSnapshot,
  MemoryBlobCRUD,
...
describe('notion html to snapshot', () => {
  ...
  test('bookmark', async () => {
    const html = `<div class="page-body">
      <figure id="ed3d2ae9-62f5-433a-9049-9ddbd1c81ac5"><a href="https://notesgraph.com/" class="bookmark source">
          <div class="bookmark-info">
            <div class="bookmark-text">
              <div class="bookmark-title">NotesGraph - All In One KnowledgeOS</div>
              <div class="bookmark-description">The universal editor that lets you work, play, present or
                create just about anything.</div>
            </div>
            <div class="bookmark-href"><img src="https://notesgraph.com/favicon-96.png"
                class="icon bookmark-icon" />https://notesgraph.com/</div>
          </div><img src="https://notesgraph.com/og.png" class="bookmark-image" />
        </a></figure>
    </div>`;
      ...
      children: [
        {
          ...
          props: {
            type: 'card',
            url: 'https://notesgraph.com/',
            title: 'NotesGraph - All In One KnowledgeOS',
            description:
              'The universal editor that lets you work, play, present or create just about anything.',
            icon: 'https://notesgraph.com/favicon-96.png',
          },
          children: [],
        },
      ],
          ...
          <tbody>
            <tr id="ed3d2ae9-62f5-433a-9049-9ddbd1c81ac5">
              <td class="cell-title"><a
                  href="https://www.notion.so/https-notesgraph-pro-ed3d2ae962f5433a90499ddbd1c81ac5?pvs=21">https://notesgraph.com</a>
              </td>
          ...
          children: [
            {
              ...
              props: {
                text: {
                  ...
                  delta: [
                    {
                      insert: 'https://notesgraph.com',
                      attributes: {
                        link: 'https://www.notion.so/https-notesgraph-pro-ed3d2ae962f5433a90499ddbd1c81ac5?pvs=21',
                      },
                    },
                  ],
                },
