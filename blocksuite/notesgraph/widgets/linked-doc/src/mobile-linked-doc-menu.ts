...
import { VirtualKeyboardProvider } from '@blocksuite/notesgraph-shared/services';
...
export const NOTESGRAPH_MOBILE_LINKED_DOC_MENU =
  'notesgraph-mobile-linked-doc-menu';

@requiredProperties({
  context: PropTypes.object,
})
export class NotesGraphMobileLinkedDocMenu extends SignalWatcher(
