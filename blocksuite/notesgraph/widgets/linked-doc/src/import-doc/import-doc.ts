...
export class ImportDoc extends WithDisposable(LitElement) {
  ...
  private _openLearnImportLink(event: MouseEvent) {
    event.stopPropagation();
    window.open(
      'https://notesgraph.com/blog/import-your-data-from-notion-into-notesgraph',
      '_blank'
    );
  }
  ...
  override render() {
    ...
    return html`
      ...
      <div class="container">
        ...
        <div>
          NotesGraph will gradually support more file formats for import.
          <a href="https://notesgraph.com/redirect/discord" target="_blank"
            >Provide feedback.</a
          >
        </div>
        ...
        <div class="button-container">
          ...
          >
            ...
            >
              ${HelpIcon}
              <notesgraph-tooltip>
                Learn how to Import your Notion pages into NotesGraph.
              </notesgraph-tooltip>
            </div>
          </icon-button>
          <icon-button
        ...
        <!-- <div class="footer">
        <div>Migrate from other versions of NotesGraph?</div>
      </div> -->
      </div>
    `;
  }
