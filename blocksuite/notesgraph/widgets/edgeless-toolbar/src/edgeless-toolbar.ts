...
import { ColorScheme, type RootBlockModel } from '@blocksuite/notesgraph-model';
import {
  EditPropsStore,
  ThemeProvider,
    ...
    return html`
      ...
      <div class="quick-tool-more">
        ...
        >
          ...
          <notesgraph-tooltip tip-position="top" .offset=${25}>
            More Tools
          </notesgraph-tooltip>
        </icon-button>
      </div>
        ...
        >
          ...
          ${cache(
            this._seniorPrevTooltip
              ? html` <notesgraph-tooltip tip-position="top" .offset=${4}>
                  ${this._seniorPrevTooltip}
                </notesgraph-tooltip>`
              : nothing
          )}
      ...
      >
        ...
        >
          <smooth-corner
            ...
            .smooth=${0.7}
            .borderWidth=${1}
            .bgColor=${'var(--notesgraph-background-overlay-panel-color)'}
            .borderColor=${'var(--notesgraph-border-color)'}
