...
export const NOTESGRAPH_SCROLL_ANCHORING_WIDGET =
  'notesgraph-scroll-anchoring-widget';

export class NotesGraphScrollAnchoringWidget extends WidgetComponent {
  ...
  #moveToAnchorInEdgeless(id: string) {
    ...
    if (parentComponent && parentComponent.flavour === 'notesgraph:note') {
