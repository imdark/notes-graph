...
export const NOTESGRAPH_KEYBOARD_TOOL_PANEL = 'notesgraph-keyboard-tool-panel';

@requiredProperties({
  context: PropTypes.object,
})
export class NotesGraphKeyboardToolPanel extends SignalWatcher(
  ...
  override render() {
    ...
    return html`<div class="notesgraph-keyboard-tool-panel-container">
      ${repeat(
        groups,
        group => group.name,
