...
import { type VirtualKeyboardProviderWithAction } from '@blocksuite/notesgraph-shared/services';
import {
  BlockComponent,
  PropTypes,
  requiredProperties,
...
export class NotesGraphKeyboardToolbar extends SignalWatcher(
  ...
  override render() {
    return html`
      ...
      <notesgraph-keyboard-tool-panel
