...
import { getDocTitleByEditorHost } from '@blocksuite/notesgraph-fragment-doc-title';
...
export const NOTESGRAPH_KEYBOARD_TOOLBAR_WIDGET =
  'notesgraph-keyboard-toolbar-widget';

export class NotesGraphKeyboardToolbarWidget extends WidgetComponent<RootBlockModel> {
  ...
  override render() {
    ...
    return html`<blocksuite-portal
      .shadowDom=${false}
      .template=${html`<notesgraph-keyboard-toolbar
...
export const keyboardToolbarWidget = WidgetViewExtension(
  ...
  literal`${unsafeStatic(NOTESGRAPH_KEYBOARD_TOOLBAR_WIDGET)}`
);

declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_KEYBOARD_TOOLBAR_WIDGET]: NotesGraphKeyboardToolbarWidget;
  }
}
