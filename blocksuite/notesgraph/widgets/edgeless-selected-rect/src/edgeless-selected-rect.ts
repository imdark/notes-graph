...
import { type FrameOverlay } from '@blocksuite/notesgraph-block-frame';
import {
...
import type { SelectedRect } from '@blocksuite/notesgraph-shared/types';
import {
  getSelectedRect,
...
export class EdgelessSelectedRectWidget extends WidgetComponent<RootBlockModel> {
  ...
  static override styles = css`
    ...
    .notesgraph-edgeless-selected-rect {
      position: absolute;
      top: 0;
      left: 0;
      ...
      z-index: 1;
      border-color: var(--notesgraph-blue);
      border-width: 2px;
      border-style: solid;
      transform: translate(0, 0) rotate(0);
    }

    .notesgraph-edgeless-selected-rect[data-locked='true'] {
      border-color: ${unsafeCSSVarV2('edgeless/lock/locked', '#00000085')};
    }

    .notesgraph-edgeless-selected-rect .handle {
      position: absolute;
      user-select: none;
      outline: none;
      pointer-events: auto;
    ...
    .notesgraph-edgeless-selected-rect .handle[aria-label^='top-'],
    .notesgraph-edgeless-selected-rect .handle[aria-label^='bottom-'] {
      width: 18px;
      height: 18px;
      box-sizing: border-box;
      z-index: 10;
    ...
    .notesgraph-edgeless-selected-rect .handle[aria-label^='top-'] .resize,
    .notesgraph-edgeless-selected-rect .handle[aria-label^='bottom-'] .resize {
      position: absolute;
      width: 12px;
      height: 12px;
      box-sizing: border-box;
      border-radius: 50%;
      border: 2px var(--notesgraph-blue) solid;
      background: white;
    }

    .notesgraph-edgeless-selected-rect .handle[aria-label^='top-'] .rotate,
    .notesgraph-edgeless-selected-rect .handle[aria-label^='bottom-'] .rotate {
      position: absolute;
      width: 12px;
      height: 12px;
      box-sizing: border-box;
    ...
    /* -18 + 6.5 */
    .notesgraph-edgeless-selected-rect .handle[aria-label='top-left'] {
      left: -12px;
      top: -12px;
    }
    .notesgraph-edgeless-selected-rect .handle[aria-label='top-left'] .resize {
      right: 0;
      bottom: 0;
    }
    .notesgraph-edgeless-selected-rect .handle[aria-label='top-left'] .rotate {
      right: 6px;
      bottom: 6px;
    }

    .notesgraph-edgeless-selected-rect .handle[aria-label='top-right'] {
      top: -12px;
      right: -12px;
    }
    .notesgraph-edgeless-selected-rect .handle[aria-label='top-right'] .resize {
      left: 0;
      bottom: 0;
    }
    .notesgraph-edgeless-selected-rect .handle[aria-label='top-right'] .rotate {
      left: 6px;
      bottom: 6px;
    }

    .notesgraph-edgeless-selected-rect .handle[aria-label='bottom-right'] {
      right: -12px;
      bottom: -12px;
    }
    .notesgraph-edgeless-selected-rect
    ...
    .notesgraph-edgeless-selected-rect .handle[aria-label='bottom-left'] {
      bottom: -12px;
      left: -12px;
    }
    .notesgraph-edgeless-selected-rect
    ...
    .notesgraph-edgeless-selected-rect .handle[aria-label='top'],
    .notesgraph-edgeless-selected-rect .handle[aria-label='bottom'],
    .notesgraph-edgeless-selected-rect .handle[aria-label='left'],
    .notesgraph-edgeless-selected-rect .handle[aria-label='right'] {
      border: 0;
      background: transparent;
      border-color: var('--notesgraph-blue');
    }
    ...
    .notesgraph-edgeless-selected-rect .handle[aria-label='top'] .resize,
    .notesgraph-edgeless-selected-rect .handle[aria-label='bottom'] .resize,
    .notesgraph-edgeless-selected-rect .handle[aria-label='left'] .resize,
    .notesgraph-edgeless-selected-rect .handle[aria-label='right'] .resize {
      width: 100%;
      height: 100%;
    }

    .notesgraph-edgeless-selected-rect .handle[aria-label='top'] .resize:after,
    .notesgraph-edgeless-selected-rect
      .handle[aria-label='bottom']
      .resize:after,
    .notesgraph-edgeless-selected-rect .handle[aria-label='left'] .resize:after,
    .notesgraph-edgeless-selected-rect
    ...
    .notesgraph-edgeless-selected-rect .handle .resize::before {
      content: '';
      display: none;
      position: absolute;
      width: 20px;
    ...
    .notesgraph-edgeless-selected-rect[data-mode='scale']
      .handle[aria-label='top-left']
      .resize:hover::before,
    .notesgraph-edgeless-selected-rect[data-scale-direction='top-left'][data-scale-percent]
      .handle[aria-label='top-left']
      .resize::before {
      display: block;
      top: 0px;
    ...
    .notesgraph-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .notesgraph-edgeless-selected-rect[data-scale-direction='top-right'][data-scale-percent]
      .handle[aria-label='top-right']
      .resize::before {
      display: block;
      top: 0px;
    ...
    .notesgraph-edgeless-selected-rect[data-mode='scale']
      .handle[aria-label='bottom-right']
      .resize:hover::before,
    .notesgraph-edgeless-selected-rect[data-scale-direction='bottom-right'][data-scale-percent]
      .handle[aria-label='bottom-right']
      .resize::before {
      display: block;
      bottom: 0px;
    ...
    .notesgraph-edgeless-selected-rect[data-mode='scale']
      .handle[aria-label='bottom-left']
      .resize:hover::before,
    .notesgraph-edgeless-selected-rect[data-scale-direction='bottom-left'][data-scale-percent]
      .handle[aria-label='bottom-left']
      .resize::before {
      display: block;
      bottom: 0px;
    ...
    .notesgraph-edgeless-selected-rect::after {
    ...
    .notesgraph-edgeless-selected-rect[data-scale-direction='top-left']::after {
      display: block;
      top: -20px;
      left: -20px;
      transform: translate(-100%, -100%);
    }
    .notesgraph-edgeless-selected-rect[data-scale-direction='top-right']::after {
      display: block;
      top: -20px;
      right: -20px;
      transform: translate(100%, -100%);
    }
    .notesgraph-edgeless-selected-rect[data-scale-direction='bottom-right']::after {
      display: block;
      bottom: -20px;
      right: -20px;
      transform: translate(100%, 100%);
    }
    .notesgraph-edgeless-selected-rect[data-scale-direction='bottom-left']::after {
      display: block;
      bottom: -20px;
      left: -20px;
      transform: translate(-100%, 100%);
  ...
  override render() {
    ...
    return html`
      <style>
        .notesgraph-edgeless-selected-rect .handle[aria-label='right']::after {
          content: '';
          ...
          width: 2px;
          height: 100%;
          background: var(--notesgraph-error-color);
          filter: drop-shadow(-6px 0px 12px rgba(235, 67, 53, 0.35));
        }

        .notesgraph-edgeless-selected-rect .handle[aria-label='bottom']::after {
          content: '';
      ...
      <div
        class="notesgraph-edgeless-selected-rect"
        style=${styleMap({
