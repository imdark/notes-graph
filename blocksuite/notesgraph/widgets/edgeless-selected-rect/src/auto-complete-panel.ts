...
import { FontFamilyIcon } from '@blocksuite/notesgraph-components/icons';
import {
...
export class EdgelessAutoCompletePanel extends WithDisposable(LitElement) {
  ...
  private _addNote() {
    ...
    store.addBlock('notesgraph:paragraph', { type: 'text' }, id);
  ...
  private _showFrameOverlay() {
    ...
    const strokeColor = this.std
      .get(ThemeProvider)
      .getCssVariableColor('--notesgraph-black-30');
