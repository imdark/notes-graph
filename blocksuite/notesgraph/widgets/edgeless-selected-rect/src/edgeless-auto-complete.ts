...
import { mountShapeTextEditor } from '@blocksuite/notesgraph-gfx-shape';
import type {
  Connection,
...
import { ToolbarRegistryIdentifier } from '@blocksuite/notesgraph-shared/services';
import type { SelectedRect } from '@blocksuite/notesgraph-shared/types';
import { handleNativeRangeAtPoint } from '@blocksuite/notesgraph-shared/utils';
import {
  type BlockComponent,
  type BlockStdScope,
  stdContext,
...
export class EdgelessAutoComplete extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .edgeless-auto-complete-arrow-wrapper
      ...
      border: 1px solid var(--notesgraph-white-10);
      box-shadow: var(--notesgraph-shadow-1);
