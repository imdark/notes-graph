...
import { getSelectionRectsCommand } from '@blocksuite/notesgraph-shared/commands';
import { EMBED_BLOCK_MODEL_LIST } from '@blocksuite/notesgraph-shared/consts';
...
export const NOTESGRAPH_DOC_REMOTE_SELECTION_WIDGET =
  'notesgraph-doc-remote-selection-widget';

export class NotesGraphDocRemoteSelectionWidget extends WidgetComponent {
  ...
  private _getCursorRect(selections: BaseSelection[]): SelectionRect | null {
    ...
    if (this.block.model.flavour !== 'notesgraph:page') {
                ...
                >
                  <div
                    style="${styleMap({
                      ...
                      maxWidth: '160px',
                      padding: '0 3px',
                      border: '1px solid var(--notesgraph-pure-black-20)',
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_DOC_REMOTE_SELECTION_WIDGET]: NotesGraphDocRemoteSelectionWidget;
  }
}
