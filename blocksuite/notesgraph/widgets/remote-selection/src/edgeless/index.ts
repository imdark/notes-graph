...
export const NOTESGRAPH_EDGELESS_REMOTE_SELECTION_WIDGET =
  'notesgraph-edgeless-remote-selection-widget';
...
export class EdgelessRemoteSelectionWidget extends WidgetComponent<RootBlockModel> {
  ...
  override render() {
    ...
    return html`
      <div class="notesgraph-edgeless-remote-selection">${rects}${cursors}</div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_EDGELESS_REMOTE_SELECTION_WIDGET]: EdgelessRemoteSelectionWidget;
  }
}
