...
export function effects() {
  customElements.define('notesgraph-menu', MenuComponent);
  customElements.define('mobile-menu', MobileMenuComponent);
  customElements.define('notesgraph-menu-button', MenuButton);
  customElements.define('mobile-menu-button', MobileMenuButton);
  customElements.define('notesgraph-menu-input', MenuInput);
  customElements.define('mobile-menu-input', MobileMenuInput);
  customElements.define('notesgraph-menu-sub-menu', MenuSubMenu);
