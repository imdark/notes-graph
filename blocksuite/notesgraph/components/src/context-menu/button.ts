...
export class MenuButton extends MenuFocusable {
  static override styles = css`
    ...
    .notesgraph-menu-button:hover,
    notesgraph-menu-button.active .notesgraph-menu-button {
      background-color: var(--notesgraph-hover-color);
    }

    .notesgraph-menu-button .notesgraph-menu-action-text {
      flex: 1;
      font-size: 14px;
      line-height: 22px;
    ...
    .notesgraph-menu-button.focused {
      outline: 1px solid ${unsafeCSS(cssVarV2.layer.insideBorder.primaryBorder)};
    }

    .notesgraph-menu-button.delete-item:hover {
      background-color: var(--notesgraph-background-error-color);
      color: var(--notesgraph-error-color);
    }

    .notesgraph-menu-button.delete-item:hover .notesgraph-menu-action-text {
      color: var(--notesgraph-error-color);
    }
  `;
...
export class MobileMenuButton extends MenuFocusable {
  static override styles = css`
    ...
    .mobile-menu-button .notesgraph-menu-action-text {
      flex: 1;
      color: var(--notesgraph-text-primary-color);
      font-size: 17px;
      line-height: 22px;
    ...
    menu => {
      ...
      const data: MenuButtonData = {
        content: () => {
          return html`
            ${config.prefix}
            <div class="notesgraph-menu-action-text">
