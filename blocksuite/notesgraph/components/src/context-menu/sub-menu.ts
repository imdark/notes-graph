...
export class MenuSubMenu extends MenuFocusable {
  static override styles = [
    MenuButton.styles,
    css`
      .notesgraph-menu-button svg:last-child {
        transition: transform 150ms cubic-bezier(0.42, 0, 1, 1);
      }
      notesgraph-menu-sub-menu.active .notesgraph-menu-button svg:last-child {
...
export const renderSubMenu = (data: MenuSubMenuData, menu: Menu) => {
  ...
  return html` <notesgraph-menu-sub-menu
    .data="${data}"
    .menu="${menu}"
  ></notesgraph-menu-sub-menu>`;
};
