import type { Color, ColorScheme, Palette } from '@blocksuite/notesgraph-model';
import { DefaultTheme, resolveColor } from '@blocksuite/notesgraph-model';
import { unsafeCSSVarV2 } from '@blocksuite/notesgraph-shared/theme';
import { ColorEvent } from '@blocksuite/notesgraph-shared/utils';
...
export class EdgelessColorButton extends LitElement {
  static override styles = css`
    ...
    :host([active])::after {
      border: 1.5px solid var(--notesgraph-primary-color);
    }
  `;
