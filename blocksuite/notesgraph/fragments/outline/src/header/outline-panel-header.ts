...
export const NOTESGRAPH_OUTLINE_PANEL_HEADER =
  'notesgraph-outline-panel-header';
  ...
  override render() {
    ...
    return html`<div class=${styles.container}>
      ...
      <div class=${styles.notePreviewSettingContainer}>
        <notesgraph-outline-note-preview-setting-menu></notesgraph-outline-note-preview-setting-menu>
      </div>`;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_OUTLINE_PANEL_HEADER]: OutlinePanelHeader;
  }
}
