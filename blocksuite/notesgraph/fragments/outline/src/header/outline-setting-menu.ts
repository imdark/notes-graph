...
export const NOTESGRAPH_OUTLINE_NOTE_PREVIEW_SETTING_MENU =
  'notesgraph-outline-note-preview-setting-menu';
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_OUTLINE_NOTE_PREVIEW_SETTING_MENU]: OutlineNotePreviewSettingMenu;
  }
}
