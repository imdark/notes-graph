...
import { NoteDisplayMode } from '@blocksuite/notesgraph-model';
...
export const NOTESGRAPH_OUTLINE_VIEWER = 'notesgraph-outline-viewer';
...
export class OutlineViewer extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .outline-viewer-indicator {
      ...
      border-radius: 1px;
      overflow: hidden;
      background: var(--notesgraph-black-10, rgba(0, 0, 0, 0.1));
    }

    .outline-viewer-indicator.active {
      width: 24px;
      background: var(--notesgraph-text-primary-color);
    }
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_OUTLINE_VIEWER]: OutlineViewer;
  }
}
