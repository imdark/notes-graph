...
export const NOTESGRAPH_OUTLINE_NOTE_CARD = 'notesgraph-outline-note-card';
    ...
    this.disposables.add(
      std.dnd.draggable<NoteCardEntity>({
        ...
        setDragPreview: ({ container, setOffset, location }) => {
          const preview = document.createElement(NOTESGRAPH_OUTLINE_NOTE_CARD);
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_OUTLINE_NOTE_CARD]: OutlineNoteCard;
  }
}
