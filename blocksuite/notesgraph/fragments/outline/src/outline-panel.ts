...
export const NOTESGRAPH_OUTLINE_PANEL = 'notesgraph-outline-panel';
...
export class OutlinePanel extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <notesgraph-outline-panel-header></notesgraph-outline-panel-header>
      <notesgraph-outline-panel-body> </notesgraph-outline-panel-body>
      <notesgraph-outline-notice></notesgraph-outline-notice>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_OUTLINE_PANEL]: OutlinePanel;
  }
}
