...
export const NOTESGRAPH_OUTLINE_NOTICE = 'notesgraph-outline-notice';
...
export class OutlineNotice extends SignalWatcher(
  ...
  override render() {
    ...
    return html`
      <div
        data-testid=${NOTESGRAPH_OUTLINE_NOTICE}
        class=${styles.outlineNotice}
      >
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_OUTLINE_NOTICE]: OutlineNotice;
  }
}
