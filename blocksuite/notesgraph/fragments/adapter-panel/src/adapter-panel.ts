...
export const NOTESGRAPH_ADAPTER_PANEL = 'notesgraph-adapter-panel';
  ...
  override render() {
    return html`
      <div class="adapters-container">
        ...
        ></notesgraph-adapter-panel-header>
        <notesgraph-adapter-panel-body></notesgraph-adapter-panel-body>
      </div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_ADAPTER_PANEL]: AdapterPanel;
  }
}
