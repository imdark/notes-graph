...
export const NOTESGRAPH_FRAME_TITLE_EDITOR =
  'notesgraph-frame-card-title-editor';
...
export class FrameCardTitleEditor extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    const inlineEditorStyle = styleMap({
      ...
      width: 'fit-content',
      height: '20px',
      fontSize: 'var(--notesgraph-font-sm)',
      lineHeight: '20px',
      position: 'absolute',
      left: `${this.left}px`,
      top: '0px',
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_FRAME_TITLE_EDITOR]: FrameCardTitleEditor;
  }
}
