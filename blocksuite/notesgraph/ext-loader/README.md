...
Blocksuite extension loader system for NotesGraph, providing a structured way to manage and load extensions in different contexts.
...
```typescript
import { BaseExtensionProvider } from '@blocksuite/notesgraph-ext-loader';
import { z } from 'zod';
...
```typescript
import { StoreExtensionProvider, StoreExtensionManager } from '@blocksuite/notesgraph-ext-loader';
import { z } from 'zod';
...
```typescript
import { ViewExtensionProvider, ViewExtensionManager } from '@blocksuite/notesgraph-ext-loader';
import { z } from 'zod';
