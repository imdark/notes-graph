...
import { rangeWrap } from '@blocksuite/notesgraph-shared/utils';
...
const TABLE_CELL_HOST_SELECTOR =
  'dv-table-view-cell-container, notesgraph-database-virtual-cell-container';
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-multi-tag-select': MultiTagSelect;
  }
}
