...
import { NotesGraphLitIcon, UniAnyRender, UniLit } from './index.js';
import { AnyRender } from './utils/uni-component/render-template.js';

export function coreEffects() {
  customElements.define('notesgraph-data-view-renderer', DataViewRootUI);
  customElements.define('any-render', AnyRender);
  customElements.define(
    'data-view-properties-setting',
    DataViewPropertiesSettingView
  );
  customElements.define('notesgraph-data-view-record-field', RecordField);
  ...
  customElements.define('notesgraph-lit-icon', NotesGraphLitIcon);
  customElements.define('data-view-group-setting', GroupSetting);
  customElements.define('notesgraph-multi-tag-select', MultiTagSelect);
  customElements.define('data-view-group-title-boolean-view', BooleanGroupView);
  customElements.define('notesgraph-multi-tag-view', MultiTagView);
  ...
  customElements.define('notesgraph-data-view-record-detail', RecordDetail);
}
