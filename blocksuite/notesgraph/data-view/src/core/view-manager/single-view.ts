...
> implements SingleView {
  ...
  // Surfaced so a view can render a loading state instead of "no results"
  // while an asynchronous source is still populating rows$.
  rowsLoading$ = computed(() => this.dataSource.rowsLoading$.value);
