...
export class DataViewRootUILogic {
  ...
  render() {
    return html` <notesgraph-data-view-renderer
      ${ref(this._uiRef)}
      .logic="${this}"
    ></notesgraph-data-view-renderer>`;
  }
}
...
export class DataViewRootUI extends SignalWatcher(
  ...
  static override styles = css`
    ${unsafeCSS(dataViewCommonStyle('notesgraph-data-view-renderer'))}
    notesgraph-data-view-renderer {
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-data-view-renderer': DataViewRootUI;
  }
}
