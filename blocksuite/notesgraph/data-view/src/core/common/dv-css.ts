...
export const dataViewVars = {
  cellTextSize: '--notesgraph-data-view-cell-text-size',
  cellTextLineHeight: '--notesgraph-data-view-cell-text-line-height',
};
...
export const shadow2 = css({
  boxShadow: 'var(--notesgraph-shadow-2)',
});

export const dividerH = css({
  height: '1px',
  backgroundColor: 'var(--notesgraph-divider-color)',
  margin: '8px 0',
});
