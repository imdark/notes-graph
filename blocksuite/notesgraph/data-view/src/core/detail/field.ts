...
export class RecordField extends SignalWatcher(
  ...
  static override styles = css`
    ...
    notesgraph-data-view-record-field .icon {
      display: flex;
      align-items: center;
      width: 16px;
      height: 16px;
    ...
    notesgraph-data-view-record-field .icon svg {
      width: 16px;
      height: 16px;
    ...
    .field-content notesgraph-database-number-cell .number {
      text-align: left;
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-data-view-record-field': RecordField;
  }
}
