...
const styles = css`
  ...
  notesgraph-data-view-kanban-cell:hover {
    background-color: var(--notesgraph-hover-color);
  }

  notesgraph-data-view-kanban-cell .icon {
    display: flex;
    align-items: center;
  ...
  notesgraph-data-view-kanban-cell .icon svg {
    width: 16px;
    height: 16px;
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-data-view-kanban-cell': KanbanCell;
  }
}
