...
const styles = css`
  ...
  notesgraph-database-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  notesgraph-database-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-database-column-stats-cell': DatabaseColumnStatsCell;
  }
}
