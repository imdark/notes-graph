...
import { getRangeByPositions } from '@blocksuite/notesgraph-shared/utils';
...
export class TableSelectionController implements ReactiveController {
  ...
  private resolveDragStartTarget(
    ...
    if (fillValues) {
      ...
      cell = target.closest('notesgraph-database-virtual-cell-container');
    }
...
export class SelectionElement extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .database-selection {
      ...
      background-color: var(--notesgraph-primary-color-04);
      pointer-events: none;
      display: none;
    }
