...
export class TableDragController implements ReactiveController {
  ...
  getInsertPosition = (
    ...
    const tableRect = this.host
      ?.querySelector('notesgraph-data-view-table-group')
...
//   div.style.backgroundColor = 'var(--notesgraph-background-primary-color)';
//   div.style.boxShadow = 'var(--notesgraph-shadow-2)';
//   div.style.left = `${x}px`;
//   div.style.top = `${y}px`;
