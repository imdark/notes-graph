...
const styles = css`
  ...
  notesgraph-database-virtual-column-stats:hover .stats-cell {
    opacity: 1;
  }

  .stats-cell:hover,
  notesgraph-database-virtual-column-stats-cell.active .stats-cell {
    opacity: 1;
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-database-virtual-column-stats-cell': VirtualDatabaseColumnStatsCell;
  }
}
