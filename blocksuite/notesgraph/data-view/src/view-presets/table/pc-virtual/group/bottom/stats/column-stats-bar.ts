...
const styles = css`
  notesgraph-database-virtual-column-stats {
  ...
  protected override render() {
    ...
    return html`
      ${repeat(
        ...
        col => col.id,
        col => {
          return html`<notesgraph-database-virtual-column-stats-cell
            .column=${col}
            .group=${this.group}
          ></notesgraph-database-virtual-column-stats-cell>`;
        }
      )}
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-database-virtual-column-stats': VirtualDataBaseColumnStats;
  }
}
