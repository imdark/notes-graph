...
export class DatabaseCellContainer extends SignalWatcher(
  ...
  static override styles = css`
    notesgraph-database-virtual-cell-container {
      display: flex;
      align-items: start;
      width: 100%;
      border: none;
    ...
    notesgraph-database-virtual-cell-container uni-lit > *:first-child {
      padding: 6px;
    }
  `;
  ...
  override connectedCallback() {
    ...
    if (style) {
      style.borderBottom = '1px solid var(--notesgraph-border-color)';
      style.borderRight = '1px solid var(--notesgraph-border-color)';
    }
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-database-virtual-cell-container': DatabaseCellContainer;
  }
}
