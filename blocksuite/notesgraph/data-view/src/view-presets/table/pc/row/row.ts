...
export class TableRowView extends SignalWatcher(
  ...
  static override styles = css`
    .notesgraph-database-block-row:has(.row-select-checkbox.selected) {
      background: var(--notesgraph-primary-color-04);
    }
    .notesgraph-database-block-row:has(.row-select-checkbox.selected)
      .row-selected-bg {
      position: relative;
    ...
    .notesgraph-database-block-row.selected > .database-cell {
    ...
    .notesgraph-database-block-row .show-on-hover-row {
      visibility: hidden;
      opacity: 0;
    }
    .notesgraph-database-block-row:hover .show-on-hover-row {
      visibility: visible;
      opacity: 1;
    }
    .notesgraph-database-block-row:has(.active) .show-on-hover-row {
      visibility: visible;
      opacity: 1;
    }
    .notesgraph-database-block-row:has([data-editing='true'])
      .show-on-hover-row {
      visibility: hidden;
      opacity: 0;
    }
    ...
    .row-op {
      ...
      padding: 4px;
      border-radius: 4px;
      box-shadow: var(--notesgraph-button-shadow);
  ...
  get groupKey() {
    return this.closest<TableGroup>('notesgraph-data-view-table-group')?.group
      ?.key;
  }
  ...
  override connectedCallback() {
    ...
    this.classList.add('notesgraph-database-block-row', 'database-row');
  }
            ...
            <div style="display: flex;">
              ...
              >
                <div
                  ...
                  border-radius: 2px;
                  height: 12px;
                  background-color: var(--notesgraph-placeholder-color);"
                ></div>
              </div>
              <row-select-checkbox
