...
export class TableViewUI extends DataViewUIBase<TableViewUILogic> {
  override connectedCallback(): void {
    ...
    this.classList.add('notesgraph-database-table', tableViewStyle);
  ...
  private renderTable() {
      ...
      return html`
        <div class="${tableGroupsContainerStyle}">
          ${repeat(
            ...
            group => group.key,
            group =>
              html`<notesgraph-data-view-table-group
    ...
    return html`<notesgraph-data-view-table-group
      .tableViewLogic="${this.logic}"
    ></notesgraph-data-view-table-group>`;
  }
      ...
      <div class="${tableWrapperStyle}" style="${wrapperStyle}">
        ...
        >
          <div
            ...
            class="notesgraph-database-table-container"
