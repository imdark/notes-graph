...
export const calendarViewStyles = css`
  ...
  .calendar-empty-month-hint-close svg {
    width: 16px;
    height: 16px;
    color: var(--notesgraph-icon-secondary);
    flex: 0 0 auto;
  }
  ...
  .calendar-day.is-outside {
    background: color-mix(
      in srgb,
      var(--notesgraph-background-secondary-color) 55%,
      var(--notesgraph-background-primary-color)
    );
  }
  ...
  .calendar-day:not(.is-outside):hover {
    background: color-mix(
      in srgb,
      var(--notesgraph-primary-color) 2%,
      var(--notesgraph-background-primary-color)
    );
  }

  .calendar-day.is-drop-target {
    box-shadow: inset 0 0 0 1px var(--notesgraph-primary-color);
    background: color-mix(
      in srgb,
  ...
  .calendar-day.is-today {
    background: color-mix(
      in srgb,
      var(--notesgraph-primary-color) 6%,
      var(--notesgraph-background-primary-color)
    );
  }
  ...
  .calendar-day.is-outside .calendar-day-number {
    color: color-mix(
      in srgb,
      var(--notesgraph-text-secondary-color) 60%,
      transparent
    );
  }
  ...
  .calendar-day.is-today:hover {
    background: color-mix(
      in srgb,
      var(--notesgraph-primary-color) 9%,
      var(--notesgraph-background-primary-color)
    );
  }
  ...
  .calendar-entry:focus-visible {
    outline: 1px solid var(--notesgraph-primary-color);
    outline-offset: 1px;
  }
  ...
  .calendar-entry.selected {
    ...
    background: color-mix(
      in srgb,
      var(--notesgraph-primary-color) 15%,
  ...
  .calendar-resize-handle::after {
    ...
    border-radius: 1px;
    background: var(--notesgraph-icon-secondary);
  }
  ...
  .calendar-entry-preview {
    ...
    box-sizing: border-box;
    border-radius: 4px;
    border: 1.5px dashed var(--notesgraph-primary-color);
    background: color-mix(
      in srgb,
      var(--notesgraph-primary-color) 6%,
      transparent
  ...
  .calendar-day:hover .calendar-new-row {
    background: color-mix(
      in srgb,
      var(--notesgraph-primary-color) 10%,
      var(--notesgraph-background-primary-color)
    );
  }
  ...
  .calendar-day.is-today .calendar-new-row:hover {
    background: color-mix(
      in srgb,
      var(--notesgraph-primary-color) 88%,
      var(--notesgraph-pure-white)
    );
  }
  ...
  .calendar-empty-month-hint {
    ...
    border: 1px solid
      color-mix(in srgb, var(--notesgraph-primary-color) 18%, transparent);
    border-radius: 6px;
    background: color-mix(
      in srgb,
      var(--notesgraph-background-primary-color) 92%,
      var(--notesgraph-primary-color)
    );
    box-shadow: var(--notesgraph-menu-shadow);
    box-sizing: border-box;
  }
