...
const styles = css`
  .notesgraph-database-filter-button {
    display: flex;
    align-items: center;
    gap: 6px;
    line-height: 20px;
  ...
  .notesgraph-database-filter-button:hover,
  .notesgraph-database-filter-button.active {
...
export class DataViewHeaderToolsFilter extends WidgetBase {
  ...
  override render() {
    ...
    return html` <div
      ...
      style="${style}"
      class="notesgraph-database-filter-button"
    >
      ${FilterIcon()}
    </div>`;
  }
