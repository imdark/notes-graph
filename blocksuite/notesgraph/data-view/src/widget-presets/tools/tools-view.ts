...
const styles = css`
  ...
  .toolbar-hover-container:hover .notesgraph-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
  .toolbar-hover-container:has(.active) .notesgraph-database-toolbar {
    visibility: visible;
    opacity: 1;
  }
...
export class DataViewHeaderTools extends WidgetBase {
  ...
  override render() {
    const classList = classMap({
      ...
      'notesgraph-database-toolbar': true,
    });
