...
const progressColors = {
  empty: 'var(--notesgraph-black-10)',
  processing: 'var(--notesgraph-processing-color)',
  success: 'var(--notesgraph-success-color)',
};
...
export class ProgressCell extends BaseCellRenderer<number, number> {
  ...
  protected override render() {
    ...
    const bgStyles = styleMap({
      backgroundColor:
        progress === 0 ? progressColors.empty : 'var(--notesgraph-hover-color)',
    });
