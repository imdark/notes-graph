...
import { addAttachments } from '@blocksuite/notesgraph-block-attachment';
import { insertLinkByQuickSearchCommand } from '@blocksuite/notesgraph-block-bookmark';
import { addImages } from '@blocksuite/notesgraph-block-image';
import { DefaultTool } from '@blocksuite/notesgraph-block-surface';
import { MAX_IMAGE_WIDTH } from '@blocksuite/notesgraph-model';
import { TelemetryProvider } from '@blocksuite/notesgraph-shared/services';
import type { NoteChildrenFlavour } from '@blocksuite/notesgraph-shared/types';
import {
  getImageFilesFromLocal,
  openSingleFileWith,
} from '@blocksuite/notesgraph-shared/utils';
import { EdgelessToolbarToolMixin } from '@blocksuite/notesgraph-widget-edgeless-toolbar';
...
export class EdgelessNoteMenu extends EdgelessToolbarToolMixin(LitElement) {
  static override styles = css`
    ...
    .divider {
      width: 1px;
      height: 24px;
      background: var(--notesgraph-border-color);
      ...
      <edgeless-slide-menu>
        <div class="menu-content">
          ...
          <div class="button-group-container">
            ...
            <edgeless-tool-icon-button
              .activeMode=${'background'}
              .tooltip=${html`<notesgraph-tooltip-content-with-shortcut
                data-tip="${'Link'}"
                data-shortcut="${'@'}"
              ></notesgraph-tooltip-content-with-shortcut>`}
              @click=${() => {
