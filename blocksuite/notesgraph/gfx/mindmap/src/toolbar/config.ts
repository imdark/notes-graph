...
import { hasGrouped } from '@blocksuite/notesgraph-gfx-shape';
import {
  LayoutType,
  MindmapElementModel,
  MindmapStyle,
...
export const mindmapToolbarExtension = ToolbarModuleExtension({
  id: BlockFlavourIdentifier('notesgraph:surface:mindmap'),
  config: mindmapToolbarConfig,
});

export const shapeMindmapToolbarExtension = ToolbarModuleExtension({
  id: BlockFlavourIdentifier('custom:notesgraph:surface:shape'),
