...
import { DefaultTool } from '@blocksuite/notesgraph-block-surface';
import {
  darkToolbarStyles,
  lightToolbarStyles,
...
import { EdgelessDraggableElementController } from '@blocksuite/notesgraph-widget-edgeless-toolbar';
...
export class EdgelessTemplatePanel extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .edgeless-templates-panel {
      ...
      height: 568px;
      border-radius: 12px;
      background-color: var(--notesgraph-background-overlay-panel-color);
    ...
    .search-bar {
      padding: 21px 24px;
      font-size: 18px;
      color: var(--notesgraph-secondary);
      border-bottom: 1px solid var(--notesgraph-divider-color);
    ...
    .category-entry:hover {
      color: var(--notesgraph-text-primary-color);
      background-color: var(--notesgraph-background-tertiary-color);
    }
    ...
    .template-item > svg {
      ...
      width: 135px;
      height: 80px;
      color: var(--notesgraph-background-primary-color);
    }
    ...
    /* .template-item:hover::before {
      ...
      background-color: var(--notesgraph-primary-color);
      color: var(--notesgraph-white);
    } */
    ...
    .template-item:hover::after {
      ...
      height: 100%;
      box-sizing: border-box;
      border: 1px solid var(--notesgraph-black-10);
      border-radius: 4px;
    ...
    .template-item.loading > notesgraph-template-loading {
      position: absolute;
      left: 50%;
      top: 50%;
      transform: translate(-50%, -50%);
    ...
    .arrow {
      ...
      color: var(--notesgraph-background-overlay-panel-color);
    }
  `;
        ...
        <div class="template-viewport">
          <div class="template-scrollcontent" data-scrollable>
            <div class="template-list">
              ${this._loading
                ? html`<notesgraph-template-loading
                    style=${styleMap({
                      position: 'absolute',
                      left: '50%',
                      top: '50%',
                      ...
                      return html`
                        ...
                        >
                          ...
                          ${template === this._loadingTemplate
                            ? html`<notesgraph-template-loading></notesgraph-template-loading>`
                            : nothing}
                          ${template.name
                            ? html`<notesgraph-tooltip
                                .offset=${12}
                                .autoHide=${true}
                                tip-position="top"
                              >
