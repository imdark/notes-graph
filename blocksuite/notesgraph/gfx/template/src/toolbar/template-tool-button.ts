...
import { ArrowDownSmallIcon } from '@blocksuite/notesgraph-components/icons';
import { once } from '@blocksuite/notesgraph-shared/utils';
...
export class EdgelessTemplateButton extends EdgelessToolbarToolMixin(
  ...
  static override styles = css`
    ...
    .arrow-icon {
      --y: 17px;
      background: var(--notesgraph-black-10);
      width: 24px;
      height: 24px;
      border-radius: 50%;
      display: flex;
