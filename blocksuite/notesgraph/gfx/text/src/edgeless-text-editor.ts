...
import { DefaultTheme, TextElementModel } from '@blocksuite/notesgraph-model';
import type { RichText } from '@blocksuite/notesgraph-rich-text';
import { ThemeProvider } from '@blocksuite/notesgraph-shared/services';
import { getSelectedRect } from '@blocksuite/notesgraph-shared/utils';
import {
  type BlockComponent,
  type BlockStdScope,
  ...
  static override styles = css`
    .edgeless-text-editor {
      ...
      border: ${EdgelessTextEditor.BORDER_WIDTH}px solid
        var(--notesgraph-primary-color, #1e96eb);
      border-radius: 4px;
