...
import { getLineHeight } from '@blocksuite/notesgraph-gfx-text';
import type { ConnectorElementModel } from '@blocksuite/notesgraph-model';
import type { RichText } from '@blocksuite/notesgraph-rich-text';
import { ThemeProvider } from '@blocksuite/notesgraph-shared/services';
import { almostEqual } from '@blocksuite/notesgraph-shared/utils';
import {
  type BlockComponent,
  type BlockStdScope,
  ShadowlessElement,
...
export class EdgelessConnectorLabelEditor extends WithDisposable(
  ...
  static override styles = css`
    .edgeless-connector-label-editor {
      ...
      border: ${BORDER_WIDTH}px solid var(--notesgraph-primary-color, #1e96eb);
      background: var(--notesgraph-background-primary-color, #fff);
      border-radius: 2px;
