...
import {
  packColor,
  type PickColorEvent,
} from '@blocksuite/notesgraph-components/color-picker';
import type { LineDetailType } from '@blocksuite/notesgraph-components/edgeless-line-styles-panel';
import {
  createTextActions,
  normalizeTextBound,
} from '@blocksuite/notesgraph-gfx-text';
import {
...
import type { MenuItem } from '@blocksuite/notesgraph-widget-edgeless-toolbar';
import {
  getRootBlock,
  LINE_STYLE_LIST,
  renderMenu,
} from '@blocksuite/notesgraph-widget-edgeless-toolbar';
...
export const connectorToolbarExtension = ToolbarModuleExtension({
  id: BlockFlavourIdentifier('notesgraph:surface:connector'),
