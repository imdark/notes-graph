...
import { requestThrottledConnectedFrame } from '@blocksuite/notesgraph-shared/utils';
import {
  BlockComponent,
...
export class EdgelessRootPreviewBlockComponent extends BlockComponent<RootBlockModel> {
  static override styles = css`
    ...
    notesgraph-edgeless-root-preview .widgets-container {
      position: absolute;
      left: 0;
      top: 0;
      contain: size layout;
    ...
    notesgraph-edgeless-root-preview .edgeless-background {
      height: 100%;
