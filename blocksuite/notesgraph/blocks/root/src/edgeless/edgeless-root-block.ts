...
import { NoteConfigExtension } from '@blocksuite/notesgraph-block-note';
import {
  DefaultTool,
  getBgGridGap,
...
import { isSingleMindMapNode } from '@blocksuite/notesgraph-gfx-mindmap';
...
> {
  ...
  get surfaceBlockModel() {
    return this.model.children.find(
      child => child.flavour === 'notesgraph:surface'
