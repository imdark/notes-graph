...
import { EdgelessTextBlockComponent } from '@blocksuite/notesgraph-block-edgeless-text';
import {
  FrameTool,
  type PresentToolOption,
} from '@blocksuite/notesgraph-block-frame';
import {
  DefaultTool,
...
import {
  ...
  EraserTool,
  HighlighterTool,
} from '@blocksuite/notesgraph-gfx-brush';
import {
  ConnectorTool,
  mountConnectorLabelEditor,
} from '@blocksuite/notesgraph-gfx-connector';
import {
  createGroupFromSelectedCommand,
  ungroupCommand,
} from '@blocksuite/notesgraph-gfx-group';
import {
  getNearestTranslation,
  isElementOutsideViewport,
  isSingleMindMapNode,
} from '@blocksuite/notesgraph-gfx-mindmap';
import { NoteTool } from '@blocksuite/notesgraph-gfx-note';
import { PanTool } from '@blocksuite/notesgraph-gfx-pointer';
import {
  mountShapeTextEditor,
  ShapeTool,
} from '@blocksuite/notesgraph-gfx-shape';
import { TextTool } from '@blocksuite/notesgraph-gfx-text';
import {
