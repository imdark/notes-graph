...
export class ImageBlockPageComponent extends SignalWatcher(
  ...
  static override styles = css`
    ...
    notesgraph-page-image .notesgraph-image-status {
      position: absolute;
      left: 18px;
      bottom: 18px;
    }

    notesgraph-page-image .resizable-img {
      position: relative;
      max-width: 100%;
    }

    notesgraph-page-image .resizable-img img {
      width: 100%;
      height: 100%;
    }

    notesgraph-page-image .comment-highlighted {
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-page-image': ImageBlockPageComponent;
  }
}
