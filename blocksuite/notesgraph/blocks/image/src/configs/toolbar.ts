...
import { updateBlockAlign } from '@blocksuite/notesgraph-block-note';
import { ImageBlockModel, TextAlign } from '@blocksuite/notesgraph-model';
import {
  ActionPlacement,
      ...
      actions: [
        {
          ...
          icon: BookmarkIcon(),
          when(ctx) {
            const supported = ctx.store.schema.flavourSchemaMap.has(
