...
import type { ImageBlockModel } from '@blocksuite/notesgraph-model';
    ...
    return html`
      <div class="notesgraph-image-container" style=${containerStyleMap}>
        ${when(
          blobUrl,
          () =>
            html`<notesgraph-page-image
              .block=${this}
              .state=${resovledState}
              style="${alignItemsStyleMap}"
            ></notesgraph-page-image>`,
          () =>
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-image': ImageBlockComponent;
  }
}
