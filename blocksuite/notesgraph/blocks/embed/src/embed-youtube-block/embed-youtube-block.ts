  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class=${classMap({
            'notesgraph-embed-youtube-block': true,
            loading,
        ...
        >
          <div class="notesgraph-embed-youtube-video">
            ${videoId
              ? html`
                  <div class="notesgraph-embed-youtube-video-iframe-container">
                    <iframe
                      id="ytplayer"
                      type="text/html"
                    ...
                    <div
                      class=${classMap({
                        'notesgraph-embed-youtube-video-iframe-overlay': true,
          ...
          <div class="notesgraph-embed-youtube-content">
            <div class="notesgraph-embed-youtube-content-header">
              <div class="notesgraph-embed-youtube-content-title-icon">
                ${titleIcon}
              </div>

              <div class="notesgraph-embed-youtube-content-title-text">
                ${titleText}
              </div>

              <div class="notesgraph-embed-youtube-content-creator-image">
                ${creatorImageEl}
              </div>

              <div class="notesgraph-embed-youtube-content-creator-text">
                ${creator}
              </div>
            </div>
            ...
            ${loading
              ? html`<div
                  class="notesgraph-embed-youtube-content-description"
                ></div>`
              : descriptionText
                ? html`<div
                    class="notesgraph-embed-youtube-content-description"
            ...
            <div
              class="notesgraph-embed-youtube-content-url"
              @click=${this.open}
            >
              <span>www.youtube.com</span>

              <div class="notesgraph-embed-youtube-content-url-icon">
                ${OpenIcon}
              </div>
            </div>
          </div>
