...
export function effects() {
  customElements.define(
    'notesgraph-embed-edgeless-figma-block',
    EmbedEdgelessBlockComponent
  );
  customElements.define(
    'notesgraph-embed-figma-block',
    EmbedFigmaBlockComponent
  );

  customElements.define('notesgraph-embed-html-block', EmbedHtmlBlockComponent);
  customElements.define(
    'notesgraph-embed-edgeless-html-block',
  ...
  customElements.define(
    'notesgraph-embed-edgeless-github-block',
  ...
  customElements.define(
    'notesgraph-embed-edgeless-youtube-block',
  ...
  customElements.define(
    'notesgraph-embed-edgeless-loom-block',
    EmbedEdgelessLoomBlockComponent
  );
  customElements.define('notesgraph-embed-loom-block', EmbedLoomBlockComponent);

  customElements.define(
    'notesgraph-embed-edgeless-iframe-block',
    EmbedEdgelessIframeBlockComponent
  );
  customElements.define(
    'notesgraph-embed-iframe-block',
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-embed-figma-block': EmbedFigmaBlockComponent;
    'notesgraph-embed-edgeless-figma-block': EmbedEdgelessBlockComponent;
    'notesgraph-embed-github-block': EmbedGithubBlockComponent;
    'notesgraph-embed-edgeless-github-block': EmbedEdgelessGithubBlockComponent;
    'notesgraph-embed-html-block': EmbedHtmlBlockComponent;
    'notesgraph-embed-edgeless-html-block': EmbedEdgelessHtmlBlockComponent;
    'embed-html-fullscreen-toolbar': EmbedHtmlFullscreenToolbar;
    'notesgraph-embed-edgeless-loom-block': EmbedEdgelessLoomBlockComponent;
    'notesgraph-embed-loom-block': EmbedLoomBlockComponent;
    'notesgraph-embed-youtube-block': EmbedYoutubeBlockComponent;
    'notesgraph-embed-edgeless-youtube-block': EmbedEdgelessYoutubeBlockComponent;
    'notesgraph-embed-iframe-block': EmbedIframeBlockComponent;
