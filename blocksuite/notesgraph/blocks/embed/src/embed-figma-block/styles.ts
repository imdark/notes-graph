...
export const styles = css`
  ...
  .notesgraph-embed-figma img,
  .notesgraph-embed-figma object,
  .notesgraph-embed-figma svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .notesgraph-embed-figma-iframe-container {
    height: 100%;
    position: relative;
  }

  .notesgraph-embed-figma-iframe-container > iframe {
    width: 100%;
    height: 100%;
    border-radius: 4px;
    border: none;
  ...
  .notesgraph-embed-figma-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .notesgraph-embed-figma-iframe-overlay.hide {
    display: none;
  }

  .notesgraph-embed-figma-content {
    display: block;
    flex-direction: column;
    width: 100%;
    height: fit-content;
  ...
  .notesgraph-embed-figma-content-header {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .notesgraph-embed-figma-content-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .notesgraph-embed-figma-content-title-icon img,
  .notesgraph-embed-figma-content-title-icon object,
  .notesgraph-embed-figma-content-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--notesgraph-background-primary-color);
  }

  .notesgraph-embed-figma-content-title-text {
    flex: 1 0 0;
  ...
  .notesgraph-embed-figma-content-description {
    height: 40px;
  ...
  .notesgraph-embed-figma-content-description::after {
    content: '...';
    position: absolute;
    right: 0;
    bottom: 0;
  ...
  .notesgraph-embed-figma-content-url {
    display: flex;
    align-items: center;
  ...
  .notesgraph-embed-figma-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .notesgraph-embed-figma-content-url:hover > span {
    color: var(--notesgraph-link-color);
  }
  .notesgraph-embed-figma-content-url:hover .open-icon {
    fill: var(--notesgraph-link-color);
  }

  .notesgraph-embed-figma-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .notesgraph-embed-figma-content-url-icon svg {
    height: 12px;
    width: 12px;
    fill: ${unsafeCSSVarV2('icon/primary')};
  }

  .notesgraph-embed-figma-block.selected {
    .notesgraph-embed-figma-content-url > span {
      color: var(--notesgraph-link-color);
    }
    .notesgraph-embed-figma-content-url .open-icon {
      fill: var(--notesgraph-link-color);
    }
  }
`;
