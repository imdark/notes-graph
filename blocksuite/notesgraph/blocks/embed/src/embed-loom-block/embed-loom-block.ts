  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class=${classMap({
            'notesgraph-embed-loom-block': true,
            loading,
        ...
        >
          <div class="notesgraph-embed-loom-video">
            ${videoId
              ? html`
                  <div class="notesgraph-embed-loom-video-iframe-container">
                    <iframe
                    ...
                    <div
                      class=${classMap({
                        'notesgraph-embed-loom-video-iframe-overlay': true,
          ...
          <div class="notesgraph-embed-loom-content">
            <div class="notesgraph-embed-loom-content-header">
              <div class="notesgraph-embed-loom-content-title-icon">
                ${titleIcon}
              </div>

              <div class="notesgraph-embed-loom-content-title-text">
                ${titleText}
              </div>
            </div>

            <div class="notesgraph-embed-loom-content-description">
              ${descriptionText}
            </div>

            <div class="notesgraph-embed-loom-content-url" @click=${this.open}>
              <span>loom.com</span>

              <div class="notesgraph-embed-loom-content-url-icon">
                ${OpenIcon}
              </div>
            </div>
          </div>
