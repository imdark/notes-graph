...
export const styles = css`
  ...
  .notesgraph-embed-loom-video {
    flex-grow: 1;
    width: 100%;
  }

  .notesgraph-embed-loom-video img,
  .notesgraph-embed-loom-video object,
  .notesgraph-embed-loom-video svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .notesgraph-embed-loom-video-iframe-container {
    position: relative;
    height: 100%;
  }

  .notesgraph-embed-loom-video-iframe-container > iframe {
    width: 100%;
    height: 100%;
    border-radius: 4px;
  }

  .notesgraph-embed-loom-video-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .notesgraph-embed-loom-video-iframe-overlay.hide {
    display: none;
  }

  .notesgraph-embed-loom-content {
    display: flex;
    flex-direction: column;
    width: 100%;
    height: fit-content;
  ...
  .notesgraph-embed-loom-content-header {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .notesgraph-embed-loom-content-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .notesgraph-embed-loom-content-title-icon img,
  .notesgraph-embed-loom-content-title-icon object,
  .notesgraph-embed-loom-content-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--notesgraph-background-primary-color);
  }

  .notesgraph-embed-loom-content-title-text {
    flex: 1 0 0;
  ...
  .notesgraph-embed-loom-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .notesgraph-embed-loom-content-url {
    display: flex;
    align-items: center;
  ...
  .notesgraph-embed-loom-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .notesgraph-embed-loom-content-url:hover > span {
    color: var(--notesgraph-link-color);
  }
  .notesgraph-embed-loom-content-url:hover .open-icon {
    fill: var(--notesgraph-link-color);
  }

  .notesgraph-embed-loom-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .notesgraph-embed-loom-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--notesgraph-text-secondary-color);
  }

  .notesgraph-embed-loom-block.loading {
    .notesgraph-embed-loom-content-title-text {
      color: var(--notesgraph-placeholder-color);
    }
  }

  .notesgraph-embed-loom-block.selected {
    .notesgraph-embed-loom-content-url > span {
      color: var(--notesgraph-link-color);
    }
    .notesgraph-embed-loom-content-url .open-icon {
      fill: var(--notesgraph-link-color);
    }
  }
`;
