...
export class EmbedIframeErrorCard extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .notesgraph-embed-iframe-error-card {
      container: notesgraph-embed-iframe-error-card / size;
      display: flex;
    ...
    .notesgraph-embed-iframe-error-card.horizontal {
      flex-direction: row;
      ...
      @container notesgraph-embed-iframe-error-card (width < 480px) {
        .error-banner {
          display: none;
        }
      }
    ...
    .notesgraph-embed-iframe-error-card.vertical {
      ...
      @container notesgraph-embed-iframe-error-card (height < 300px) or (width < 300px) {
        .error-banner {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'notesgraph-embed-iframe-error-card': true,
