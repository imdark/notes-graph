...
export class EmbedIframeIdleCard extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .notesgraph-embed-iframe-idle-card {
      container: notesgraph-embed-iframe-idle-card / size;
    ...
    .notesgraph-embed-iframe-idle-card:hover {
      cursor: pointer;
    }

    .notesgraph-embed-iframe-idle-card.horizontal {
      flex-direction: row;
    ...
    .notesgraph-embed-iframe-idle-card.vertical {
      ...
      @container notesgraph-embed-iframe-idle-card (height < 180px) {
        .icon {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'notesgraph-embed-iframe-idle-card': true,
