...
export class EmbedIframeLoadingCard extends LitElement {
  static override styles = css`
    ...
    .notesgraph-embed-iframe-loading-card {
      container: notesgraph-embed-iframe-loading-card / size;
      display: flex;
      ...
      @container notesgraph-embed-iframe-loading-card (width < 360px) {
        .loading-banner {
          display: none;
        }
      }
    ...
    .notesgraph-embed-iframe-loading-card.horizontal {
      flex-direction: row;
    ...
    .notesgraph-embed-iframe-loading-card.vertical {
      ...
      @container notesgraph-embed-iframe-loading-card (height < 240px) {
        .loading-banner {
          display: none;
        }
      }
  ...
  override render() {
    ...
    const cardClasses = classMap({
      'notesgraph-embed-iframe-loading-card': true,
