...
export const styles = css`
  ...
  .notesgraph-embed-html img,
  .notesgraph-embed-html object,
  .notesgraph-embed-html svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
    border-radius: 4px;
  ...
  .notesgraph-embed-html-iframe-container {
    position: relative;
    width: 100%;
    height: 100%;
  ...
  .embed-html-block-iframe-wrapper notesgraph-menu {
    min-width: 296px;
  }

  .embed-html-block-iframe-wrapper notesgraph-menu .settings-header {
    padding: 7px 12px;
    font-weight: 500;
  ...
  .notesgraph-embed-html-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .notesgraph-embed-html-iframe-overlay.hide {
    display: none;
  }

  .notesgraph-embed-html-title {
    height: fit-content;
    display: flex;
    align-items: center;
    gap: 8px;
  ...
  .notesgraph-embed-html-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .notesgraph-embed-html-title-icon img,
  .notesgraph-embed-html-title-icon object,
  .notesgraph-embed-html-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--notesgraph-background-primary-color);
  }

  .notesgraph-embed-html-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
