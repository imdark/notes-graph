  ...
  override renderBlock(): unknown {
    ...
    return this.renderEmbed(() => {
      if (!this.model.props.html) {
        return html` <div class="notesgraph-html-empty">Empty</div>`;
      }
      return html`
        <div
          class=${classMap({
            'notesgraph-embed-html-block': true,
        ...
        >
          <div class="notesgraph-embed-html">
            <div class="notesgraph-embed-html-iframe-container">
              ...
              <div
                class=${classMap({
                  'notesgraph-embed-html-iframe-overlay': true,
          ...
          <div class="notesgraph-embed-html-title">
            <div class="notesgraph-embed-html-title-icon">${HtmlIcon}</div>

            <div class="notesgraph-embed-html-title-text">${titleText}</div>
          </div>
        </div>
      `;
    });
