...
export const styles = css`
  .notesgraph-embed-github-block {
    container: notesgraph-embed-github-block / inline-size;
  ...
  .notesgraph-embed-github-content {
    display: flex;
    flex-grow: 1;
  ...
  .notesgraph-embed-github-content-title {
    display: flex;
    min-height: 22px;
    flex-direction: row;
    gap: 8px;
  ...
  .notesgraph-embed-github-content-title-icons {
    display: flex;
  ...
  .notesgraph-embed-github-content-title-icons img,
  .notesgraph-embed-github-content-title-icons object,
  .notesgraph-embed-github-content-title-icons svg {
    width: 16px;
    height: 16px;
    color: var(--notesgraph-pure-white);
  }

  .notesgraph-embed-github-content-title-site-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
    ...
    .github-icon {
      fill: var(--notesgraph-black);
      color: var(--notesgraph-black);
    }
  }

  .notesgraph-embed-github-content-title-status-icon {
    display: flex;
    align-items: center;
    gap: 4px;
    padding: 3px 6px;
  ...
  .notesgraph-embed-github-content-title-status-icon.issue.open {
    background: #238636;
  }
  .notesgraph-embed-github-content-title-status-icon.issue.closed.success {
    background: #8957e5;
  }
  .notesgraph-embed-github-content-title-status-icon.issue.closed.failure {
    background: #6e7681;
  }
  .notesgraph-embed-github-content-title-status-icon.pr.open {
    background: #238636;
  }
  .notesgraph-embed-github-content-title-status-icon.pr.draft {
    background: #6e7681;
  }
  .notesgraph-embed-github-content-title-status-icon.pr.merged {
    background: #8957e5;
  }
  .notesgraph-embed-github-content-title-status-icon.pr.closed {
    background: #c03737;
  }

  .notesgraph-embed-github-content-title-status-icon > svg {
    height: 16px;
    width: 16px;
    padding: 2px;
  }

  .notesgraph-embed-github-content-title-status-icon > span {
    padding: 0px 1.5px;
  }

  .notesgraph-embed-github-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .notesgraph-embed-github-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .notesgraph-embed-github-content-assignees {
    display: none;
  }

  .notesgraph-embed-github-content-url {
    display: flex;
    align-items: center;
  ...
  .notesgraph-embed-github-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .notesgraph-embed-github-content-url:hover > span {
    color: var(--notesgraph-link-color);
  }
  .notesgraph-embed-github-content-url:hover .open-icon {
    fill: var(--notesgraph-link-color);
  }

  .notesgraph-embed-github-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .notesgraph-embed-github-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--notesgraph-text-secondary-color);
  }

  .notesgraph-embed-github-banner {
    margin: 12px 0px 0px 12px;
    width: 204px;
    height: 102px;
  }

  .notesgraph-embed-github-banner img,
  .notesgraph-embed-github-banner object,
  .notesgraph-embed-github-banner svg {
    width: 204px;
    height: 102px;
    object-fit: cover;
    border-radius: 4px;
  ...
  .notesgraph-embed-github-block.loading {
    .notesgraph-embed-github-content-title-text {
      color: var(--notesgraph-placeholder-color);
    }
  }

  .notesgraph-embed-github-block.selected {
    .notesgraph-embed-github-content-url > span {
      color: var(--notesgraph-link-color);
    }
    .notesgraph-embed-github-content-url .open-icon {
      fill: var(--notesgraph-link-color);
    }
  }

  .notesgraph-embed-github-block.list {
    .notesgraph-embed-github-content {
      width: 100%;
      flex-direction: row;
      align-items: center;
    ...
    .notesgraph-embed-github-content-repo {
      display: none;
    }

    .notesgraph-embed-github-content-date {
      display: none;
    }
  ...
  .notesgraph-embed-github-block.vertical {
    ...
    .notesgraph-embed-github-content-assignees-text {
      display: -webkit-box;
      -webkit-line-clamp: 1;
      -webkit-box-orient: vertical;
    ...
    .notesgraph-embed-github-content-assignees-text.label {
      width: 72px;
      color: var(--notesgraph-text-primary-color);
      font-weight: 600;
    }

    .notesgraph-embed-github-content-assignees-text.users {
      width: calc(100% - 72px);
      word-break: break-all;
      white-space: normal;
      overflow: hidden;
    ...
    .notesgraph-embed-github-content-assignees-text-users.user {
      color: var(--notesgraph-link-color);
      cursor: pointer;
    }

    .notesgraph-embed-github-content-assignees-text-users.placeholder {
      color: var(--notesgraph-placeholder-color);
    }
  ...
  .notesgraph-embed-github-block.cube {
    .notesgraph-embed-github-content {
      width: 100%;
      flex-direction: column;
  ...
  @container notesgraph-embed-github-block (width < 375px) {
    .notesgraph-embed-github-content {
      width: 100%;
    }

    .notesgraph-embed-github-block:not(.edgeless)
      .notesgraph-embed-github-banner {
      display: none;
    }
  }
