import { getSurfaceBlock } from '@blocksuite/notesgraph-block-surface';
import {
  type DocMode,
  ListBlockModel,
  NoteBlockModel,
...
import { NotificationProvider } from '@blocksuite/notesgraph-shared/services';
...
export function createLinkedDocFromSlice(
  ...
  linkedDoc.load(() => {
    ...
    const noteId = linkedDoc.addBlock('notesgraph:note', {}, rootId);
