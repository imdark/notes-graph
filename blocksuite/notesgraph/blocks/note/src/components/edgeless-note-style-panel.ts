...
import type { SliderSelectEvent } from '@blocksuite/notesgraph-components/slider';
import {
  DefaultTheme,
  NoteBlockModel,
  type NoteProps,
  ...
  private _renderStylePanel() {
    return html`<div class="edgeless-note-style-panel">
      ...
      <div
        ...
        data-testid="notesgraph-note-border-style-panel"
      >
      ...
      <div
        class="edgeless-note-style-section"
        data-testid="notesgraph-note-corner-radius-panel"
      >
