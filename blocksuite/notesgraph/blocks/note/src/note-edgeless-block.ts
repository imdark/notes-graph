...
import type { DocTitle } from '@blocksuite/notesgraph-fragment-doc-title';
import { NoteBlockSchema, NoteDisplayMode } from '@blocksuite/notesgraph-model';
...
export const NOTESGRAPH_EDGELESS_NOTE = 'notesgraph-edgeless-note';
...
declare global {
  interface HTMLElementTagNameMap {
    [NOTESGRAPH_EDGELESS_NOTE]: EdgelessNoteBlockComponent;
  }
}
