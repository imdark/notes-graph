...
import { createParagraphToolbarConfigExtension } from './configs/toolbar.js';
...
> {
  ...
  override setup(
    ...
    context.register([
      FlavourExtension('notesgraph:paragraph'),
      BlockViewExtension('notesgraph:paragraph', literal`notesgraph-paragraph`),
      ParagraphTextKeymapExtension,
      ParagraphKeymapExtension,
      ...
      ...createParagraphToolbarConfigExtension('notesgraph:paragraph'),
    ]);
  }
}
