...
export class ParagraphBlockComponent extends CaptionedBlockComponent<ParagraphBlockModel> {
  ...
  private readonly _isInDatabase = () => {
    ...
    while (parent && parent !== document.body) {
      if (parent.tagName.toLowerCase() === 'notesgraph-database') {
        return true;
      }
  ...
  override renderBlock(): TemplateResult<1> {
    ...
    return html`
      ${style}
      <style>
        .notesgraph-paragraph-block-container[data-has-collapsed-siblings='false']
          notesgraph-paragraph-heading-icon
          .heading-icon {
      ...
      <div
        class=${classMap({
          'notesgraph-paragraph-block-container': true,
      ...
      >
        <div
          class=${classMap({
            'notesgraph-paragraph-rich-text-wrapper': true,
            [type$.value]: true,
          ...
          ${this.inEdgelessText
            ...
            : html`
                <div
                  ...
                  class=${classMap({
                    'notesgraph-paragraph-placeholder': true,
  ...
  override accessor blockContainerStyles = {
    margin: 'var(--notesgraph-paragraph-margin, 10px 0)',
  };
}
