import { ParagraphBlockSchema } from '@blocksuite/notesgraph-model';
import {
...
const MULTI_PARAGRAPH_EMITTED_NODES_CONTEXT_KEY =
  'notesgraph:paragraph:multi-emitted-nodes';
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['notesgraph-paragraph-block-container'],
                },
                children: [],
              },
              'children'
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['notesgraph-block-children-container'],
