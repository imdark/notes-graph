...
import { requestConnectedFrame } from '@blocksuite/notesgraph-shared/utils';
 ...
 *     Example: `shapeDomRenderer` in `blocksuite/notesgraph/gfx/shape/src/element-renderer/shape-dom/index.ts`.
 ...
 *     Import `DomElementRendererExtension` (e.g., from `@blocksuite/notesgraph-block-surface` or its source location
 *     `blocksuite/notesgraph/blocks/surface/src/extensions/dom-element-renderer.ts`).
 ...
 *     Example: `ShapeDomRendererExtension` in `blocksuite/notesgraph/gfx/shape/src/element-renderer/shape-dom.ts`.
 *
 ...
 *     As seen with `ShapeDomRendererExtension` being registered in `blocksuite/notesgraph/gfx/shape/src/view.ts`.
 *
 ...
 *         `blocksuite/notesgraph/blocks/surface/src/renderer/dom-elements/index.ts`.
 ...
 *         (e.g., from `@blocksuite/notesgraph-block-surface` or its source).
 ...
 *
 * 5.  **Ensure Exports**:
 *     -   The `DomRenderer` class itself should be accessible (e.g., exported from `@blocksuite/notesgraph/blocks/surface`).
