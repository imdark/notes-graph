...
import type { TableBlockModel } from '@blocksuite/notesgraph-model';
...
import { VirtualPaddingController } from '@blocksuite/notesgraph-shared/utils';
...
export const TableBlockComponentName = 'notesgraph-table';
        ...
        >
          <table class=${tableWrapper} ${ref(this.table$)}>
            ...
            ${IS_MOBILE || this.dataManager.readonly$.value
              ? nothing
              : html`<notesgraph-table-add-button
                  style="display: contents;"
                  .dataManager=${this.dataManager}
                ></notesgraph-table-add-button>`}
            ${html`<notesgraph-table-selection-layer
              style="display: contents;"
              .selectionController=${this.selectionController}
              .getRowRect=${this.getRowRect}
              .getColumnRect=${this.getColumnRect}
              .getAreaRect=${this.getAreaRect}
            ></notesgraph-table-selection-layer>`}
          </table>
        </div>
      </div>
    `;
