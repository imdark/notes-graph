import { cssVar, cssVarV2 } from '@blocksuite/notesgraph-shared/theme';
...
export const cellContainerStyle = css({
  ...
  textAlign: 'start',
  verticalAlign: 'top',
  'notesgraph-table[data-internal-range-selection="true"] &': {
    userSelect: 'text',
    WebkitUserSelect: 'text',
  },
  'notesgraph-table[data-internal-range-selection="true"] & rich-text': {
    userSelect: 'text',
    WebkitUserSelect: 'text',
  },
  'notesgraph-table[data-internal-range-selection="true"] & rich-text *': {
