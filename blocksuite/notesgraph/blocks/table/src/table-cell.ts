...
import { TextBackgroundDuotoneIcon } from '@blocksuite/notesgraph-components/icons';
import { DefaultInlineManagerExtension } from '@blocksuite/notesgraph-inline-preset';
import type { TableColumn, TableRow } from '@blocksuite/notesgraph-model';
import { RichText } from '@blocksuite/notesgraph-rich-text';
...
export const TableCellComponentName = 'notesgraph-table-cell';
export class TableCell extends SignalWatcher(
  ...
  get inlineManager() {
    return this.closest<TableBlockComponent>('notesgraph-table')?.std.get(
      DefaultInlineManagerExtension.identifier
    );
  }

  get topContenteditableElement() {
    return this.closest<TableBlockComponent>('notesgraph-table')
        ...
        <rich-text
          ...
          .verticalScrollContainerGetter="${() =>
            this.topContenteditableElement?.host
              ...
              : null}"
          data-parent-flavour="notesgraph:table"
        ></rich-text>
