...
export class DatabaseTitle extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .notesgraph-database-title .text {
      user-select: none;
      opacity: 0;
      white-space: pre-wrap;
    }

    .notesgraph-database-title[data-title-focus='false'] textarea {
      opacity: 0;
    }

    .notesgraph-database-title[data-title-focus='false'] .text {
    ...
    .notesgraph-database-title [data-title-empty='true']::before {
      content: 'Untitled';
      position: absolute;
      pointer-events: none;
      color: var(--notesgraph-text-primary-color);
    ...
    .notesgraph-database-title [data-title-focus='true']::before {
      color: var(--notesgraph-placeholder-color);
    }

    .notesgraph-database-title.comment-highlighted {
  ...
  get database() {
    return this.closest<DatabaseBlockComponent>('notesgraph-database');
  }
  ...
  override render() {
    ...
    const classList = classMap({
      'notesgraph-database-title': true,
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-database-title': DatabaseTitle;
  }
}
