...
import type { Rect } from '@blocksuite/notesgraph-gfx-turbo-renderer';
import {
...
export class ListLayoutHandlerExtension extends BlockLayoutHandlerExtension<ListLayout> {
  readonly blockType = 'notesgraph:list';
  ...
  override queryLayout(
    ...
    const listItemSelector =
      '.notesgraph-list-block-container .notesgraph-list-rich-text-wrapper [data-v-text="true"]';
    ...
    listItemNodes.forEach(listItemNode => {
      ...
      if (listItemWrapper.classList.contains('notesgraph-list--checked')) {
        checked = true;
      }
