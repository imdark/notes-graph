import { ListBlockSchema } from '@blocksuite/notesgraph-model';
import {
  AdapterTextUtils,
...
export const listBlockHtmlAdapterMatcher: BlockHtmlAdapterMatcher = {
  ...
  fromBlockSnapshot: {
    enter: (o, context) => {
      ...
      if (
        walkerContext.getNodeContext('notesgraph:list:parent') === o.parent &&
        ...
        walkerContext.setNodeContext('notesgraph:list:parent', o.parent);
      }
      ...
      walkerContext.openNode(
        {
          ...
          tagName: 'li',
          properties: {
            className: ['notesgraph-list-block-container'],
          },
          children: liChildren,
        },
        'children'
    ...
    leave: (o, context) => {
      ...
      if (
        walkerContext.getPreviousNodeContext('notesgraph:list:parent') ===
          o.parent &&
        ...
        walkerContext.closeNode();
        if (
          o.next?.flavour !== 'notesgraph:list' ||
