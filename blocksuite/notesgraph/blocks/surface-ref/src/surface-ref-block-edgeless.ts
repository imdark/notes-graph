import { type SurfaceRefBlockModel } from '@blocksuite/notesgraph-model';
...
export class EdgelessSurfaceRefBlockComponent extends BlockComponent<SurfaceRefBlockModel> {
  static override styles = css`
    notesgraph-edgeless-surface-ref {
      position: relative;
      overflow: hidden;
    }

    .notesgraph-edgeless-surface-ref-container {
      border-radius: 8px;
      border: 1px solid
    ...
    .notesgraph-edgeless-surface-ref-container.focused {
  ...
  override renderBlock() {
    return html` <div
      class=${classMap({
        'notesgraph-edgeless-surface-ref-container': true,
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-edgeless-surface-ref': EdgelessSurfaceRefBlockComponent;
  }
}
