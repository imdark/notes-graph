...
import { CopyIcon, DeleteIcon } from '@blocksuite/notesgraph-components/icons';
...
export class DataViewBlockComponent extends CaptionedBlockComponent<DataViewBlockModel> {
  static override styles = css`
    ${unsafeCSS(dataViewCommonStyle('notesgraph-database'))}
    notesgraph-database {
      display: block;
      border-radius: 8px;
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-data-view': DataViewBlockComponent;
  }
}
