...
import { Peekable } from '@blocksuite/notesgraph-components/peek';
import { ViewExtensionManagerIdentifier } from '@blocksuite/notesgraph-ext-loader';
import {
  type DocLinkClickedEvent,
  RefNodeSlotsProvider,
} from '@blocksuite/notesgraph-inline-reference';
import {
  type AliasInfo,
  type DocMode,
...
import { cloneReferenceInfo } from '@blocksuite/notesgraph-shared/utils';
import {
  BlockSelection,
  BlockStdScope,
  type EditorHost,
...
export class EmbedSyncedDocBlockComponent extends EmbedBlockComponent<EmbedSyncedDocModel> {
    ...
    class EmbedSyncedDocWatcher extends LifeCycleWatcher {
      ...
      override mounted(): void {
        ...
        view.viewUpdated.subscribe(payload => {
          if (
            payload.type !== 'block' ||
            payload.view.model.flavour !== 'notesgraph:embed-synced-doc'
          ) {
            return;
          }
  ...
  protected _renderSyncedView = () => {
    ...
    const renderEditor = () => {
      return choose(editorMode, [
        [
          'page',
          () => html`
            <div class="notesgraph-page-viewport" data-theme=${appTheme}>
              ${new BlockStdScope({
                store: syncedDoc,
        ...
        [
          ...
          () => html`
            <div
              class="notesgraph-edgeless-viewport"
    ...
    return this.renderEmbed(
      () => html`
        <div
          class=${classMap({
            'notesgraph-embed-synced-doc-container': true,
            [editorMode]: true,
            [theme]: true,
            surface: false,
        ...
        >
          <div class="notesgraph-embed-synced-doc-editor">
            ${isPageMode && this._isEmptySyncedDoc
              ? html`
                  <div class="notesgraph-embed-synced-doc-editor-empty">
                    <span>
          ...
          <div
            class=${classMap({
              'notesgraph-embed-synced-doc-header-wrapper': true,
              selected: this.selected$.value,
            })}
          >
            <div class="notesgraph-embed-synced-doc-header">
              <span class="notesgraph-embed-synced-doc-icon"
                >${this.icon$.value}</span
              >
              <span class="notesgraph-embed-synced-doc-title"
                >${this.title$}</span
              >
            </div>
          </div>
  ...
  @query(
    ':scope > .notesgraph-block-component > .embed-block-container > notesgraph-embed-synced-doc-card'
  )
  accessor syncedDocCard: EmbedSyncedDocCard | null = null;

  @query(
    ':scope > .notesgraph-block-component > .embed-block-container > .notesgraph-embed-synced-doc-container > .notesgraph-embed-synced-doc-editor > div > editor-host'
  )
