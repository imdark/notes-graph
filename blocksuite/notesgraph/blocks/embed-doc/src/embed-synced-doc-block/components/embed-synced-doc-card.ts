...
import { RENDER_CARD_THROTTLE_MS } from '@blocksuite/notesgraph-block-embed';
import { LoadingIcon } from '@blocksuite/notesgraph-components/icons';
...
export class EmbedSyncedDocCard extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    ...
    return html`
      <div
        class="notesgraph-embed-synced-doc-card ${cardClassMap}"
        @click=${this._handleClick}
      >
        <div class="notesgraph-embed-synced-doc-card-content">
          <div class="notesgraph-embed-synced-doc-card-content-title">
            <div class="notesgraph-embed-synced-doc-card-content-title-icon">
              ${icon}
            </div>

            <div class="notesgraph-embed-synced-doc-card-content-title-text">
              ${title}
            </div>
          </div>
          ...
          ${showDefaultNoteContent
            ? html`<div
                class="notesgraph-embed-synced-doc-content-note default"
              >
                ${defaultNoteContent}
              </div>`
            : nothing}
          <div class="notesgraph-embed-synced-doc-content-note render"></div>

          ${error
            ? html`
                <div class="notesgraph-embed-synced-doc-card-content-reload">
                  <div
                    class="notesgraph-embed-synced-doc-card-content-reload-button"
              ...
              `
            : html`
                <div class="notesgraph-embed-synced-doc-card-content-date">
                  <span>Updated</span>
        ...
        <div class="notesgraph-embed-synced-doc-card-banner render"></div>

        ${showDefaultBanner
          ? html`
              <div class="notesgraph-embed-synced-doc-card-banner default">
                ${defaultBanner}
              </div>
            `
          : nothing}
  ...
  @queryAsync('.notesgraph-embed-synced-doc-card-banner.render')
  ...
  @queryAsync('.notesgraph-embed-synced-doc-content-note.render')
