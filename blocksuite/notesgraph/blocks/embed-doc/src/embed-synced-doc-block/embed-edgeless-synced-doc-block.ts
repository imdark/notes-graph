...
import { toEdgelessEmbedBlock } from '@blocksuite/notesgraph-block-embed';
import {
  EdgelessCRUDIdentifier,
  reassociateConnectorsCommand,
} from '@blocksuite/notesgraph-block-surface';
import { type AliasInfo } from '@blocksuite/notesgraph-model';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
...
export class EmbedEdgelessSyncedDocBlockComponent extends toEdgelessEmbedBlock(
  ...
  @query('.notesgraph-embed-synced-doc-edgeless-header-wrapper')
  accessor headerWrapper: HTMLDivElement | null = null;

  @query('notesgraph-preview-root')
    ...
    return this.renderEmbed(
      () => html`
        <div
          ...
          ?data-scale=${scale}
        >
          <div class="notesgraph-embed-synced-doc-edgeless-header-wrapper">
            ${header}
          </div>
          ...
          <div class="notesgraph-embed-synced-doc-editor-overlay"></div>
        </div>
      `
    );
  };
