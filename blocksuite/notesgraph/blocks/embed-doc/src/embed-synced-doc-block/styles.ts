import { embedNoteContentStyles } from '@blocksuite/notesgraph-block-embed';
import {
  EMBED_CARD_HEIGHT,
  EMBED_CARD_WIDTH,
...
export const blockStyles = css`
  ...
  notesgraph-embed-synced-doc-block[data-page-mode] {
  ...
  .edgeless-block-portal-embed
    > notesgraph-embed-synced-doc-block[data-nested-editor] {
    position: relative;
    display: block;
    left: 0px;
    top: 0px;
  ...
  .edgeless-block-portal-embed
    .notesgraph-embed-synced-doc-editor
    .notesgraph-page-root-block-container {
    width: 100%;
  }

  .edgeless-block-portal-embed .notesgraph-embed-synced-doc-container.edgeless {
    display: block;
    padding: 0;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .edgeless-block-portal-embed .notesgraph-embed-synced-doc-container.surface {
    border: 1px solid var(--notesgraph-border-color);
  }

  notesgraph-embed-synced-doc-block[data-nested-editor],
  notesgraph-embed-edgeless-synced-doc-block[data-nested-editor] {
    .notesgraph-embed-synced-doc-container.page {
  ...
  .notesgraph-embed-synced-doc-container {
    border: 1px solid transparent;
    border-radius: 8px;
    overflow: hidden;
  }
  .notesgraph-embed-synced-doc-container.comment-highlighted {
    outline: 2px solid ${unsafeCSSVarV2('block/comment/highlightUnderline')};
  }
  .notesgraph-embed-synced-doc-container.show-hover-border:hover {
  ...
  .notesgraph-embed-synced-doc-container.edgeless {
    display: block;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .notesgraph-embed-synced-doc-header-wrapper {
    position: absolute;
    top: 0;
    left: 0;
    height: 34px;
    width: 100%;
    background-color: var(--notesgraph-white);
    opacity: 0;
  }
  @media print {
    .notesgraph-embed-synced-doc-header-wrapper {
  ...
  .notesgraph-embed-synced-doc-header-wrapper.selected {
    opacity: 1;
    transition: all 0.23s ease;
  }
  .notesgraph-embed-synced-doc-header {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .notesgraph-embed-synced-doc-header svg {
    flex-shrink: 0;
  }
  .notesgraph-embed-synced-doc-icon {
    line-height: 0;
    color: ${unsafeCSSVarV2('icon/primary')};
  }
  .notesgraph-embed-synced-doc-title {
    font-size: 14px;
    font-weight: 600;
    line-height: 22px;
    margin-left: 8px;
  ...
  .notesgraph-embed-synced-doc-editor-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .notesgraph-embed-synced-doc-editor-empty {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .notesgraph-embed-synced-doc-container.surface
    > .notesgraph-embed-synced-doc-editor
    > .notesgraph-embed-synced-doc-editor-empty {
    left: 0;
  ...
  .notesgraph-embed-synced-doc-editor-empty > span {
  ...
  .notesgraph-embed-synced-doc-container
    > .notesgraph-embed-synced-doc-editor.notesgraph-page-viewport {
    background: transparent;
  }

  .notesgraph-embed-synced-doc-container > .notesgraph-embed-synced-doc-editor {
    width: 100%;
    height: 100%;
  }

  .notesgraph-embed-synced-doc-editor .notesgraph-page-root-block-container {
    width: 100%;
    max-width: 100%;
  }
...
export const cardStyles = css`
  .notesgraph-embed-synced-doc-card {
    margin: 0 auto;
  ...
  .notesgraph-embed-synced-doc-card-content {
  ...
  .notesgraph-embed-synced-doc-card-content-title {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .notesgraph-embed-synced-doc-card-content-title-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
  ...
  .notesgraph-embed-synced-doc-card-content-title-icon svg {
    width: 16px;
    height: 16px;
    fill: var(--notesgraph-background-primary-color);
  }

  .notesgraph-embed-synced-doc-card-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .notesgraph-embed-synced-doc-content-note.render {
    display: none;
    overflow: hidden;
    pointer-events: none;
  }
  ...
  .notesgraph-embed-synced-doc-content-note.default {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
    white-space: normal;
  ...
  .notesgraph-embed-synced-doc-card-content-date,
  .notesgraph-embed-synced-doc-card-content-reload {
    display: flex;
    flex-grow: 1;
  ...
  .notesgraph-embed-synced-doc-card-content-date > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .notesgraph-embed-synced-doc-card-content-reload-button {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 4px;
  ...
  .notesgraph-embed-synced-doc-card-content-reload-button svg {
    width: 12px;
    height: 12px;
  }
  .notesgraph-embed-synced-doc-card-content-reload-button > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
    word-break: break-all;
  ...
  .notesgraph-embed-synced-doc-card-banner {
  ...
  .notesgraph-embed-synced-doc-card-banner.render {
    display: none;
  }
  .notesgraph-embed-synced-doc-card-banner img,
  .notesgraph-embed-synced-doc-card-banner object,
  .notesgraph-embed-synced-doc-card-banner svg {
    width: 204px;
    max-width: 100%;
    height: 102px;
    object-fit: cover;
  ...
  .notesgraph-embed-synced-doc-card.loading,
  .notesgraph-embed-synced-doc-card.deleted,
  .notesgraph-embed-synced-doc-card.error {
    .notesgraph-embed-linked-doc-content-note.render {
      display: none;
    }
    .notesgraph-embed-linked-doc-content-note.default {
      display: block;
    }
    .notesgraph-embed-synced-doc-card-banner.render {
      display: none;
    }
    .notesgraph-embed-synced-doc-card-banner.default {
      display: block;
    }
    .notesgraph-embed-synced-doc-card-content-date {
      display: none;
  ...
  .notesgraph-embed-synced-doc-card:not(.loading).deleted,
  .notesgraph-embed-synced-doc-card:not(.loading).error {
    background: var(--notesgraph-background-secondary-color);
  }
  .notesgraph-embed-synced-doc-card:not(.loading):not(.error):not(
      .surface
    ).deleted {
  ...
  .notesgraph-embed-synced-doc-card:not(.loading):not(.error):not(.deleted):not(
      .note-empty
    ).cycle {
    .notesgraph-embed-synced-doc-content-note.render {
      display: block;
  ...
  .notesgraph-embed-synced-doc-card.surface:not(.cycle) {
    ...
    .notesgraph-embed-synced-doc-card-content-note {
      margin: 0 auto;
      flex-grow: 0;
    }
  ...
  .notesgraph-embed-synced-doc-card.surface:not(.loading):not(.error):not(
      .deleted
    ).cycle {
  ...
  .notesgraph-embed-synced-doc-edgeless-header-wrapper {
    position: relative;
