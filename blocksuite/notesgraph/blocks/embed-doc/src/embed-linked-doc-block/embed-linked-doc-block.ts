...
import { isPeekable, Peekable } from '@blocksuite/notesgraph-components/peek';
...
export class EmbedLinkedDocBlockComponent extends EmbedBlockComponent<EmbedLinkedDocModel> {
  ...
  private readonly _renderEmbedView = () => {
    ...
    return this.renderEmbed(
      () => html`
        <div
          class="notesgraph-embed-linked-doc-block ${cardClassMap}"
          @click=${this._handleClick}
          @dblclick=${this._handleDoubleClick}
        >
          <div class="notesgraph-embed-linked-doc-content">
            <div class="notesgraph-embed-linked-doc-content-title">
              <div class="notesgraph-embed-linked-doc-content-title-icon">
                ${icon}
              </div>

              <div class="notesgraph-embed-linked-doc-content-title-text">
                ${title}
              </div>
            </div>
            ...
            ${when(
              ...
              () =>
                html`<div
                  class="notesgraph-embed-linked-doc-content-note alias"
                >
                  ${repeat(
              ...
              () =>
                when(
                  ...
                  () => html`
                    <div
                      class="notesgraph-embed-linked-doc-content-note default"
                    >
                      ${defaultNoteContent}
                    </div>
                  `,
                  () => html`
                    <div
                      class="notesgraph-embed-linked-doc-content-note render"
                    ></div>
                  `
                )
            )}
            ${isError
              ? html`
                  <div class="notesgraph-embed-linked-doc-card-content-reload">
                    <div
                      class="notesgraph-embed-linked-doc-card-content-reload-button"
                ...
                `
              : html`
                  <div class="notesgraph-embed-linked-doc-content-date">
                    <span>Updated</span>
          ...
          ${showDefaultBanner
            ? html`
                <div class="notesgraph-embed-linked-doc-banner default">
                  ${defaultBanner}
                </div>
              `
            : nothing}
  ...
  @queryAsync('.notesgraph-embed-linked-doc-content-note.render')
