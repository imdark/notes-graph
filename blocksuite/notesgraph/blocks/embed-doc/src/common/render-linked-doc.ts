import { getNotesFromDoc } from '@blocksuite/notesgraph-block-embed';
...
import { EMBED_CARD_HEIGHT } from '@blocksuite/notesgraph-shared/consts';
...
async function renderNoteContent(
  ...
  noteBlocksContainer.classList.add('notesgraph-embed-doc-content-note-blocks');
