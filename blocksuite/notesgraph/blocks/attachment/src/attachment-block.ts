...
import {
  ...
  ResourceController,
} from '@blocksuite/notesgraph-components/resource';
...
export class AttachmentBlockComponent extends CaptionedBlockComponent<AttachmentBlockModel> {
  ...
  protected renderUpgradeButton = () => {
    ...
    return when(
      ...
      () => html`
        <button
          class="notesgraph-attachment-content-button"
  ...
  protected renderWithHorizontal(
    ...
    return html`
      <div class=${classMap(classInfo)}>
        <div class="notesgraph-attachment-content">
          <div class="notesgraph-attachment-content-title">
            <div class="notesgraph-attachment-content-title-icon">${icon}</div>
            <div class="notesgraph-attachment-content-title-text truncate">
              ${title}
            </div>
          </div>

          <div class="notesgraph-attachment-content-description">
            <div class="notesgraph-attachment-content-info truncate">
              ${description}
            </div>
            ${choose(state, [
        ...
        <div class="notesgraph-attachment-banner">${kind}</div>
      </div>
    `;
  }
  ...
  protected renderWithVertical(
    ...
    return html`
      <div class=${classMap(classInfo)}>
        ...
        <div class="notesgraph-attachment-banner">
          ${kind}
          ${choose(state, [
            ['error', () => this.renderNormalButton(needUpload)],
            ['error:oversize', this.renderUpgradeButton],
  ...
  protected renderCardView = () => {
    ...
    const classInfo = {
      'notesgraph-attachment-card': true,
      [cardStyle]: true,
  ...
  protected renderEmbedView = () => {
    ...
    return html`
      <div class="notesgraph-attachment-embed-container">
      ...
      ${when(enabled, () => {
        ...
        return html`
          <notesgraph-resource-status
            class="notesgraph-attachment-embed-status"
            .message=${message}
  ...
  private readonly _renderCitation = () => {
    ...
    return html`<notesgraph-citation-card
      .icon=${icon}
      .citationTitle=${name}
  ...
  override renderBlock() {
    return html`
      <div
        class=${classMap({
          'notesgraph-attachment-container': true,
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-attachment': AttachmentBlockComponent;
  }
}
