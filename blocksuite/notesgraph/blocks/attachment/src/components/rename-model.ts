import { ConfirmIcon } from '@blocksuite/notesgraph-components/icons';
...
import { CitationProvider } from '@blocksuite/notesgraph-shared/services';
...
export const RenameModal = ({
  ...
  return html`
    ...
    <div
      class="notesgraph-attachment-rename-overlay-mask"
      @click="${abort}"
    ></div>
    <div class="notesgraph-attachment-rename-container">
      <div class="notesgraph-attachment-rename-input-wrapper">
        <input
          ${ref(inputRef)}
          type="text"
          .value=${fileName}
          ...
          @keydown=${onKeydown}
        />
        <span class="notesgraph-attachment-rename-extension">${extension}</span>
      </div>
      <editor-icon-button
