...
import { reassociateConnectorsCommand } from '@blocksuite/notesgraph-block-surface';
...
import { getBlockProps } from '@blocksuite/notesgraph-shared/utils';
...
const previewAction = {
  ...
  content(ctx) {
    ...
    return html`<notesgraph-link-preview
      .url=${url}
  ...
  actions: [
      ...
      actions: [
        {
          ...
          run(ctx) {
            ...
            ctx.store.addBlock('notesgraph:paragraph', { text }, parent, index);
    ...
    } satisfies ToolbarActionGroup<ToolbarAction>,
    {
      ...
      content(ctx) {
        ...
        return html`${keyed(
          model,
          html`<notesgraph-card-style-dropdown-menu
            @toggle=${onToggle}
            .actions=${actions}
            .context=${ctx}
  ...
  actions: [
    ...
    },
    {
      ...
      content(ctx) {
        ...
        return html`${keyed(
          model,
          html`<notesgraph-size-dropdown-menu
            @select=${onSelect}
            @toggle=${onToggle}
            .format=${format}
            .sizeSignal=${scale$}
          ></notesgraph-size-dropdown-menu>`
        )}`;
      },
    },
  ],
...
export const createBuiltinToolbarConfigExtension = (
  ...
  return [
    ...
    ToolbarModuleExtension({
      id: BlockFlavourIdentifier(`notesgraph:surface:${name}`),
