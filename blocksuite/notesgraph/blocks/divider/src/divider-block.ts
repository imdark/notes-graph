...
import type { DividerBlockModel } from '@blocksuite/notesgraph-model';
import { BLOCK_CHILDREN_CONTAINER_PADDING_LEFT } from '@blocksuite/notesgraph-shared/consts';
...
export class DividerBlockComponent extends CaptionedBlockComponent<DividerBlockModel> {
  ...
  override renderBlock() {
    ...
    return html`
      <div class="notesgraph-divider-block-container">
        <hr />
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-divider': DividerBlockComponent;
  }
}
