import { selectBlock } from '@blocksuite/notesgraph-block-note';
...
import type { LatexBlockModel } from '@blocksuite/notesgraph-model';
...
declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-latex': LatexBlockComponent;
  }
}
