...
import { BlockLayoutPainterExtension } from '@blocksuite/notesgraph-gfx-turbo-renderer/painter';

export interface CodeLayout extends BlockLayout {
  type: 'notesgraph:code';
}

function isCodeLayout(layout: BlockLayout): layout is CodeLayout {
  return layout.type === 'notesgraph:code';
}
