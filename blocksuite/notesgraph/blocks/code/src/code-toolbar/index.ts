...
import type { CodeBlockModel } from '@blocksuite/notesgraph-model';
import {
  BlockSelection,
  TextSelection,
  WidgetComponent,
...
export const NOTESGRAPH_CODE_TOOLBAR_WIDGET = 'notesgraph-code-toolbar-widget';
export class NotesGraphCodeToolbarWidget extends WidgetComponent<
  CodeBlockModel,
  CodeBlockComponent
> {
