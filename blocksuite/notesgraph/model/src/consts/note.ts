...
export enum NoteShadow {
  Box = '--notesgraph-note-shadow-box',
  Film = '--notesgraph-note-shadow-film',
  Float = '--notesgraph-note-shadow-float',
  None = '',
  Paper = '--notesgraph-note-shadow-paper',
  Sticker = '--notesgraph-note-shadow-sticker',
}
