...
export const LatexExtension = InlineMarkdownExtension<NotesGraphTextAttributes>(
  {
    name: 'latex',
    ...
    action: ({
      ...
      const ifEdgelessText = blockComponent.closest('notesgraph-edgeless-text');
      ...
      if (blockPrefix === '$$$$') {
        ...
        blockComponent.host.updateComplete
          .then(() => {
            ...
            if (!latexBlock || latexBlock.flavour !== 'notesgraph:latex')
              return;
