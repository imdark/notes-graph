...
import { HoverController } from '@blocksuite/notesgraph-components/hover';
import { PeekViewProvider } from '@blocksuite/notesgraph-components/peek';
import type { FootNote } from '@blocksuite/notesgraph-model';
...
import { isValidUrl, normalizeUrl } from '@blocksuite/notesgraph-shared/utils';
import {
  BlockSelection,
  type BlockStdScope,
  ShadowlessElement,
...
export class NotesGraphFootnoteNode extends WithDisposable(ShadowlessElement) {
