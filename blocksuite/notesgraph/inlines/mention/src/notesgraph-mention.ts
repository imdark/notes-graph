...
import { UserProvider } from '@blocksuite/notesgraph-shared/services';
...
export class NotesGraphMention extends SignalWatcher(
  ...
  static override styles = css`
    .notesgraph-mention {
      ...
      /* Client/baseMedium */
      font-family: Inter;
      font-size: var(--notesgraph-font-size-base);
      font-style: normal;
      font-weight: 500;
    ...
    .notesgraph-mention:hover {
      background: var(--notesgraph-hover-color);
    }
    .notesgraph-mention[data-selected='true'] {
      background: var(--notesgraph-hover-color);
    }
    .notesgraph-mention[data-type='default'] {
      color: ${unsafeCSSVarV2('text/primary')};
    }
    .notesgraph-mention[data-type='removed'] {
      color: ${unsafeCSSVarV2('text/disable')};
    }
    .notesgraph-mention[data-type='error'] {
      color: ${unsafeCSSVarV2('text/disable')};
    }
    .notesgraph-mention[data-type='loading'] {
