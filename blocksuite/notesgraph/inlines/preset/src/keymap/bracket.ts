import { insertLinkedNode } from '@blocksuite/notesgraph-inline-reference';
import { CodeBlockModel } from '@blocksuite/notesgraph-model';
import { getInlineEditorByModel } from '@blocksuite/notesgraph-rich-text';
import { BRACKET_PAIRS } from '@blocksuite/notesgraph-shared/consts';
import {
  createDefaultDoc,
  matchModels,
