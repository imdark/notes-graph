  ...
  return new Promise<void>((resolve, reject) => {
    ...
    iframe.onload = async () => {
      ...
      doc.write(`<!DOCTYPE html><html><head><style>@media print {
                ...
                :root, body {
                  --notesgraph-text-primary: #000 !important;
                  --notesgraph-text-secondary: #111 !important;
                  --notesgraph-text-tertiary: #333 !important;
                  --notesgraph-background-primary: #fff !important;
                  --notesgraph-background-secondary: #fff !important;
                  --notesgraph-background-tertiary: #fff !important;
                }
                ...
                :root {
                  --notesgraph-note-shadow-box: none !important;
                  --notesgraph-note-shadow-sticker: none !important;
                }
      ...
      iframe.contentWindow.document
        .write(`<!DOCTYPE html><html><head><style>@media print {
              ...
              :root, body {
                ...
                --notesgraph-background-secondary: #fff !important;
                --notesgraph-background-tertiary: #fff !important;
                --notesgraph-background-code-block: #f5f5f5 !important;
                --notesgraph-quote-color: #e3e3e3 !important;
                --notesgraph-border-color: #e3e3e3 !important;
              }
              body, [data-theme='dark'] {
                color: #000 !important;
                background: #fff !important;
