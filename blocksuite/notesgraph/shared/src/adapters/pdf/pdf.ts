...
pdfMake.fonts = {
  Inter: {
    normal: 'https://cdn.notesgraph.com/fonts/Inter-Regular.woff',
    bold: 'https://cdn.notesgraph.com/fonts/Inter-SemiBold.woff',
    italics: 'https://cdn.notesgraph.com/fonts/Inter-Italic.woff',
    bolditalics: 'https://cdn.notesgraph.com/fonts/Inter-SemiBoldItalic.woff',
  },
  SarasaGothicCL: {
    normal: 'https://cdn.notesgraph.com/fonts/SarasaGothicCL-Regular.ttf',
    bold: 'https://cdn.notesgraph.com/fonts/SarasaGothicCL-Regular.ttf',
    italics: 'https://cdn.notesgraph.com/fonts/SarasaGothicCL-Regular.ttf',
    bolditalics: 'https://cdn.notesgraph.com/fonts/SarasaGothicCL-Regular.ttf',
  },
};
...
export class PdfAdapter extends BaseAdapter<PdfAdapterFile> {
  ...
  private async _blockToContent(
    ...
    if (flavour === 'notesgraph:paragraph') {
    ...
    } else if (flavour === 'notesgraph:list') {
      content.push(
    ...
    } else if (flavour === 'notesgraph:code') {
      content.push(...this._createCodeContent(props, textContent, baseIndent));
    } else if (flavour === 'notesgraph:divider') {
      content.push({
        canvas: [
          {
            type: 'line',
    ...
    } else if (flavour === 'notesgraph:callout') {
      ...
      return content;
    } else if (flavour === 'notesgraph:bookmark') {
      content.push({
    ...
    if (block.children && block.children.length) {
      const shouldIncrementDepth =
        flavour !== 'notesgraph:page' && flavour !== 'notesgraph:note';
  ...
  private async _createListContent(
    ...
    const blueColor =
      resolveCssVariable('var(--notesgraph-blue-700)') || '#1E96EB';
  ...
  private async _createCalloutContent(
    ...
    const colorVar =
      backgroundColorName === 'default' || backgroundColorName === 'grey'
        ? 'var(--notesgraph-v2-block-callout-background-grey)'
        : `var(--notesgraph-v2-block-callout-background-${backgroundColorName})`;
