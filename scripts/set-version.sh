...
update_app_stream_version() {
  ...
  #     <url>https://github.com/notesgraph/notesgraph/releases/tag/v0.21.0</url>
  #   </release>
  # </releases>
  ...
  sed -i.bak -E "s|<url>https://github.com/notesgraph/notesgraph/releases/tag/v[^<]*</url>|<url>https://github.com/notesgraph/notesgraph/releases/tag/v$new_version</url>|" "$file_path" || {
    # If the sed command fails, print an error message and exit with a non-zero status
...
update_app_version_in_helm_charts ".github/helm/notesgraph/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/notesgraph/charts/graphql/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/notesgraph/charts/front/Chart.yaml" "$new_version"
update_app_version_in_helm_charts ".github/helm/notesgraph/charts/doc/Chart.yaml" "$new_version"

update_app_stream_version "packages/frontend/apps/electron/resources/notesgraph.metainfo.xml" "$new_version"
