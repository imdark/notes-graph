...
import { NotesGraphIconPicker } from './picker/notesgraph-icon/notesgraph-icon-picker';
    ...
    <div className={clsx(styles.container, className)} style={{ ...style }}>
      ...
      <main className={styles.main}>
        {activePanel === 'Emoji' ? (
          ...
          <NotesGraphIconPicker
            onSelect={(icon, color) => {
              onSelect?.({ type: IconType.NotesGraphIcon, name: icon, color });
            }}
          />
        ) : null}
      </main>
