...
export interface IconEditorProps {
  ...
  /**
   * Extra content rendered below the picker inside the popup (e.g. an AI
   * icon generator). The function form receives a close() callback so the
   * extra content can dismiss the popup after applying.
   */
