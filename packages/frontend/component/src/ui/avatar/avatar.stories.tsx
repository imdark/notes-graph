...
DefaultAvatar.args = {
  name: 'NotesGraph',
  url: 'https://notesgraph.com/favicon-96.png',
  size: 50,
};
...
export const ColorfulFallbackWithDifferentSize: StoryFn<AvatarProps> = args => (
  <>
    <Avatar {...args} size={20} colorfulFallback name="NotesGraph" />
    <Avatar {...args} size={40} colorfulFallback name="NotesGraph" />
    <Avatar {...args} size={60} colorfulFallback name="NotesGraph" />
  </>
);
