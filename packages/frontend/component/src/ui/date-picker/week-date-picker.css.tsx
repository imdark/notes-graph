...
export const dayCell = style({
  ...
  selectors: {
    ...
    '&::before': {
      boxShadow: '0 0 0 2px var(--notesgraph-brand-color)',
    },
    '&::after': {
      border: '1px solid var(--notesgraph-brand-color)',
    },
...
export const dayCellWeek = style({
  ...
  whiteSpace: 'nowrap',
  overflow: 'hidden',
  color: 'var(--cell-color, var(--notesgraph-text-secondary-color))',
});
export const dayCellDate = style({
  ...
  color: 'var(--cell-color, var(--notesgraph-text-primary-color))',
});
