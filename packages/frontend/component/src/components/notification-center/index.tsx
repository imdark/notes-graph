...
function NotificationCard(props: NotificationCardProps): ReactNode {
  ...
  return (
    <Toast.Root
      ...
      data-testid="notesgraph-notification"
      onMouseEnter={() => {
        setExpand(true);
      }}
      onMouseMove={() => {
          ...
          {notification.action && (
            ...
            >
              {notification.actionLabel ??
                t['com.notesgraph.keyboardShortcuts.undo']()}
            </div>
          )}
          ...
          <div className={styles.progressBarStyle}>
            <svg width="100%" height="4">
              <rect
                width="100%"
                height="4"
                fill="var(--notesgraph-hover-color)"
                rx="2"
                ry="2"
              />
              <rect
                width="0%"
                height="4"
                fill="var(--notesgraph-primary-color)"
                rx="2"
                ry="2"
              >
                <animate
...
/**
 * @deprecated use `import { NotificationCenter } from '@notesgraph/component'` instead
 */
