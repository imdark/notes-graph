import { emailRegex } from '@notesgraph/component/auth-components';
import type {
  InviteLink,
...
export const InviteTeamMemberModal = ({
  ...
  return (
    <ConfirmModal
      ...
      title={t['com.notesgraph.payment.member.team.invite.title']()}
      cancelText={t['com.notesgraph.inviteModal.button.cancel']()}
      cancelButtonOptions={{
        variant: 'secondary',
      }}
      contentOptions={{
      ...
      confirmText={
        inviteMethod === 'email'
          ? t['com.notesgraph.payment.member.team.invite.send-invites']()
          : t['com.notesgraph.payment.member.team.invite.done']()
      }
