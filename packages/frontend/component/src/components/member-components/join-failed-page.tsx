...
import { ErrorNames, type GetInviteInfoQuery } from '@notesgraph/graphql';
...
export const JoinFailedPage = ({
  ...
  return (
    <AuthPageContainer
      title={t['com.notesgraph.fail-to-join-workspace.title']()}
      subtitle={
        userFriendlyError.name === ErrorNames.MEMBER_QUOTA_EXCEEDED ? (
          <div className={styles.lineHeight}>
            <Trans
              i18nKey={'com.notesgraph.fail-to-join-workspace.description-1'}
              components={{
                1: (
            ...
            />
            <div>
              {t['com.notesgraph.fail-to-join-workspace.description-2']()}
            </div>
          </div>
        ) : (
          <div>
