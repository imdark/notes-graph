...
import type { GetInviteInfoQuery } from '@notesgraph/graphql';
...
export const SentRequestPage = ({
  ...
  return (
    <AuthPageContainer
      title={t['com.notesgraph.sent-request-to-join-workspace.title']()}
      subtitle={
        <div className={styles.lineHeight}>
          <Trans
            i18nKey="com.notesgraph.sent-request-to-join-workspace.description"
            components={{
              1: (
