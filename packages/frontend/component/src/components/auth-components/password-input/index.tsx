  ...
  return (
    <>
      <Input
        ...
        placeholder={t['com.notesgraph.auth.set.password.placeholder']({
          ...
          <div className={statusWrapper}>
            {status ? (
              <Tag
                status={status}
                minimum={t[
                  'com.notesgraph.auth.set.password.message.minlength'
                ]({
                  min: String(passwordLimits.minLength),
                })}
                maximum={t[
                  'com.notesgraph.auth.set.password.message.maxlength'
                ]({
      ...
      <Input
        ...
        size="extraLarge"
        placeholder={t[
          'com.notesgraph.auth.set.password.placeholder.confirm'
        ]()}
