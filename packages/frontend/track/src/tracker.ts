...
const SESSION_ID_KEY = 'notesgraph_telemetry_session_id';
const SESSION_NUMBER_KEY = 'notesgraph_telemetry_session_number';
const SESSION_NUMBER_CURRENT_KEY =
  'notesgraph_telemetry_session_number_current';
const LAST_ACTIVITY_KEY = 'notesgraph_telemetry_last_activity_ms';
