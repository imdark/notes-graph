import { Checkbox } from '@notesgraph/admin/components/ui/checkbox';
import { Label } from '@notesgraph/admin/components/ui/label';
import { Separator } from '@notesgraph/admin/components/ui/separator';
import { Switch } from '@notesgraph/admin/components/ui/switch';
import type { FeatureType } from '@notesgraph/graphql';
