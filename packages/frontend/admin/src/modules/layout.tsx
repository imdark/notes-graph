import {
  ResizablePanel,
  ResizablePanelGroup,
} from '@notesgraph/admin/components/ui/resizable';
import { Separator } from '@notesgraph/admin/components/ui/separator';
import { TooltipProvider } from '@notesgraph/admin/components/ui/tooltip';
    ...
    return (
      <Sheet>
        ...
        <SheetHeader className="hidden">
          <SheetTitle>NotesGraph</SheetTitle>
          <SheetDescription>
