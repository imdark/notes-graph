import { buttonVariants } from '@notesgraph/admin/components/ui/button';
...
const links = [
  {
    ...
    label: 'Star NotesGraph on GitHub',
  },
  {
    href: BUILD_CONFIG.githubUrl,
...
export function AboutNotesGraph() {
  return (
    <div className="flex flex-col h-full gap-3 py-5 px-6 w-full">
      <div className="flex items-center">
        <span className="text-xl font-semibold">About NotesGraph</span>
      </div>
