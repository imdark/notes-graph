...
import {
  ...
  CardHeader,
  CardTitle,
} from '@notesgraph/admin/components/ui/card';
import {
  type ChartConfig,
  ChartContainer,
  ChartTooltip,
  ChartTooltipContent,
} from '@notesgraph/admin/components/ui/chart';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogHeader,
  DialogTitle,
} from '@notesgraph/admin/components/ui/dialog';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  DropdownMenuTrigger,
} from '@notesgraph/admin/components/ui/dropdown-menu';
import { Label } from '@notesgraph/admin/components/ui/label';
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@notesgraph/admin/components/ui/select';
import { Separator } from '@notesgraph/admin/components/ui/separator';
import { Skeleton } from '@notesgraph/admin/components/ui/skeleton';
import {
  Table,
  TableBody,
  TableCell,
  ...
  TableHeader,
  TableRow,
} from '@notesgraph/admin/components/ui/table';
import { useMutation } from '@notesgraph/admin/use-mutation';
import { useQuery } from '@notesgraph/admin/use-query';
import {
  adminDashboardQuery,
