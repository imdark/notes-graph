  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        sidebar: {
          bg: 'var(--notesgraph-v2-selfhost-layer-background-sidebarBg-sidebarBg)',
          foreground: 'var(--notesgraph-v2-selfhost-text-sidebar-primary)',
          'foreground-secondary':
            'var(--notesgraph-v2-selfhost-text-sidebar-secondary)',
          hover: 'var(--notesgraph-v2-selfhost-button-sidebarButton-bg-hover)',
          active:
            'var(--notesgraph-v2-selfhost-button-sidebarButton-bg-select)',
        },
        // Chip / badge tokens
        chip: {
          blue: 'var(--notesgraph-v2-chip-label-blue)',
          white: 'var(--notesgraph-v2-chip-label-white)',
          text: 'var(--notesgraph-v2-chip-label-text)',
        },
        // Toggle tokens
        toggle: {
          on: 'var(--notesgraph-v2-selfhost-toggle-backgroundOn)',
          off: 'var(--notesgraph-v2-selfhost-toggle-backgroundOff)',
          thumb: 'var(--notesgraph-v2-selfhost-toggle-foreground)',
        },
      },
      borderRadius: {
