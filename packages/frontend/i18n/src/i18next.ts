...
import type { useNotesGraphI18N } from './i18n.gen';
...
export type I18nFuncs = ReturnType<typeof useNotesGraphI18N>;
...
export function createI18nWrapper(getI18nFn: () => i18n) {
  ...
  return new Proxy(I18nMethod, {
    ...
    ReturnType<typeof useNotesGraphI18N> & {
      [unknownKey: string]: () => string;
    };
}

/**
 * I18n['com.notesgraph.xxx']({ arg1: 'hello' }) -> '中文 hello'
 */
