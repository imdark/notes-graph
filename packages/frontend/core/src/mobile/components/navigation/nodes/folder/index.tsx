...
import type {
  ...
  NodeOperation,
} from '@notesgraph/core/desktop/components/navigation-panel';
...
const NavigationPanelFolderNodeFolder = ({
          ...
          <MenuSub
            ...
            items={
              <>
                ...
                >
                  {t[
                    'com.notesgraph.rootAppSidebar.organize.folder.add-docs'
                  ]()}
                </MenuItem>
                <MenuItem
  ...
  return (
    ...
    >
      ...
      <AddItemPlaceholder
        label={t['com.notesgraph.rootAppSidebar.organize.folder.new-doc']()}
        onClick={handleNewDoc}
