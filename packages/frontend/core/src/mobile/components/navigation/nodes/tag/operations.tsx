...
import { FavoriteService } from '@notesgraph/core/modules/favorite';
...
export const useNavigationPanelTagNodeOperations = (
  ...
  const handleMoveToTrash = useCallback(() => {
    ...
    toast(t['com.notesgraph.tags.delete-tags.toast']());
      ...
      'doc-selector',
      {
        ...
        onBeforeConfirm(ids, cb) {
          ...
          if (
            ...
            openConfirmModal({
              title: t['com.notesgraph.m.selector.remove-warning.title'](),
              description: t[
                'com.notesgraph.m.selector.remove-warning.message'
              ]({
                type: t['com.notesgraph.m.selector.type-doc'](),
                where: t['com.notesgraph.m.selector.where-tag'](),
              }),
              cancelText:
                t['com.notesgraph.m.selector.remove-warning.cancel'](),
              confirmText:
                t['com.notesgraph.m.selector.remove-warning.confirm'](),
              reverseFooter: true,
              onConfirm: () => {
      ...
      },
      {
        ...
        view: (
          <MenuItem prefixIcon={<FolderIcon />} onClick={handleOpenDocSelector}>
            {t['com.notesgraph.m.explorer.tag.manage-docs']()}
          </MenuItem>
        ),
      },
