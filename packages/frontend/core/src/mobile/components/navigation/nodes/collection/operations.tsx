  ...
  const handleRename = useCallback(
    (name: string) => {
      ...
      if (collection && collection.name$.value !== name) {
        ...
        notify.success({ message: t['com.notesgraph.toastMessage.rename']() });
      }
    },
    ...
    () => [
      {
        ...
        view: (
          <IconButton
            ...
            tooltip={t[
              'com.notesgraph.rootAppSidebar.explorer.collection-add-tooltip'
            ]()}
          >
            <PlusIcon />
          </IconButton>
      ...
      },
      {
        ...
        view: (
          <MenuItem prefixIcon={<FilterIcon />} onClick={handleShowEdit}>
            {t['com.notesgraph.collection.menu.edit']()}
          </MenuItem>
        ),
      },
      {
