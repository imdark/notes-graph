...
export const TagDesc = ({ input }: { input: string }) => {
  ...
  return input
    ? t['com.notesgraph.m.explorer.tag.new-tip-not-empty']({ value: input })
    : t['com.notesgraph.m.explorer.tag.new-tip-empty']();
};
...
export const NavigationPanelTags = () => {
  ...
  return (
    <CollapsibleSection
      path={path}
      title={t['com.notesgraph.rootAppSidebar.tags']()}
    >
      <NavigationPanelTreeRoot>
        ...
        <AddItemPlaceholder
          ...
          label={t[
            'com.notesgraph.rootAppSidebar.explorer.tag-section-add-tooltip'
          ]()}
        />
        <TagRenameDialog
