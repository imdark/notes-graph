...
import { ConfirmModal, notify, useConfirmModal } from '@notesgraph/component';
...
export const DeleteAccount = () => {
  ...
  return (
    <>
      {account ? (
        <RowLayout
          label={t['com.notesgraph.mobile.setting.others.delete-account']()}
          onClick={openModal}
        >
...
const DeleteAccountModal = ({
      ...
      openConfirmModal({
        ...
        description: (
          <>
            <span>
              {t[
                'com.notesgraph.setting.account.delete.success-description-1'
              ]()}
            </span>
            <br />
            <span>
              {t[
                'com.notesgraph.setting.account.delete.success-description-2'
              ]()}
            </span>
          </>
        ),
  ...
  return (
    <ConfirmModal
      ...
      description={
        <Trans
          i18nKey="com.notesgraph.setting.account.delete.confirm-description-2"
          components={{
            1: <strong />,
          }}
        />
