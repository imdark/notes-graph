...
export const AboutGroup = () => {
  ...
  return (
    <SettingGroup title={t['com.notesgraph.mobile.setting.about.title']()}>
      <RowLayout label={t['com.notesgraph.mobile.setting.about.appVersion']()}>
        {BUILD_CONFIG.isIOS
      ...
      <RowLayout
        label={t['com.notesgraph.mobile.setting.about.editorVersion']()}
      >
        {BUILD_CONFIG.isIOS
