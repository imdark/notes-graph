import { getBaseFontStyleOptions } from '@notesgraph/core/desktop/dialogs/setting/general-setting/editor/general';
import {
...
export const FontStyleSetting = () => {
  ...
  return (
    <RowLayout label={t['com.notesgraph.mobile.setting.appearance.font']()}>
