...
const ChangedRenderer = ({
  ...
  const addedText = added
    ? t['com.notesgraph.m.selector.info-added']({ count: `${added}`, type })
    : '';
  const removedText = removed
    ? t['com.notesgraph.m.selector.info-removed']({
        count: `${removed}`,
        type,
      })
    : '';
    ...
    <div className={styles.root}>
      <PageHeader back backAction={onBack}>
        <span className={styles.headerTitle}>
          {title ?? t['com.notesgraph.m.selector.title']({ type: typeText })}
        </span>
      </PageHeader>
      ...
      <SafeArea bottom className={styles.footer}>
        <div className={styles.info}>
          ...
          <div className={styles.totalInfo}>
            {t['com.notesgraph.m.selector.info-total']({
        ...
        <div className={styles.actions}>
          ...
          >
            {confirmText ?? t['com.notesgraph.m.selector.confirm-default']()}
          </Button>
        </div>
      </SafeArea>
    </div>
