...
globalStyle(':root', {
  vars: {
    ...
    '--notesgraph-edgeless-zoom-toolbar-bottom': `calc(10px + ${globalVars.appTabSafeArea})`,
  },
  userSelect: 'none',
...
globalStyle('body:has(>#app-tabs):not(:has(notesgraph-keyboard-toolbar))', {
  paddingBottom: globalVars.appTabSafeArea,
});
globalStyle('body:has(notesgraph-keyboard-toolbar)', {
