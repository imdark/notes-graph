...
import { SharePage } from '@notesgraph/core/desktop/pages/workspace/share/share-page';
import { workbenchRoutes } from '@notesgraph/core/mobile/workbench-router';
import { ServersService } from '@notesgraph/core/modules/cloud';
import { WorkspacesService } from '@notesgraph/core/modules/workspace';
import { FrameworkScope, useLiveData, useServices } from '@notesgraph/infra';
import {
  lazy as reactLazy,
  Suspense,
  useEffect,
