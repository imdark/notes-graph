...
import { MenuItem, MenuSeparator, MobileMenuSub } from '@notesgraph/component';
import { sortPagesByDate } from '@notesgraph/core/desktop/pages/workspace/detail-page/tabs/journal';
import {
  type DocRecord,
  DocService,
  DocsService,
...
const ActivityBlock = ({
  ...
  const title =
    name === 'created'
      ? t['com.notesgraph.journal.created-today']()
      : t['com.notesgraph.journal.updated-today']();
  return (
    <>
  ...
  return (
    <>
      ...
      <MobileMenuSub
        ...
        title={t['com.notesgraph.m.selector.journal-menu.today-activity']()}
      >
        {t['com.notesgraph.m.selector.journal-menu.today-activity']()}
      </MobileMenuSub>
      {suffix}
    </>
  );
