...
import { ViewportElementExtension } from '@blocksuite/notesgraph/shared/services';
import { openFilesWith } from '@blocksuite/notesgraph/shared/utils';
import { type DocSnapshot, nanoid, Store } from '@blocksuite/notesgraph/store';
import type { TextSelection } from '@blocksuite/std';
import { IconButton, notify, toast } from '@notesgraph/component';
import {
  LitDocEditor,
  type PageEditor,
...
import type { CommentAttachment } from '@notesgraph/core/modules/comment/types';
import { PeekViewService } from '@notesgraph/core/modules/peek-view';
import { downloadResourceWithUrl } from '@notesgraph/core/utils/resource';
import { DebugLogger } from '@notesgraph/debug';
import { useFramework, useService } from '@notesgraph/infra';
