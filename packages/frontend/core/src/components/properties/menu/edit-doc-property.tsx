...
export const EditWorkspacePropertyMenuItems = ({
  ...
  return (
    <>
      ...
      >
        {t['com.notesgraph.page-properties.create-property.menu.header']()}
        <div className={styles.propertyTypeName}>
          <WorkspacePropertyIcon propertyInfo={propertyInfo} />
          {t[`com.notesgraph.page-properties.property.${propertyType}`]()}
        </div>
      </div>
      <MenuSeparator />
      <MenuItem
        ...
        disabled={readonly}
      >
        {t['com.notesgraph.page-properties.property.always-show']()}
      </MenuItem>
      <MenuItem
        ...
        disabled={readonly}
      >
        {t['com.notesgraph.page-properties.property.hide-when-empty']()}
      </MenuItem>
      <MenuItem
        prefixIcon={<InvisibleIcon />}
        ...
        disabled={readonly}
      >
        {t['com.notesgraph.page-properties.property.always-hide']()}
      </MenuItem>
      <MenuSeparator />
      <MenuItem
        ...
        onClick={() => {
          confirmModal.openConfirmModal({
            title:
              t[
                'com.notesgraph.settings.workspace.properties.delete-property'
              ](),
            description: (
              <Trans
                values={{
                ...
                i18nKey="com.notesgraph.settings.workspace.properties.delete-property-desc"
              >
      ...
      >
        {t['com.notesgraph.settings.workspace.properties.delete-property']()}
      </MenuItem>
    </>
  );
};
