import { MenuItem, MenuSeparator } from '@notesgraph/component';
...
import { generateUniqueNameInSequence } from '@notesgraph/core/utils/unique-name';
        ...
        return (
          ...
          >
            <div className={styles.propertyItem}>
              ...
              {isUniqueExist && (
                <span>
                  {t['com.notesgraph.page-properties.create-property.added']()}
                </span>
              )}
            </div>
          </MenuItem>
