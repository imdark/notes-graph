import { Button, Divider } from '@notesgraph/component';
  ...
  return (
    <div className={styles.root}>
      <section className={styles.sectionLabel}>
        {t['com.notesgraph.all-docs.display.properties']()}
      </section>
      ...
      {displayPreference.view === 'list' ? (
        <>
          ...
          <section className={styles.sectionLabel}>
            {t['com.notesgraph.all-docs.display.list-view']()}
          </section>
          <div className={styles.properties}>
            <Button
              ...
              onClick={toggleIcon}
            >
              {t['com.notesgraph.all-docs.display.list-view.icon']()}
            </Button>
            <Button
              className={styles.property}
              data-show={showBody}
              onClick={toggleBody}
            >
              {t['com.notesgraph.all-docs.display.list-view.body']()}
            </Button>
          </div>
        </>
      ) : null}
