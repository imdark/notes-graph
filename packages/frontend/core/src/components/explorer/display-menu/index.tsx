    ...
    <div className={styles.displayMenuContainer}>
      ...
      >
        <div className={styles.subMenuSelectorContainer}>
          <span>{t['com.notesgraph.explorer.display-menu.grouping']()}</span>
      ...
      >
        <div className={styles.subMenuSelectorContainer}>
          <span>{t['com.notesgraph.explorer.display-menu.ordering']()}</span>
          <span className={styles.subMenuSelectorSelected}>
  ...
  return (
    ...
    >
      <Button className={className} style={style}>
        {t['com.notesgraph.explorer.display-menu.button']()}
      </Button>
    </Menu>
  );
};
