...
import { EmptyDocs } from '../../notesgraph/empty';
...
export const DocsExplorer = ({
  ...
  const handleMultiDelete = useCallback(() => {
    ...
    openConfirmModal({
      title: t['com.notesgraph.moveToTrash.confirmModal.title.multiple']({
        number: selectedDocIds.length.toString(),
      }),
      description: t[
        'com.notesgraph.moveToTrash.confirmModal.description.multiple'
      ]({
        number: selectedDocIds.length.toString(),
      }),
    ...
    <>
      ...
      {!disableMultiSelectToolbar || onRestore ? (
        <ListFloatingToolbar
          ...
          content={
            <Trans
              i18nKey="com.notesgraph.page.toolbar.selected"
