...
const QUICK_ACTION_MAP: Record<QuickActionKey, QuickActionItem> = {
  quickFavorite: {
    name: 'com.notesgraph.all-docs.quick-action.favorite',
    Component: QuickFavorite,
  },
  quickTrash: {
    name: 'com.notesgraph.all-docs.quick-action.trash',
    Component: QuickDelete,
  },
  quickSplit: {
    name: 'com.notesgraph.all-docs.quick-action.split',
    Component: QuickSplit,
  },
  quickTab: {
    name: 'com.notesgraph.all-docs.quick-action.tab',
    Component: QuickTab,
  },
  quickSelect: {
    name: 'com.notesgraph.all-docs.quick-action.select',
    Component: QuickSelect,
  },
  quickDeletePermanently: {
    name: 'com.notesgraph.all-docs.quick-action.delete-permanently',
    Component: QuickDeletePermanently,
    disabled: true, // can only be controlled in code
  },
  quickRestore: {
    name: 'com.notesgraph.all-docs.quick-action.restore',
