...
import type { AllPageFilterOption } from '@notesgraph/core/components/atoms';
import { allPageFilterSelectAtom } from '@notesgraph/core/components/atoms';
    ...
    <RadioGroup
      ...
      items={useMemo<RadioItem[]>(
        () => [
          {
            value: 'docs',
            label: t['com.notesgraph.docs.header'](),
            testId: 'workspace-docs-button',
            className: styles.filterTab,
          },
          {
            value: 'collections',
            label: t['com.notesgraph.collections.header'](),
