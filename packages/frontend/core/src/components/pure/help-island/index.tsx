    ...
    >
      ...
      >
        {showList.includes('whatNew') && (
          <Tooltip
            content={t['com.notesgraph.appUpdater.whatsNew']()}
            side="left"
          >
            <StyledIconWrapper
        ...
        {showList.includes('contact') && (
          <Tooltip
            content={t['com.notesgraph.helpIsland.contactUs']()}
            side="left"
          >
            <StyledIconWrapper
        ...
        {showList.includes('shortcuts') && (
          <Tooltip
            content={t['com.notesgraph.keyboardShortcuts.title']()}
            side="left"
          >
            <StyledIconWrapper
      ...
      {spread ? (
        ...
        <Tooltip
          content={t['com.notesgraph.helpIsland.helpAndFeedback']()}
          side="left"
        >
