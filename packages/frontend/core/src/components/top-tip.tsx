import {
  BrowserWarning,
  LocalDemoTips,
} from '@notesgraph/component/notesgraph-banner';
import { Trans, useI18n } from '@notesgraph/i18n';
import { useLiveData, useService } from '@notesgraph/infra';
import { useCallback, useState } from 'react';

import { useEnableCloud } from '../components/hooks/notesgraph/use-enable-cloud';
...
const OSWarningMessage = () => {
  ...
  if (environment.isMobile) {
    return <span>{t['com.notesgraph.top-tip.mobile']()}</span>;
  }
