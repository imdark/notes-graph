import { ScrollableContainer } from '@notesgraph/component';
...
import { NotesGraphWorkspaceList } from './workspace-list';
      ...
      <div className={styles.signInWrapper}>
        ...
        <div className={styles.signInTextContainer}>
          <div className={styles.signInTextPrimary}>
            {t['com.notesgraph.workspace.cloud.auth']()}
          </div>
          <div className={styles.signInTextSecondary}>
            {t['com.notesgraph.workspace.cloud.description']()}
          </div>
        </div>
      </div>
    </MenuItem>
