...
import { OAuth } from '@notesgraph/core/components/notesgraph/auth/oauth';
...
import { useSelfhostLoginVersionGuard } from '../hooks/notesgraph/use-selfhost-login-version-guard';
    ...
    <AuthContainer>
      ...
      <AuthContent>
        ...
        >
          ...
          >
            {t['com.notesgraph.auth.sign.email.continue']()}
          </Button>
        </form>
        ...
        {!isSelfhosted && (
          <>
            <div className={style.authMessage}>
              {/*prettier-ignore*/}
              <Trans i18nKey="com.notesgraph.auth.sign.message">
                By clicking &quot;Continue with Google/Email&quot; above, you acknowledge that
                you agree to NotesGraph&apos;s <a href="https://notesgraph.com/terms" target="_blank" rel="noreferrer">Terms of Conditions</a> and <a href="https://notesgraph.com/privacy" target="_blank" rel="noreferrer">Privacy Policy</a>.
            </Trans>
            </div>
            ...
            <div className={style.skipSection}>
              {BUILD_CONFIG.isNative ? (
                ...
                >
                  {t['com.notesgraph.auth.sign.add-selfhosted']()}
                </Button>
              ) : (
                <div className={style.skipText}>
                  {t['com.notesgraph.mobile.sign-in.skip.hint']()}
                </div>
              )}
              <Button
                variant="plain"
              ...
              >
                {t['com.notesgraph.mobile.sign-in.skip.link']()}
              </Button>
            </div>
          </>
        )}
