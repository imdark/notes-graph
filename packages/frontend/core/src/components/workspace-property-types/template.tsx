...
import { Checkbox, MenuItem, PropertyValue } from '@notesgraph/component';
...
export const TemplateGroupHeader = ({
  ...
  const text =
    groupId === 'true'
      ? t['com.notesgraph.all-docs.group.is-template']()
      : groupId === 'false'
        ? t['com.notesgraph.all-docs.group.is-not-template']()
        : 'Default';
