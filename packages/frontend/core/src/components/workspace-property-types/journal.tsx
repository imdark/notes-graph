...
import { MobileJournalConflictList } from '@notesgraph/core/mobile/pages/workspace/detail/menu/journal-conflicts';
          ...
          <Menu
            ...
            items={
              <DatePicker
                ...
                monthNames={t[
                  'com.notesgraph.calendar-date-picker.month-names'
                ]()}
...
export const JournalGroupHeader = ({ groupId, docCount }: GroupHeaderProps) => {
  ...
  const text =
    groupId === 'true'
      ? t['com.notesgraph.all-docs.group.is-journal']()
      : t['com.notesgraph.all-docs.group.is-not-journal']();
  return (
