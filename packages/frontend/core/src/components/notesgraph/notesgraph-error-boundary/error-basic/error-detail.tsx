...
import { Scrollable, ThemedImg } from '@notesgraph/component';
      ...
      <div className={styles.errorContainer} data-show-stack={showStack}>
        ...
        <div className={styles.actionContainer}>
          {error?.stack ? (
            ...
            >
              <div className={styles.actionContent}>
                <span>{t['com.notesgraph.error.hide-error']()}</span>
                <ArrowDownSmallIcon
                  data-show-stack={showStack}
          ...
          <ActionButton
            ...
            variant="primary"
          >
            {props.buttonText ?? t['com.notesgraph.error.reload']()}
          </ActionButton>
        </div>
      </div>
    </div>
...
export function ContactUS() {
  return (
    <Trans
      i18nKey="com.notesgraph.error.contact-us"
      components={{
        1: (
          <a
