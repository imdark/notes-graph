...
import { InvitationService } from '@notesgraph/core/modules/cloud';
import {
  type Notification,
  NotificationListService,
  NotificationType,
} from '@notesgraph/core/modules/notification';
import { WorkspacesService } from '@notesgraph/core/modules/workspace';
import { extractEmojiIcon } from '@notesgraph/core/utils';
  ...
  return (
    ...
    >
      <div className={styles.header}>
        <span>{t['com.notesgraph.rootAppSidebar.notifications']()}</span>
        {notifications.length > 0 && (
          <Menu
            items={
              <MenuItem prefixIcon={<DeleteIcon />} onClick={handleDeleteAll}>
                <span>{t['com.notesgraph.notification.delete-all']()}</span>
              </MenuItem>
            }
          >
      ...
      <Scrollable.Root className={styles.scrollRoot}>
        <Scrollable.Viewport className={styles.scrollViewport}>
          ...
          >
            {hasMore ? t['com.notesgraph.notification.loading-more']() : null}
          </div>
        </Scrollable.Viewport>
  ...
  return (
    <div className={styles.listEmpty}>
      ...
      <div className={styles.listEmptyTitle}>
        {t['com.notesgraph.notification.empty']()}
      </div>
      <div className={styles.listEmptyDescription}>
        {t['com.notesgraph.notification.empty.description']()}
      </div>
    </div>
  );
};
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.mention'}
            components={{
              1: (
                <b
            ...
            values={{
              username:
                ...
                t['com.notesgraph.inactive-member'](),
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.invitation-review-request'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
            ...
            values={{
              ...
              workspaceName:
                body.workspace?.name ??
                t['com.notesgraph.inactive-workspace'](),
            }}
          />
        </span>
        <div className={styles.itemDate}>
  ...
  return (
    <div className={styles.itemContainer}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.invitation-review-declined'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
  ...
  return (
    <div className={styles.itemContainer}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.invitation-review-approved'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
        ...
        {!workspaceInactived && (
          ...
          >
            {t[
              'com.notesgraph.notification.invitation-review-approved.open-workspace'
            ]()}
          </Button>
        )}
        <div className={styles.itemDate}>
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.invitation-accepted'}
            components={{
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.invitation-blocked'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
      ...
      .then(async value => {
        if (value === false) {
          ...
          notify.error({
            ...
            message: t['com.notesgraph.expired.page.new-subtitle'](),
          });
          notificationListService
  ...
  return (
    <div className={styles.itemContainer}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.invitation'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
        ...
        {!workspaceInactived && (
          <Button
            ...
            loading={isAccepting}
          >
            {t['com.notesgraph.notification.invitation.accept']()}
          </Button>
        )}
        <div className={styles.itemDate}>
          {i18nTime(notification.createdAt, {
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.comment'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
  ...
  return (
    <div className={styles.itemContainer} onClick={handleClick}>
      ...
      <div className={styles.itemMain}>
        <span>
          <Trans
            i18nKey={'com.notesgraph.notification.comment-mention'}
            components={{
              1: (
                <b
                  className={styles.itemNameLabel}
