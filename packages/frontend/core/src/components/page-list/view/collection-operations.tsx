...
import { Menu, MenuItem, usePromptModal } from '@notesgraph/component';
...
export const CollectionOperations = ({
  ...
  >(
    () => [
      {
        icon: <EditIcon />,
        name: t['com.notesgraph.collection.menu.rename'](),
        click: showEditName,
      },
      {
        icon: <FilterIcon />,
        name: t['com.notesgraph.collection.menu.edit'](),
        click: showEdit,
      },
      ...(onAddDocToCollection
        ? [
      ...
      {
        icon: <OpenInNewIcon />,
        name: t['com.notesgraph.workbench.tab.page-menu-open'](),
      ...
      ...(BUILD_CONFIG.isElectron
        ? [
            {
              icon: <SplitViewIcon />,
              name: t['com.notesgraph.workbench.split-view.page-menu-open'](),
