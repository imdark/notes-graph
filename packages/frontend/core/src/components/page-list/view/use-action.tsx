    ...
    return [
      {
        icon: <FilterIcon />,
        name: 'edit',
        tooltip: t['com.notesgraph.collection-bar.action.tooltip.edit'](),
        click: () => {
          openEdit(collection);
        },
      },
      {
        icon: <DeleteIcon style={{ color: 'var(--notesgraph-error-color)' }} />,
        name: 'delete',
        tooltip: t['com.notesgraph.collection-bar.action.tooltip.delete'](),
        click: onDelete,
      },
    ];
