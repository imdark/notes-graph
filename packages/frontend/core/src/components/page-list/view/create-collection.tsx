import { Button, Input, Modal } from '@notesgraph/component';
  ...
  return (
    <Modal open={open} title={title} onOpenChange={onOpenChange} width={480}>
      {init != null ? (
        <CreateCollection
          showTips={showTips}
          onConfirmText={t['com.notesgraph.editCollection.save']()}
          init={init}
    ...
    <div data-testid="edit-collection-modal">
      <div className={styles.content}>
        <div className={styles.label}>
          {t['com.notesgraph.editCollectionName.name']()}
        </div>
        <Input
          autoFocus
          value={value}
          ...
          placeholder={t[
            'com.notesgraph.editCollectionName.name.placeholder'
          ]()}
