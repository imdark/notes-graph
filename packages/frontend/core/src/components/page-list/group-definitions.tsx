    ...
    () => [
      ...
      },
      {
        ...
        label: count => (
          <GroupLabel
            id="yesterday"
            label={t['com.notesgraph.yesterday']()}
            count={count}
          />
        ),
        match: item =>
      ...
      },
      {
        ...
        label: count => (
          <GroupLabel
            id="last7Days"
            label={t['com.notesgraph.last7Days']()}
            count={count}
          />
        ),
        match: item =>
      ...
      },
      {
        ...
        label: count => (
          <GroupLabel
            id="last30Days"
            label={t['com.notesgraph.last30Days']()}
            count={count}
          />
        ),
        match: item =>
      ...
      },
      {
        ...
        label: count => (
          <GroupLabel
            id="moreThan30Days"
            label={t['com.notesgraph.moreThan30Days']()}
            count={count}
          />
        ),
        match: item =>
    ...
    () => ({
      ...
      label: (count: number) => (
        <GroupLabel
          id="Untagged"
          label={t[
            'com.notesgraph.page.display.grouping.group-by-tag.untagged'
          ]()}
          count={count}
        />
      ),
    ...
    () => [
      {
        ...
        label: count => (
          <GroupLabel
            id="favourited"
            label={t['com.notesgraph.page.group-header.favourited']()}
            count={count}
      ...
      },
      {
        ...
        label: count => (
          <GroupLabel
            id="notFavourited"
            label={t['com.notesgraph.page.group-header.not-favourited']()}
            count={count}
