...
import {
  ...
  FavoriteService,
} from '@notesgraph/core/modules/favorite';
...
export const TrashOperationCell = ({
  ...
  const onConfirmPermanentlyDelete = useCatchEventCallback(
    e => {
      e.preventDefault();
      openConfirmModal({
        title: `${t['com.notesgraph.trashOperation.deletePermanently']()}?`,
        description: t['com.notesgraph.trashOperation.deleteDescription'](),
        cancelText: t['Cancel'](),
...
export const CollectionOperationCell = ({
  ...
  const handleEditName = useCallback(
    (event: MouseEvent) => {
      ...
      openPromptModal({
        title: t['com.notesgraph.editCollection.renameCollection'](),
        label: t['com.notesgraph.editCollectionName.name'](),
        inputOptions: {
          placeholder:
            t['com.notesgraph.editCollectionName.name.placeholder'](),
        },
  ...
  const onConfirmAddDocToCollection = useCallback(() => {
    openConfirmModal({
      ...
      description: t['com.notesgraph.collection.add-doc.confirm.description'](),
      cancelText: t['Cancel'](),
  ...
  return (
    <>
      ...
      <IconButton
        ...
        tooltip={t['com.notesgraph.collection.menu.rename']()}
        tooltipOptions={tooltipSideTop}
      >
        <EditIcon />
      </IconButton>
      <IconButton
        onClick={handleEdit}
        tooltip={t['com.notesgraph.collection.menu.edit']()}
        tooltipOptions={tooltipSideTop}
      >
        <FilterIcon />
      </IconButton>
