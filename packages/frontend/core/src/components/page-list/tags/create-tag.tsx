import { Button, Input, Menu, toast } from '@notesgraph/component';
...
export const CreateOrEditTag = ({
  ...
  const onConfirm = useCallback(() => {
    ...
    if (
      ...
      return toast(t['com.notesgraph.tags.create-tag.toast.exist']());
    }
    if (!tagMeta) {
      tagList.createTag(tagName.trim(), tagIcon);
      toast(t['com.notesgraph.tags.create-tag.toast.success']());
      onClose();
      return;
    }
    ...
    toast(t['com.notesgraph.tags.edit-tag.toast.success']());
    onClose();
    return;
  ...
  return (
    ...
    >
      ...
      <Input
        placeholder={t['com.notesgraph.tags.create-tag.placeholder']()}
        inputStyle={{ fontSize: 'var(--notesgraph-font-xs)' }}
        onEnter={onConfirm}
        value={tagName}
