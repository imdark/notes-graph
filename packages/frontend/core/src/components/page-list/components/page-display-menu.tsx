...
export function getGroupOptions(t: ReturnType<typeof useI18n>) {
  return [
    ...
    {
      value: 'tag',
      label: t['com.notesgraph.page.display.grouping.group-by-tag'](),
    },
    {
      value: 'favourites',
      label: t['com.notesgraph.page.display.grouping.group-by-favourites'](),
    },
    {
      value: 'none',
      label: t['com.notesgraph.page.display.grouping.no-grouping'](),
    },
    ...
    return [
      {
        ...
        label: t['com.notesgraph.page.display.display-properties.body-notes'](),
      },
      {
        key: 'tags',
    ...
    return (
      <>
        ...
        >
          ...
          >
            <span>{t['com.notesgraph.page.display.grouping']()}</span>
            <span className={styles.currentGroupType}>{currentGroupType}</span>
          </div>
        </MenuSub>
        <MenuSeparator />
        <div className={styles.listOption}>
          {t['com.notesgraph.page.display.list-option']()}
        </div>
        <div className={styles.properties}>
          {t['com.notesgraph.page.display.display-properties']()}
        </div>
