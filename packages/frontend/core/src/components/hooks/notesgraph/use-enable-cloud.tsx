import { notify, useConfirmModal } from '@notesgraph/component';
...
export const useEnableCloud = () => {
  ...
  const enableCloud = useCallback(
    async (ws: Workspace | null, options?: ConfirmEnableCloudOptions) => {
      try {
        ...
        console.error(e);
        notify.error({
          title: t['com.notesgraph.workspace.enable-cloud.failed'](),
        });
      }
    },
  ...
  const confirmEnableCloud = useCallback(
    (ws: Workspace, options?: ConfirmEnableCloudOptions) => {
      ...
      openConfirmModal(
        {
          title: t['Enable NotesGraph Cloud'](),
          description: t['Enable NotesGraph Cloud Description'](),
          cancelText:
            t['com.notesgraph.enableNotesGraphCloudModal.button.cancel'](),
          confirmText:
          ...
          confirmButtonOptions: {
            variant: 'primary',
            ['data-testid' as string]: 'confirm-enable-notesgraph-cloud-button',
          },
          onConfirm: async () =>
