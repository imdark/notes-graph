...
const useKeyboardShortcutsI18N = () => {
  ...
  return useCallback(
    (key: KeyboardShortcutsI18NKeys) =>
      t[`com.notesgraph.keyboardShortcuts.${key}`](),
    [t]
  );
};
...
const useHeadingKeyboardShortcutsI18N = () => {
  ...
  return useCallback(
    (number: string) =>
      t['com.notesgraph.keyboardShortcuts.heading']({ number }),
    [t]
  );
};
...
export const useMarkdownShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.notesgraph.shortcutsTitle.markdownSyntax'](),
    shortcuts,
  };
};
...
export const usePageShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.notesgraph.shortcutsTitle.page'](),
    shortcuts,
  };
};
...
export const useEdgelessShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.notesgraph.shortcutsTitle.edgeless'](),
    shortcuts,
  };
};
...
export const useGeneralShortcuts = (): ShortcutsInfo => {
  ...
  return {
    title: t['com.notesgraph.shortcutsTitle.general'](),
    shortcuts,
  };
};
