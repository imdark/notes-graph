...
import { INTEGRATION_TYPE_NAME_MAP } from '@notesgraph/core/modules/integration/constant';
import type { IntegrationType } from '@notesgraph/core/modules/integration/type';
...
export const IntegrationTypeGroupHeader = ({
  ...
  const text =
    groupId === 'readwise'
      ? t['com.notesgraph.integration.readwise.name']()
      : groupId
        ? groupId
        : 'No integrations';
