...
import { DNDContext } from '@notesgraph/component';
import { NotesGraphOtherPageLayout } from '@notesgraph/component/notesgraph-other-page-layout';
...
import { DndService } from '@notesgraph/core/modules/dnd/services';
import { GlobalContextService } from '@notesgraph/core/modules/global-context';
import { OpenInAppGuard } from '@notesgraph/core/modules/open-in-app';
import {
...
import { NotesGraphErrorBoundary } from '../../../components/notesgraph/notesgraph-error-boundary';
...
const WorkspacePage = ({ meta }: { meta: WorkspaceMetadata }) => {
  ...
  return (
    <FrameworkScope scope={workspace.scope}>
      <DNDContextProvider>
        <OpenInAppGuard>
          <NotesGraphErrorBoundary height="100vh">
            <WorkspaceLayout>
              <WorkbenchRoot />
            </WorkspaceLayout>
