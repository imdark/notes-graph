...
import { BlocksuiteEditorJournalDocTitleUI } from '@notesgraph/core/blocksuite/block-suite-editor/journal-doc-title';
import {
  JOURNAL_DATE_FORMAT,
  JournalService,
} from '@notesgraph/core/modules/journal';
import {
  ViewBody,
  ViewHeader,
  ViewIcon,
      ...
      <div className={styles.content}>
        ...
        <div className={styles.placeholder}>
          ...
          <div className={styles.placeholderText}>
            {t['com.notesgraph.journal.placeholder.title']()}
          </div>
          <Button
            variant="primary"
          ...
          >
            {t['com.notesgraph.journal.placeholder.create']()}
          </Button>
        </div>
      </div>
    </div>
