...
import { useQuery } from '@notesgraph/core/components/hooks/use-query';
    ...
    <div className={styles.tooltip}>
      ...
      <div className={styles.tooltipRow}>
        <span
          ...
          aria-hidden="true"
        />
        {t['com.notesgraph.doc.analytics.chart.total-views']()}
      ...
      <div className={styles.tooltipRow}>
        <span
          ...
          aria-hidden="true"
        />
        {t['com.notesgraph.doc.analytics.chart.unique-views']()}
        <span className={styles.tooltipValue}>
...
export const EditorAnalyticsPanel = ({
  ...
  const showTeamPlanToast = useCallback(() => {
    toast(t['com.notesgraph.doc.analytics.paywall.toast']());
  }, [t]);
  ...
  return (
    <div className={styles.root}>
      <section className={styles.section}>
        <div className={styles.sectionHeader}>
          <div className={styles.sectionTitle}>
            <span>{t['com.notesgraph.doc.analytics.title']()}</span>
            <span className={styles.sectionSubtitle}>
              {summary
                ? t.t('com.notesgraph.doc.analytics.summary.total', {
              ...
              <>
                {allowedWindowOptions.map(option => {
                  ...
                  return (
                      ...
                      suffixIcon={
                        isLocked ? (
                          <button
                            ...
                            aria-label={t[
                              'com.notesgraph.doc.analytics.paywall.open-pricing'
                            ]()}
                            onClick={event => {
                    ...
                    >
                      {t.t('com.notesgraph.doc.analytics.window.last-days', {
                        days: option,
                      })}
                      {isLocked
                        ? ` (${t['com.notesgraph.payment.cloud.team-workspace.name']()})`
                        : ''}
                    </MenuItem>
                  );
                })}
        ...
        <div className={styles.metrics}>
          <div className={styles.metricCard}>
            <div className={styles.metricLabel}>
              {t['com.notesgraph.doc.analytics.metric.total']()}
            </div>
          ...
          <div className={styles.metricCard}>
            <div className={styles.metricLabel}>
              {t['com.notesgraph.doc.analytics.metric.unique']()}
            </div>
            <div className={styles.metricValue}>
          ...
          <div className={styles.metricCard}>
            <div className={styles.metricLabel}>
              {t['com.notesgraph.doc.analytics.metric.guest']()}
            </div>
            <div className={styles.metricValue}>
        ...
        {analyticsLoading && !analytics ? (
          ...
          <div className={styles.emptyState}>
            {t['com.notesgraph.doc.analytics.error.load-analytics']()}
          </div>
        ) : chartPoints.length ? (
          <>
          ...
          <div className={styles.emptyState}>
            {t['com.notesgraph.doc.analytics.empty.no-page-views']()}
          </div>
        )}
      </section>
      ...
      <section className={styles.section}>
        <div className={styles.sectionHeader}>
          <div className={styles.sectionTitle}>
            <span>{t['com.notesgraph.doc.analytics.viewers.title']()}</span>
            <span className={styles.sectionSubtitle}>
        ...
        {membersLoading && !membersConnection ? (
          ...
          <div className={styles.emptyState}>
            {t['com.notesgraph.doc.analytics.error.load-viewers']()}
          </div>
        ) : members.length ? (
          <>
            ...
            {hasMoreMembers ? (
              ...
              >
                {t['com.notesgraph.doc.analytics.viewers.show-all']()}
              </Button>
            ) : null}
          </>
        ) : (
          <div className={styles.emptyState}>
            {t['com.notesgraph.doc.analytics.empty.no-viewers']()}
          </div>
        )}
      </section>
    </div>
