...
import type { AppSidebarConfig } from '@notesgraph/core/blocksuite/ai/chat-panel/chat-config';
...
import { createPlaygroundModal } from '@notesgraph/core/blocksuite/ai/components/playground/modal';
...
export interface SidebarTabProps {
  editor: NotesGraphEditorContainer | null;
  doc: Store;
  ...
  const openPlayground = useCallback(() => {
    ...
    const playgroundContent = html`
      <playground-content
        ...
        .notesgraphFeatureFlagService=${framework.get(FeatureFlagService)}
        .notesgraphThemeService=${framework.get(AppThemeService)}
        .notificationService=${notificationService}
        .notesgraphWorkspaceDialogService=${framework.get(
          WorkspaceDialogService
        )}
      ...
      {!hasRuntimeSnapshot ? (
        <div className={styles.loadingContainer}>
          <div className={styles.loading}>
            <NotesGraphLogoIcon className={styles.loadingIcon} />
            <div className={styles.loadingTitle}>
              {t['com.notesgraph.ai.chat-panel.loading-history']()}
            </div>
          </div>
        </div>
      ) : (
            ...
            <div className={styles.title}>
              {isEmbedding ? (
                <span data-testid="chat-panel-embedding-progress">
                  {t.t('com.notesgraph.ai.chat-panel.embedding-progress', {
                    done,
                    total,
                  })}
                </span>
              ) : (
                t['com.notesgraph.ai.chat-panel.title']()
              )}
            </div>
            {playgroundVisible ? (
