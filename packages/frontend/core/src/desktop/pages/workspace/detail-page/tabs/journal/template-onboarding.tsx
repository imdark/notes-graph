...
import { Button, IconButton, Menu } from '@notesgraph/component';
    ...
    >
      <div className={styles.card} data-animation-played={animationPlayed}>
        <p className={styles.title}>
          {t['com.notesgraph.template-journal-onboarding.title']()}
        </p>
        <Menu
        ...
        >
          <Button variant="primary" prefix={<TemplateIcon />}>
            {t['com.notesgraph.template-journal-onboarding.select']()}
          </Button>
        </Menu>
        <JournalPaper />
        <IconButton
