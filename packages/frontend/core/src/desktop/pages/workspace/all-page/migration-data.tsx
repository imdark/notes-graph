...
import { DocCreatedByUpdatedBySyncService } from '@notesgraph/core/modules/cloud';
  ...
  return (
    <div className={styles.migrationDataNotificationContainer}>
      <div className={styles.migrationDataNotificationTitle}>
        {t['com.notesgraph.migration-all-docs-notification.header']()}
      </div>
      <div className={styles.migrationDataNotificationContent}>
        <MigrationBackgroundCover />
        {t['com.notesgraph.migration-all-docs-notification.desc']()}
      </div>

      {error && (
        <div className={styles.migrationDataNotificationError}>
          {t['com.notesgraph.migration-all-docs-notification.error']({
      ...
      <Button loading={syncing} onClick={handleSync}>
        {t['com.notesgraph.migration-all-docs-notification.button']()}
