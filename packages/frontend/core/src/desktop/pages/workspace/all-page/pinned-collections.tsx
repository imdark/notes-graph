...
import { AddFilterMenu } from '@notesgraph/core/components/filter/add-filter';
import {
  CollectionService,
  ...
  return (
    <div className={styles.container}>
      <div
        ...
        role="button"
      >
        {t['com.notesgraph.all-docs.pinned-collection.all']()}
      </div>
      ...
      {activeCollectionId && (
        <Tooltip
          content={t['com.notesgraph.all-docs.pinned-collection.edit']()}
        >
          <IconButton
            size="16"
