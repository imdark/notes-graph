...
import { EmptyCollectionDetail } from '@notesgraph/core/components/notesgraph/empty/collection-detail';
import {
  type Collection,
  CollectionService,
    ...
    <>
      <ViewHeader>
        ...
        >
          ...
          >
            <ViewLayersIcon
              style={{ color: 'var(--notesgraph-icon-color)' }}
              fontSize={14}
            />
            {t['com.notesgraph.collection.allCollections']()}
            <div>/</div>
          </div>
          <div
