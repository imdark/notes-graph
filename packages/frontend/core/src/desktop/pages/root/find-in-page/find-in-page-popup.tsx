...
import { IconButton, observeResize, RowInput } from '@notesgraph/component';
import { FindInPageService } from '@notesgraph/core/modules/find-in-page';
...
const drawText = (
  ...
  const textColor = rootStyles
    .getPropertyValue('--notesgraph-text-primary-color')
    .trim();
