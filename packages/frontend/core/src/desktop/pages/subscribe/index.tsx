...
import { effect, fromPromise, useServices } from '@notesgraph/infra';
...
import { generateSubscriptionCallbackLink } from '../../../components/hooks/notesgraph/use-subscription-notify';
import {
  RouteLogic,
  useNavigateHelper,
