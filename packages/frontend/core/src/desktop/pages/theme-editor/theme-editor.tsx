import { RadioGroup, Scrollable } from '@notesgraph/component';
...
import { notesgraphThemes, type TreeNode } from './resource';
...
export const ThemeEditor = () => {
  ...
  const { nodeMap, variableMap, tree } = notesgraphThemes[version];
