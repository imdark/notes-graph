...
import { PureWorkspaceCard } from '@notesgraph/core/components/workspace-selector/workspace-card';
import { AuthService } from '@notesgraph/core/modules/cloud';
import {
  type WorkspaceMetadata,
  WorkspacesService,
} from '@notesgraph/core/modules/workspace';
import { buildShowcaseWorkspace } from '@notesgraph/core/utils/first-app-data';
...
import { type I18nString, Trans, useI18n } from '@notesgraph/i18n';
...
const benefitList: I18nString[] = [
  'com.notesgraph.upgrade-to-team-page.benefit.g1',
  'com.notesgraph.upgrade-to-team-page.benefit.g2',
  'com.notesgraph.upgrade-to-team-page.benefit.g3',
  'com.notesgraph.upgrade-to-team-page.benefit.g4',
];
...
export const UpgradeToTeam = ({ recurring }: { recurring: string | null }) => {
  ...
  const menuTriggerText = useMemo(() => {
    ...
    return t[
      'com.notesgraph.upgrade-to-team-page.workspace-selector.placeholder'
    ]();
  ...
  useEffect(() => {
    if (isTeam && selectedWorkspace) {
      return openNotesGraph();
    }
  }, [isTeam, jumpToPage, openNotesGraph, selectedWorkspace]);

  return (
    <AuthPageContainer title={t['com.notesgraph.upgrade-to-team-page.title']()}>
      <div className={styles.root}>
        ...
        <div className={styles.upgradeButton}>
          ...
          >
            {t['com.notesgraph.upgrade-to-team-page.upgrade-button']()}
          </Button>
        </div>
        <div className={styles.contentContainer}>
          <div>{t['com.notesgraph.upgrade-to-team-page.benefit.title']()}</div>
          <ul>
          ...
          <div>
            {t['com.notesgraph.upgrade-to-team-page.benefit.description']()}
          </div>
          {selectedWorkspace && (
            <UpgradeDialog
              recurring={recurring}
  ...
  return (
    <Modal width={480} open={open} onOpenChange={onOpenChange}>
      <div className={styles.dialogTitle}>
        {t['com.notesgraph.upgrade-to-team-page.upgrade-confirm.title']()}
      </div>
      <div className={styles.dialogMessage}>
        <Trans
          i18nKey="com.notesgraph.upgrade-to-team-page.upgrade-confirm.description"
          components={{
      ...
      <div className={styles.dialogFooter}>
        ...
        >
          {t['com.notesgraph.payment.upgrade']()}
        </Upgrade>
      </div>
    </Modal>
  );
...
const WorkspaceSelector = ({
  ...
  const cloudWorkspaces = useMemo(
    () =>
      metas.filter(
        ({ flavour }) => flavour === 'notesgraph-cloud'
    ...
    <div>
      {cloudWorkspaces.length > 0 ? (
        ...
        <div className={styles.noWorkspaceItem}>
          {t['com.notesgraph.upgrade-to-team-page.no-workspace-available']()}
        </div>
      )}
      ...
      >
        <div className={styles.itemContent}>
          {t[
            'com.notesgraph.upgrade-to-team-page.workspace-selector.create-workspace'
          ]()}
        </div>
      </MenuItem>
    </div>
...
const CreateWorkspaceDialog = ({
  ...
  return (
    <Modal width={480} open={open} onOpenChange={onOpenChange}>
      <div className={styles.dialogTitle}>
        {t[
          'com.notesgraph.upgrade-to-team-page.create-and-upgrade-confirm.title'
        ]()}
      </div>
      ...
      <div className={styles.createConfirmContent}>
        <div>
          {t[
            'com.notesgraph.upgrade-to-team-page.create-and-upgrade-confirm.description'
          ]()}
        </div>
        <Input
          placeholder={t[
            'com.notesgraph.upgrade-to-team-page.create-and-upgrade-confirm.placeholder'
          ]()}
          value={name}
          onChange={setName}
        />
      ...
      <div className={styles.dialogFooter}>
        ...
        >
          {t[
            'com.notesgraph.upgrade-to-team-page.create-and-upgrade-confirm.confirm'
          ]()}
        </Button>
      </div>
    </Modal>
