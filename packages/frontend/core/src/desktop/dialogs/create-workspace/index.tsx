import { Button, ConfirmModal, notify, RowInput } from '@notesgraph/component';
...
export const CreateWorkspaceDialog = ({
  ...
  return (
    <ConfirmModal
      ...
      title={t['com.notesgraph.nameWorkspace.title']()}
      description={t['com.notesgraph.nameWorkspace.description']()}
      cancelText={t['com.notesgraph.nameWorkspace.button.cancel']()}
      closeButtonOptions={{
    ...
    >
      <FormSection
        label={t['com.notesgraph.nameWorkspace.subtitle.workspace-name']()}
        input={
          <RowInput
            autoFocus
            className={styles.input}
            data-testid="create-workspace-input"
            placeholder={t['com.notesgraph.nameWorkspace.placeholder']()}
            maxLength={64}
            minLength={0}
      ...
      <FormSection
        label={t['com.notesgraph.nameWorkspace.subtitle.workspace-type']()}
        input={
          <ServerSelector
...
const CustomConfirmButton = ({
  ...
  const handleConfirm = useAsyncCallback(async () => {
    ...
    track.$.$.$.createWorkspace({
      flavour: !server ? 'local' : 'notesgraph-cloud',
    });
  ...
  return (
    <Button
      ...
      loading={loading}
    >
      {t['com.notesgraph.nameWorkspace.button.create']()}
    </Button>
  );
};
