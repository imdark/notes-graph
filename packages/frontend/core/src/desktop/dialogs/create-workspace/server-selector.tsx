...
import { type Server, ServersService } from '@notesgraph/core/modules/cloud';
...
export const ServerSelector = ({
  ...
  const selectedServerName =
    selectedId === 'local'
      ? t['com.notesgraph.workspaceList.workspaceListType.local']()
      : serverName;
...
const ServerSelectorItem = ({
  ...
  const Icon =
    server.id === 'notesgraph-cloud' ? CloudWorkspaceIcon : SelfhostIcon;
