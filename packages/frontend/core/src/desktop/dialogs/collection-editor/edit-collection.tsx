import { Button, RadioGroup } from '@notesgraph/component';
import { SelectPage } from '@notesgraph/core/components/page-list/docs/select-page';
    ...
    () => (
      <>
        <Button onClick={onCancel} className={styles.actionButton}>
          {t['com.notesgraph.editCollection.button.cancel']()}
        </Button>
        <Button
        ...
        >
          {onConfirmText ?? t['com.notesgraph.editCollection.button.create']()}
        </Button>
      </>
    ),
    ...
    () => (
      <RadioGroup
        ...
        items={[
          {
            value: 'page',
            label: t['com.notesgraph.editCollection.pages'](),
            testId: 'edit-collection-pages-button',
          },
          {
            value: 'rule',
            label: t['com.notesgraph.editCollection.rules'](),
