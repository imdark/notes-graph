...
import { LinkVisibilityConfirmDialog } from './link-visibility-confirm';
import { ProjectMembersDialog } from './project-members';
import { BlockScheduleDialog } from './selectors/block-schedule';
...
import { UppyUploadDialog } from './uppy-upload';
...
const WORKSPACE_DIALOGS = {
  ...
  'add-to-project': AddToProjectDialog,
  'convert-to-project': ConvertToProjectDialog,
  'link-visibility-confirm': LinkVisibilityConfirmDialog,
} satisfies {
