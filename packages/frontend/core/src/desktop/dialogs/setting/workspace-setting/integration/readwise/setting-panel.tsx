...
import { WorkspaceTagsInlineEditor } from '@notesgraph/core/components/tags';
import {
  IntegrationService,
  IntegrationTypeIcon,
} from '@notesgraph/core/modules/integration';
import type { ReadwiseConfig } from '@notesgraph/core/modules/integration/type';
...
const ReadwiseSettingHeader = ({ action }: { action?: ReactNode }) => {
  ...
  return (
    <IntegrationSettingHeader
      ...
      name={t['com.notesgraph.integration.readwise.name']()}
      desc={t['com.notesgraph.integration.readwise.desc']()}
      action={action}
    />
  );
};
  ...
  return (
    <li>
      <IntegrationSettingToggle
        ...
        name={t['com.notesgraph.integration.readwise.setting.sync-new-name']()}
        desc={t['com.notesgraph.integration.readwise.setting.sync-new-desc']()}
        onChange={toggle}
      />
    </li>
  );
  ...
  const strategies = useMemo(
    () =>
      [
        {
          name: t[
            'com.notesgraph.integration.readwise.setting.update-append-name'
          ](),
          desc: t[
            'com.notesgraph.integration.readwise.setting.update-append-desc'
          ](),
          value: 'append',
        },
        {
          name: t[
            'com.notesgraph.integration.readwise.setting.update-override-name'
          ](),
          desc: t[
            'com.notesgraph.integration.readwise.setting.update-override-desc'
          ](),
          value: 'override',
        },
    ...
    <>
      <li>
        <IntegrationSettingToggle
          ...
          name={t['com.notesgraph.integration.readwise.setting.update-name']()}
          desc={t['com.notesgraph.integration.readwise.setting.update-desc']()}
          onChange={toggle}
        />
      </li>
      <li
      ...
      >
        <div className={styles.updateStrategyGroupContent}>
          <h6 className={styles.updateStrategyLabel}>
            {t['com.notesgraph.integration.readwise.setting.update-strategy']()}
          </h6>
          <IntegrationSettingTextRadioGroup
            items={strategies}
            checked={updateStrategy}
...
const StartImport = ({ onImport }: { onImport: () => void }) => {
  ...
  return (
    <IntegrationSettingItem
      name={t[
        'com.notesgraph.integration.readwise.setting.start-import-name'
      ]()}
      desc={t[
        'com.notesgraph.integration.readwise.setting.start-import-desc'
      ]()}
    >
      <Button onClick={handleImport}>
        {t['com.notesgraph.integration.readwise.setting.start-import-button']()}
      </Button>
    </IntegrationSettingItem>
  );
};
  ...
  return (
    <li>
      <h6 className={styles.tagsLabel}>
        {t['com.notesgraph.integration.readwise.setting.tags-label']()}
      </h6>
      <WorkspaceTagsInlineEditor
        placeholder={
          <span className={styles.tagsPlaceholder}>
            {t[
              'com.notesgraph.integration.readwise.setting.tags-placeholder'
            ]()}
          </span>
        }
