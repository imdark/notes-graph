    ...
    (success: boolean, token: string) => {
      ...
      if (success) {
        ...
        notify.error({
          title:
            t[
              'com.notesgraph.integration.readwise.connect.error-notify-title'
            ](),
          message:
            t[
              'com.notesgraph.integration.readwise.connect.error-notify-desc'
            ](),
        });
      }
    },
  ...
  return (
    ...
    >
      <header className={connectTitle}>
        ...
        {t['com.notesgraph.integration.readwise.connect.title']()}
      </header>
      <div className={connectDesc}>
        <Trans
          i18nKey={'com.notesgraph.integration.readwise.connect.desc'}
          components={{
            a: (
              <a
      ...
      <Input
        ...
        onInput={handleInput}
        placeholder={t[
          'com.notesgraph.integration.readwise.connect.placeholder'
        ]()}
        type="password"
      ...
      <div className={inputErrorMsg} data-show={status === 'error'}>
        {t['com.notesgraph.integration.readwise.connect.input-error']()}
      </div>
      <footer className={connectFooter}>
        ...
        >
          {t['com.notesgraph.integration.readwise.connect']()}
        </Button>
      </footer>
    </Modal>
  );
