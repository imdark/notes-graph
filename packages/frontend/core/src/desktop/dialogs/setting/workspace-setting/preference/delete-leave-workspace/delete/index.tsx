...
export const WorkspaceDeleteModal = ({
  ...
  return (
    <ConfirmModal
      ...
      cancelText={t['com.notesgraph.workspaceDelete.button.cancel']()}
      confirmText={t['com.notesgraph.workspaceDelete.button.delete']()}
    ...
    >
      {workspaceMetadata.flavour === 'local' ? (
        <Trans i18nKey="com.notesgraph.workspaceDelete.description">
          Deleting (
        ...
        <Trans i18nKey="com.notesgraph.workspaceDelete.description2">
          Deleting (
          <span className={styles.workspaceName}>
            {{ workspace: workspaceName } as any}
          </span>
      ...
      <div className={styles.inputContent}>
        <Input
          ...
          placeholder={t['com.notesgraph.workspaceDelete.placeholder']()}
          size="large"
        />
      </div>
    </ConfirmModal>
