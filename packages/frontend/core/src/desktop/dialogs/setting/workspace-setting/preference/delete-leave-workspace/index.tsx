    ...
    <>
      <SettingRow
        name={
          <span style={{ color: cssVarV2('status/error') }}>
            {isOwner
              ? t['com.notesgraph.workspaceDelete.title']()
              : t['com.notesgraph.deleteLeaveWorkspace.leave']()}
          </span>
        }
        desc={t['com.notesgraph.deleteLeaveWorkspace.description']()}
      ...
      {isOwner ? (
        ...
        <ConfirmModal
          ...
          title={`${t['com.notesgraph.deleteLeaveWorkspace.leave']()}?`}
          description={t[
            'com.notesgraph.deleteLeaveWorkspace.leaveDescription'
          ]()}
          confirmText={t['Leave']()}
