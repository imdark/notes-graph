...
import { WorkspaceSubscriptionService } from '@notesgraph/core/modules/cloud';
  ...
  return (
    <>
      <SettingHeader
        ...
        subtitle={t['com.notesgraph.payment.billing-setting.subtitle']()}
      />
      <SettingWrapper
        title={t['com.notesgraph.payment.billing-setting.information']()}
      >
        <TeamCard />
        <TypeformLink />
