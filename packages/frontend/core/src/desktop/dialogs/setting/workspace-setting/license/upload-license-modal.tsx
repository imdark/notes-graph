...
import { Button, Modal, notify, useConfirmModal } from '@notesgraph/component';
...
export const UploadLicenseModal = ({
    ...
    async (file: File) => {
      ...
      try {
        ...
        openConfirmModal({
          title:
            t[
              'com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.success.title'
            ](),
          description:
            t[
              'com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.success.description'
            ](),
        ...
        openConfirmModal({
          title:
            t[
              'com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.failed'
            ](),
  ...
  return (
    <Modal
      ...
      description={t[
        'com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.description'
      ]()}
    >
      <div className={styles.activateModalContent}>
        <div className={styles.tipsContainer}>
          <div className={styles.tipsTitle}>
            {t[
              'com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.tips.title'
            ]()}
          </div>
          <div className={styles.tipsContent}>
            <Trans
              i18nKey="com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.tips.content"
              components={{
                1: (
                  <a
          ...
          <div className={styles.workspaceIdContainer}>
            <div className={styles.workspaceIdLabel}>
              {t[
                'com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.tips.workspace-id'
              ]()}
            </div>
            <Button
              variant="secondary"
        ...
        <Upload accept=".lic, .license" fileChange={handleInstallLicense}>
          ...
          >
            <span className={styles.uploadButtonContent}>
              ...
              {t[
                'com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.click-to-upload'
              ]()}
            </span>
          </Button>
        </Upload>
        <div className={styles.footer}>
          {t[
            'com.notesgraph.settings.workspace.license.self-host-team.upload-license-file.help'
          ]()}
        </div>
      </div>
    </Modal>
