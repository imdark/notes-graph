...
const getConditions = (
  ...
  return [
    ...
    {
      condition: flavour === 'notesgraph-cloud',
      label: 'syncCloud',
    },
    {
      condition: !!isTeam,
    ...
    {
      condition: flavour !== 'notesgraph-cloud' && flavour !== 'local',
      label: 'selfHosted',
    },
  ];
};
...
const getLabelMap = (t: ReturnType<typeof useI18n>): LabelMap => ({
  local: {
    value: t['com.notesgraph.settings.workspace.state.local'](),
    background: cssVarV2('chip/label/orange'),
  },
  syncCloud: {
    value: t['com.notesgraph.settings.workspace.state.sync-notesgraph-cloud'](),
    background: cssVarV2('chip/label/blue'),
  },
  selfHosted: {
    value: t['com.notesgraph.settings.workspace.state.self-hosted'](),
    background: cssVarV2('chip/label/purple'),
  },
  joinedWorkspace: {
    value: t['com.notesgraph.settings.workspace.state.joined'](),
    background: cssVarV2('chip/label/yellow'),
  },
  availableOffline: {
    value: t['com.notesgraph.settings.workspace.state.available-offline'](),
    background: cssVarV2('chip/label/green'),
  },
  publishedToWeb: {
    value: t['com.notesgraph.settings.workspace.state.published'](),
    background: cssVarV2('chip/label/blue'),
  },
  teamWorkspace: {
    value: t['com.notesgraph.settings.workspace.state.team'](),
    background: cssVarV2('chip/label/purple'),
  },
});
