...
import type * as Infra from '@notesgraph/infra';
import {
  cleanup,
  fireEvent,
  render,
...
vi.mock('@notesgraph/component/setting-components', () => ({
  SettingHeader: ({
    title,
    subtitle,
  }: {
...
vi.mock('@notesgraph/core/modules/cloud', () => ({
  WorkspaceServerService: WorkspaceServerServiceToken,
}));

vi.mock('@notesgraph/core/modules/workspace', () => ({
  WorkspaceService: WorkspaceServiceToken,
}));

vi.mock('@notesgraph/electron-api', () => ({
  get apis() {
    return electronApiState.apis;
  },
}));

vi.mock('@notesgraph/graphql', () => ({
  ByokKeyStorage,
  ByokKeyTestStatus,
  ByokProvider,
...
vi.mock('@notesgraph/i18n', () => {
  const messages: Record<string, string> = {
    'com.notesgraph.settings.workspace.byok.action.add-key': 'Add key',
    'com.notesgraph.settings.workspace.byok.action.edit': 'Edit',
    'com.notesgraph.settings.workspace.byok.action.delete': 'Delete',
    'com.notesgraph.settings.workspace.byok.action.test-key': 'Test key',
    'com.notesgraph.settings.workspace.byok.action.save-key': 'Save key',
    'com.notesgraph.settings.workspace.byok.action.cancel': 'Cancel',
    'com.notesgraph.settings.workspace.byok.action.clear-all':
      'Clear all BYOK keys',
    'com.notesgraph.settings.workspace.byok.field.api-key': 'API key',
    'com.notesgraph.settings.workspace.byok.field.storage': 'Key storage',
    'com.notesgraph.settings.workspace.byok.placeholder.key-name': 'Primary',
    'com.notesgraph.settings.workspace.byok.status.key-verified':
      'Key verified',
    'com.notesgraph.settings.workspace.byok.status.disabled-after-failure':
      'Disabled after failure',
    'com.notesgraph.settings.workspace.byok.storage.local': 'Local',
    'com.notesgraph.settings.workspace.byok.storage.server': 'Server',
    'com.notesgraph.settings.workspace.byok.storage.local-this-device':
      'Local (this device)',
    'com.notesgraph.settings.workspace.byok.storage.local-desktop-only':
      'Local (Desktop only)',
    'com.notesgraph.settings.workspace.byok.usage.tokens': '{{count}} tokens',
    'com.notesgraph.settings.workspace.byok.notify.operation-failed.message':
      'Please try again.',
    'com.notesgraph.settings.workspace.byok.notify.test-failed.title':
      'Key test failed',
    'com.notesgraph.settings.workspace.byok.notify.load-failed.title':
      'BYOK settings not loaded',
    'com.notesgraph.settings.workspace.byok.notify.save-failed.title':
      'BYOK key not saved',
    'com.notesgraph.settings.workspace.byok.notify.delete-failed.title':
      'BYOK key not deleted',
    'com.notesgraph.settings.workspace.byok.notify.reorder-failed.title':
      'BYOK keys not reordered',
    'com.notesgraph.settings.workspace.byok.notify.clear-failed.title':
