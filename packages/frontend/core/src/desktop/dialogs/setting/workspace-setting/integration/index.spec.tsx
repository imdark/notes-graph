...
vi.mock('@notesgraph/core/components/hooks/use-workspace-info', () => ({
...
vi.mock('@notesgraph/i18n', () => {
  const messages: Record<string, string> = {
    'com.notesgraph.integration.integrations': 'Integrations',
    'com.notesgraph.integration.setting.description': 'Integration settings',
    'com.notesgraph.settings.workspace.byok.title': 'AI BYOK',
    'com.notesgraph.settings.workspace.byok.subtitle':
...
describe('IntegrationSetting', () => {
  beforeEach(() => {
    ...
    workspaceState.flavour = 'notesgraph';
  });
