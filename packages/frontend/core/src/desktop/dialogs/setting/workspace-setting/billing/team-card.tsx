...
import { SubscriptionRecurring } from '@notesgraph/graphql';
...
export const TeamCard = () => {
  ...
  const description = useMemo(() => {
    if (recurring === SubscriptionRecurring.Yearly) {
      return t[
        'com.notesgraph.settings.workspace.billing.team-workspace.description.billed.annually'
      ]();
    }
    if (recurring === SubscriptionRecurring.Monthly) {
      return t[
        'com.notesgraph.settings.workspace.billing.team-workspace.description.billed.monthly'
      ]();
    }
    return t['com.notesgraph.payment.billing-setting.free-trial']();
  }, [recurring, t]);

  const expirationDate = useMemo(() => {
    if (expiration && endDate) {
      return t[
        'com.notesgraph.settings.workspace.billing.team-workspace.not-renewed'
      ]({
    ...
    if (nextBillingDate && endDate) {
      return t[
        'com.notesgraph.settings.workspace.billing.team-workspace.next-billing-date'
      ]({
        date: new Date(endDate).toLocaleDateString(),
      });
    }
      ...
      <div className={styles.currentPlan}>
        <SettingRow
          ...
          name={
            <CardNameLabelRow
              cardName={t[
                'com.notesgraph.settings.workspace.billing.team-workspace'
              ]()}
        ...
        >
          ...
          >
            {t[
              'com.notesgraph.settings.workspace.billing.team-workspace.cancel-plan'
            ]()}
          </Button>
        </CancelTeamAction>
      </div>
