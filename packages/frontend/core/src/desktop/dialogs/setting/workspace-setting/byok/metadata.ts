import { ByokKeyStorage, ByokProvider } from '@notesgraph/graphql';
import type { I18nInstance } from '@notesgraph/i18n';
...
export function byokT(
  ...
  return t.t('com.notesgraph.settings.workspace.byok.' + key, options);
}
