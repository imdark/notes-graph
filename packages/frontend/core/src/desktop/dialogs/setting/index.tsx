...
import { Loading, Scrollable } from '@notesgraph/component';
import { WorkspaceDetailSkeleton } from '@notesgraph/component/setting-components';
import type { ModalProps } from '@notesgraph/component/ui/modal';
import { Modal } from '@notesgraph/component/ui/modal';
import {
  AuthService,
...
const SettingModalInner = ({
  ...
  const [openStarNotesGraphModal, setOpenStarNotesGraphModal] = useState(false);

  const handleOpenIssueFeedbackModal = useCallback(() => {
    setOpenIssueFeedbackModal(true);
  }, [setOpenIssueFeedbackModal]);

  const handleOpenStarNotesGraphModal = useCallback(() => {
    setOpenStarNotesGraphModal(true);
  }, [setOpenStarNotesGraphModal]);
          ...
          >
            <div className={style.centerContainer}>
              ...
              <div className={style.footer}>
                ...
                <Trans
                  i18nKey={'com.notesgraph.settings.suggestion-2'}
                  components={{
                    1: (
                      <span
                        className={style.link}
                        onClick={handleOpenStarNotesGraphModal}
                      />
                    ),
                    2: (
                      <span
              ...
              <StarNotesGraphModal
                open={openStarNotesGraphModal}
                setOpen={setOpenStarNotesGraphModal}
              />
              <IssueFeedbackModal
