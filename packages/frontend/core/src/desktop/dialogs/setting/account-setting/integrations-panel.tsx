...
import { buildWorkspaceSettingsRedirectUri } from '@notesgraph/core/components/hooks/use-navigate-helper';
import {
  useQuery,
  type UseQueryConfig,
} from '@notesgraph/core/components/hooks/use-query';
...
const CalDAVLinkDialog = ({
  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (!selectedProvider) {
      nextErrors.provider =
        t['com.notesgraph.integration.calendar.caldav.field.provider.error']();
    }
    if (!username.trim()) {
      nextErrors.username =
        t['com.notesgraph.integration.calendar.caldav.field.username.error']();
    }
    if (!password) {
      nextErrors.password =
        t['com.notesgraph.integration.calendar.caldav.field.password.error']();
    }
    ...
    try {
      ...
      notify.error({
        title: t['com.notesgraph.integration.calendar.caldav.link.failed'](),
  ...
  return (
    <Modal
      open={open}
      width={480}
      title={t['com.notesgraph.integration.calendar.caldav.link.title']()}
    ...
    >
      <div className={styles.caldavField}>
        <div className={styles.caldavLabel}>
          {t['com.notesgraph.integration.calendar.caldav.field.provider']()}
        </div>
        <Menu
        ...
        >
          ...
          >
            {selectedProvider?.label ??
              t[
                'com.notesgraph.integration.calendar.caldav.field.provider.placeholder'
              ]()}
          </Button>
        </Menu>
        {errors.provider ? (
        ...
        {selectedProvider?.requiresAppPassword ? (
          <div className={styles.caldavHint}>
            {t[
              'com.notesgraph.integration.calendar.caldav.hint.app-password'
            ]()}
            {selectedProvider.docsUrl ? (
              ...
              >
                {t[
                  'com.notesgraph.integration.calendar.caldav.hint.learn-more'
                ]()}
              </a>
            ) : null}
          </div>
          ...
          <div className={styles.caldavHint}>
            <a
              ...
              rel="noreferrer noopener"
            >
              {t['com.notesgraph.integration.calendar.caldav.hint.guide']()}
            </a>
          </div>
        ) : null}
      </div>
      <div className={styles.caldavField}>
        <div className={styles.caldavLabel}>
          {t['com.notesgraph.integration.calendar.caldav.field.username']()}
        </div>
        <Input
          value={username}
          onInput={handleUsernameInput}
          placeholder={t[
            'com.notesgraph.integration.calendar.caldav.field.username.placeholder'
          ]()}
      ...
      <div className={styles.caldavField}>
        <div className={styles.caldavLabel}>
          {t['com.notesgraph.integration.calendar.caldav.field.password']()}
        </div>
        <Input
          value={password}
          onInput={handlePasswordInput}
          placeholder={t[
            'com.notesgraph.integration.calendar.caldav.field.password.placeholder'
          ]()}
          type="password"
      ...
      <div className={styles.caldavField}>
        <div className={styles.caldavLabel}>
          {t['com.notesgraph.integration.calendar.caldav.field.displayName']()}
        </div>
        <Input
          value={displayName}
          onInput={handleDisplayNameInput}
          placeholder={t[
            'com.notesgraph.integration.calendar.caldav.field.displayName.placeholder'
          ]()}
          disabled={submitting}
        />
      </div>
      <div className={styles.caldavFooter}>
        ...
        >
          {t['com.notesgraph.integration.calendar.account.link']()}
        </Button>
      </div>
    </Modal>
  );
...
export const IntegrationsPanel = ({
  ...
  const {
    ...
    useMemo(
      () =>
        makeConfig(
          t['com.notesgraph.integration.calendar.account.load-error']()
        ),
      [makeConfig, t]
    )
  );
  ...
  const {
    ...
    useMemo(
      () =>
        makeConfig(
          t['com.notesgraph.integration.calendar.provider.load-error']()
        ),
      [makeConfig, t]
    )
  );
  ...
  const handleLink = useCallback(
    async (provider: CalendarProviderType) => {
      ...
      try {
        ...
        notify.error({
          title: t['com.notesgraph.integration.calendar.auth.start-error'](),
        });
      } finally {
        setLinking(false);
      }
  ...
  const handleUnlink = useCallback(
    async (accountId: string) => {
      ...
      try {
        ...
        notify.error({
          title:
            t['com.notesgraph.integration.calendar.account.unlink-error'](),
        });
      } finally {
  ...
  return (
    <>
      ...
      <CollapsibleWrapper
        ...
        caption={t['com.notesgraph.integration.setting.description']()}
      >
        <div className={styles.panel}>
          <div className={styles.panelHeader}>
            <div className={styles.panelTitle}>
              <TodayIcon />
              <span>{t['com.notesgraph.integration.calendar.name']()}</span>
            </div>
          ...
          {loading ? (
            ...
            <div className={styles.accountList}>
              {accounts.map(account => {
                ...
                const statusMessage = account.lastError
                  ? t[
                      'com.notesgraph.integration.calendar.account.status.failed'
                    ]({
                      error: account.lastError,
                    })
                  : t[
                      'com.notesgraph.integration.calendar.account.status.failed-reconnect'
                    ]();
                ...
                return (
                  ...
                  >
                    <div className={styles.accountInfo}>
                      ...
                      <div className={styles.accountDetails}>
                        ...
                        <div className={styles.accountMeta}>
                          ...
                          <span>
                            {t[
                              'com.notesgraph.integration.calendar.account.count'
                    ...
                    <div className={styles.accountActions}>
                      ...
                      >
                        {t[
                          'com.notesgraph.integration.calendar.account.unlink'
                        ]()}
                      </Button>
                    </div>
                  </div>
            ...
            <div className={styles.empty}>
              {t['com.notesgraph.integration.calendar.account.linked-empty']()}
            </div>
          )}
        </div>
      </CollapsibleWrapper>
