...
import { SpellCheckSettingService } from '@notesgraph/core/modules/editor-setting/services/spell-check-setting';
import { FeatureFlagService } from '@notesgraph/core/modules/feature-flag';
import {
  type FontData,
  SystemFontFamilyService,
} from '@notesgraph/core/modules/system-font-family';
...
const getLabel = (fontKey: FontFamily, t: ReturnType<typeof useI18n>) => {
  switch (fontKey) {
    case 'Sans':
      return t['com.notesgraph.appearanceSettings.fontStyle.sans']();
    case 'Serif':
      return t['com.notesgraph.appearanceSettings.fontStyle.serif']();
    case 'Mono':
      return t[`com.notesgraph.appearanceSettings.fontStyle.mono`]();
    case 'Custom':
      return t['com.notesgraph.settings.editorSettings.edgeless.custom']();
    default:
      return '';
  }
};
...
const FontFamilySettings = () => {
  ...
  return (
    <SettingRow
      name={t['com.notesgraph.appearanceSettings.font.title']()}
      desc={t['com.notesgraph.appearanceSettings.font.description']()}
    >
      <RadioGroup
        items={radioItems}
...
const CustomFontFamilySettings = () => {
  ...
  return (
    <SettingRow
      name={t[
        'com.notesgraph.settings.editorSettings.general.font-family.custom.title'
      ]()}
      desc={t[
        'com.notesgraph.settings.editorSettings.general.font-family.custom.description'
      ]()}
    >
      <Menu
...
const FontSizeSettings = () => {
  ...
  return (
    <SettingRow
      name={t[
        'com.notesgraph.settings.editorSettings.general.font-size.title'
      ]()}
      desc={t[
        'com.notesgraph.settings.editorSettings.general.font-size.description'
      ]()}
    >
...
const NewDocDefaultModeSettings = () => {
  const t = useI18n();
  const { editorSettingService, docModeRegistryService } = useServices({
    EditorSettingService,
    DocModeRegistryService,
  });
  const settings = useLiveData(editorSettingService.editorSetting.settings$);
  const creatableModes = useLiveData(docModeRegistryService.creatableModes$);
  const items = useMemo(
    () => [
      ...creatableModes.map(mode => ({
        value: mode.id as EditorSettingSchema['newDocDefaultMode'],
        label: t.t(mode.labelKey),
        testId: `${mode.id}-mode-trigger`,
      })),
      {
        value: 'ask' as EditorSettingSchema['newDocDefaultMode'],
        label: t['com.notesgraph.settings.editorSettings.ask-me-every-time'](),
  ...
  return (
    <SettingRow
      name={t[
        'com.notesgraph.settings.editorSettings.general.default-new-doc.title'
      ]()}
      desc={t[
        'com.notesgraph.settings.editorSettings.general.default-new-doc.description'
      ]()}
    >
      <Menu
...
const getDateTitleFormatLabel = (format: NewDocDateTitleFormat) => {
  return `com.notesgraph.settings.editorSettings.general.auto-date-title.format.${format.toLowerCase()}` as const;
};
...
export const NewDocDateTitleSettings = () => {
  ...
  return (
    <>
      <SettingRow
        name={t[
          'com.notesgraph.settings.editorSettings.general.auto-date-title.title'
        ]()}
        desc={t[
          'com.notesgraph.settings.editorSettings.general.auto-date-title.description'
        ]()}
      >
        <Switch
      ...
      {settings.autoTitleNewDocWithCurrentDate ? (
        <SettingRow
          name={t[
            'com.notesgraph.settings.editorSettings.general.auto-date-title.format.title'
          ]()}
          desc={t[
            'com.notesgraph.settings.editorSettings.general.auto-date-title.format.description'
          ]()}
        >
          <Menu
            contentOptions={menuContentOptions}
      ...
      <SettingRow
        name={t.t(
          'com.notesgraph.settings.editorSettings.general.add-icon-option.title'
        )}
        desc={t.t(
          'com.notesgraph.settings.editorSettings.general.add-icon-option.description'
        )}
      >
        <Switch
...
const AISettings = () => {
  ...
  const onToggleAI = useCallback(
    (checked: boolean) => {
      openConfirmModal({
        title: checked
          ? t[
              'com.notesgraph.settings.editorSettings.general.ai.enable.title'
            ]()
          : t[
              'com.notesgraph.settings.editorSettings.general.ai.disable.title'
            ](),
        description: checked
          ? t[
              'com.notesgraph.settings.editorSettings.general.ai.enable.description'
            ]()
          : t[
              'com.notesgraph.settings.editorSettings.general.ai.disable.description'
            ](),
        confirmText: checked
          ? t[
              'com.notesgraph.settings.editorSettings.general.ai.enable.confirm'
            ]()
          : t[
              'com.notesgraph.settings.editorSettings.general.ai.disable.confirm'
            ](),
        cancelText: t['Cancel'](),
  ...
  return (
    <SettingRow
      name={t['com.notesgraph.settings.editorSettings.general.ai.title']()}
      desc={t[
        'com.notesgraph.settings.editorSettings.general.ai.description'
      ]()}
    >
...
const SpellCheckSettings = () => {
  ...
  return (
    <SettingRow
      name={t[
        'com.notesgraph.settings.editorSettings.general.spell-check.title'
      ]()}
      desc={
        requireRestart ? (
          <div className={styles.spellCheckSettingDescription}>
            <Trans i18nKey="com.notesgraph.settings.editorSettings.general.spell-check.restart-hint">
          ...
          t[
            'com.notesgraph.settings.editorSettings.general.spell-check.description'
          ]()
        )
      }
    >
...
const MiddleClickPasteSettings = () => {
  ...
  return (
    <SettingRow
      name={t[
        'com.notesgraph.settings.editorSettings.general.middle-click-paste.title'
      ]()}
      desc={t[
        'com.notesgraph.settings.editorSettings.general.middle-click-paste.description'
      ]()}
    >
      <Switch
...
export const General = () => {
  ...
  return (
    <SettingWrapper
      title={t['com.notesgraph.settings.editorSettings.general']()}
    >
      <AISettings />
      <FontFamilySettings />
