...
import type { ShortcutsInfo } from '../../../../../components/hooks/notesgraph/use-shortcuts';
import {
  useEdgelessShortcuts,
  useGeneralShortcuts,
  useMarkdownShortcuts,
  usePageShortcuts,
} from '../../../../../components/hooks/notesgraph/use-shortcuts';
  ...
  return (
    <>
      <SettingHeader
        ...
        subtitle={t['com.notesgraph.keyboardShortcuts.subtitle']()}
