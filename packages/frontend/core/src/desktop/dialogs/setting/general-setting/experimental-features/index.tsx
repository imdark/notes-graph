  ...
  return (
    <div className={styles.promptRoot} data-testid="experimental-prompt">
      <div className={styles.promptTitle}>
        {t[
          'com.notesgraph.settings.workspace.experimental-features.prompt-header'
        ]()}
      </div>
      ...
      <div className={styles.promptWarning}>
        <div className={styles.promptWarningTitle}>
          {t[
            'com.notesgraph.settings.workspace.experimental-features.prompt-warning-title'
          ]()}
        </div>
        {t[
          'com.notesgraph.settings.workspace.experimental-features.prompt-warning'
        ]()}
      </div>
      ...
      <label className={styles.promptDisclaimer}>
        ...
        />
        {t[
          'com.notesgraph.settings.workspace.experimental-features.prompt-disclaimer'
        ]()}
      </label>
      ...
      <div className={styles.promptDisclaimerConfirm}>
        ...
        >
          {t[
            'com.notesgraph.settings.workspace.experimental-features.get-started'
          ]()}
        </Button>
      </div>
    </div>
...
const feedbackLink: Record<NonNullable<Flag['feedbackType']>, string> = {
  ...
  email: 'mailto:support@notesgraph.com',
  github: 'https://github.com/notesgraph/notesgraph/issues',
};
...
const ExperimentalFeaturesMain = () => {
  ...
  return (
    <>
      <SettingHeader
        title={t[
          'com.notesgraph.settings.workspace.experimental-features.header.plugins'
        ]()}
        subtitle={t[
          'com.notesgraph.settings.workspace.experimental-features.header.subtitle'
        ]()}
      />
      <div
      ...
      >
        {Object.keys(NOTESGRAPH_FLAGS).map(key => (
          <ExperimentalFeaturesItem
            key={key}
            flagKey={key}
            flag={featureFlagService.flags[key as keyof NOTESGRAPH_FLAGS]}
          />
        ))}
      </div>
    </>
...
const experimentalFeaturesDisclaimerAtom = atomWithStorage(
  'notesgraph:experimental-features-disclaimer',
  false
);
