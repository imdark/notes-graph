...
import { LayoutType, MindmapStyle } from '@blocksuite/notesgraph/model';
...
export const MindMapSettings = () => {
    ...
    () => [
      {
        ...
        label:
          t[
            'com.notesgraph.settings.editorSettings.edgeless.mind-map.layout.left'
          ](),
      },
      {
        ...
        label:
          t[
            'com.notesgraph.settings.editorSettings.edgeless.mind-map.layout.radial'
          ](),
      },
      {
        ...
        label:
          t[
            'com.notesgraph.settings.editorSettings.edgeless.mind-map.layout.right'
          ](),
      },
    ],
    [t]
  ...
  return (
    <>
      <EdgelessSnapshot
        title={t['com.notesgraph.settings.editorSettings.edgeless.mind-map']()}
        docName="mindmap"
      ...
      <SettingRow
        name={t[
          'com.notesgraph.settings.editorSettings.edgeless.mind-map.layout'
        ]()}
        desc={''}
      >
        <RadioGroup
