import { notify, Switch } from '@notesgraph/component';
import {
  SettingHeader,
  SettingRow,
  SettingWrapper,
...
export const NotificationSettings = () => {
  ...
  return (
    <>
      <SettingHeader
        title={t['com.notesgraph.setting.notifications.header.title']()}
        subtitle={t[
          'com.notesgraph.setting.notifications.header.description'
        ]()}
      />
      <SettingWrapper
        title={t['com.notesgraph.setting.notifications.email.title']()}
      >
        ...
        <SettingRow
          name={t['com.notesgraph.setting.notifications.email.mention.title']()}
          desc={t[
            'com.notesgraph.setting.notifications.email.mention.subtitle'
          ]()}
        >
          <Switch
        ...
        <SettingRow
          name={t['com.notesgraph.setting.notifications.email.invites.title']()}
          desc={t[
            'com.notesgraph.setting.notifications.email.invites.subtitle'
          ]()}
        >
          <Switch
        ...
        <SettingRow
          name={t[
            'com.notesgraph.setting.notifications.email.comments.title'
          ]()}
          desc={t[
            'com.notesgraph.setting.notifications.email.comments.subtitle'
          ]()}
        >
          <Switch
