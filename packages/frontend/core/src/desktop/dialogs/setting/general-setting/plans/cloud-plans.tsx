...
const freeBenefits: BenefitsGetter = t => ({
  [t['com.notesgraph.payment.cloud.free.benefit.g1']()]: (
    [1, 2, 3] as const
  ).map(i => ({
    title: t[`com.notesgraph.payment.cloud.free.benefit.g1-${i}`](),
  })),
  [t['com.notesgraph.payment.cloud.free.benefit.g2']()]: (
    [1, 2, 3, 4, 5] as const
  ).map(i => ({
    title: t[`com.notesgraph.payment.cloud.free.benefit.g2-${i}`](),
  })),
});

const proBenefits: BenefitsGetter = t => ({
  [t['com.notesgraph.payment.cloud.pro.benefit.g1']()]: [
    {
      title: t['com.notesgraph.payment.cloud.pro.benefit.g1-1'](),
      icon: <NotesGraphLogoIcon />,
    },
    ...([2, 3, 4, 5, 7, 8] as const).map(i => ({
      title: t[`com.notesgraph.payment.cloud.pro.benefit.g1-${i}`](),
    })),
  ],
});

const teamBenefits: BenefitsGetter = t => ({
  [t['com.notesgraph.payment.cloud.team-workspace.benefit.g1']()]: [
    {
      title: t['com.notesgraph.payment.cloud.team-workspace.benefit.g1-1'](),
      icon: <NotesGraphLogoIcon />,
    },
    ...([2, 3, 4, 5, 6] as const).map(i => ({
      title: t[`com.notesgraph.payment.cloud.team-workspace.benefit.g1-${i}`](),
    })),
  ],
});
  ...
  return new Map<SubscriptionPlan, FixedPrice | DynamicPrice>([
    [
      SubscriptionPlan.Free,
      {
        ...
        price: '0',
        yearlyPrice: '0',
        name: t['com.notesgraph.payment.cloud.free.name'](),
        description: t['com.notesgraph.payment.cloud.free.description'](),
        titleRenderer: () => t['com.notesgraph.payment.cloud.free.title'](),
    ...
    [
      SubscriptionPlan.Pro,
      {
        ...
        price: '1',
        yearlyPrice: '1',
        name: t['com.notesgraph.payment.cloud.pro.name'](),
        description: t['com.notesgraph.payment.cloud.pro.description'](),
        titleRenderer: (recurring, detail) => {
          ...
          return (
            <>
              {t['com.notesgraph.payment.cloud.pro.title.price-monthly']({
                price: '$' + price,
              })}
              {recurring === SubscriptionRecurring.Yearly ? (
                <span className={planTitleTitleCaption}>
                  {t['com.notesgraph.payment.cloud.pro.title.billed-yearly']()}
                </span>
              ) : null}
            </>
          );
    ...
    [
      SubscriptionPlan.Team,
      {
        ...
        price: '2',
        yearlyPrice: '2',
        name: t['com.notesgraph.payment.cloud.team-workspace.name'](),
        description:
          t['com.notesgraph.payment.cloud.team-workspace.description'](),
        titleRenderer: (recurring, detail) => {
          const price =
            recurring === SubscriptionRecurring.Yearly
              ? detail.yearlyPrice
          ...
          return (
            <>
              {t[
                'com.notesgraph.payment.cloud.team-workspace.title.price-monthly'
              ]({
                price: '$' + price,
              })}
              {recurring === SubscriptionRecurring.Yearly ? (
                <span className={planTitleTitleCaption}>
                  {t[
                    'com.notesgraph.payment.cloud.team-workspace.title.billed-yearly'
                  ]()}
                </span>
              ) : null}
            </>
...
const getRecurringLabel = ({
  ...
  return recurring === SubscriptionRecurring.Monthly
    ? t['com.notesgraph.payment.recurring-monthly']()
    : t['com.notesgraph.payment.recurring-yearly']();
};
...
export const CloudPlans = () => {
  ...
  const cloudCaption = loggedIn ? (
    isCanceled ? (
      <p>
        {t['com.notesgraph.payment.subtitle-canceled']({
      ...
      <p>
        <Trans
          plan={currentPlan}
          i18nKey="com.notesgraph.payment.subtitle-active"
          values={{ currentPlan }}
        >
          You are currently on the {{ currentPlan }} plan. If you have any
          questions, please contact our&nbsp;
          <a
            href="mailto:support@notesgraph.com"
            style={{ color: 'var(--notesgraph-link-color)' }}
          >
            customer support
          </a>
          .
    ...
    <p>{t['com.notesgraph.payment.subtitle-not-signed-in']()}</p>
  );
    ...
    <div className={styles.recurringToggleWrapper}>
      <div>
        <div className={styles.recurringToggleRecurring}>
          <span>
            {t[
              'com.notesgraph.payment.cloud.pricing-plan.toggle-billed-yearly'
            ]()}
          </span>
        </div>
        {yearlyDiscount ? (
          <div className={styles.recurringToggleDiscount}>
            {t['com.notesgraph.payment.cloud.pricing-plan.toggle-discount']({
  ...
  const cloudSelect = (
    <div className={styles.cloudSelect}>
      <b>{t['com.notesgraph.payment.cloud.pricing-plan.select.title']()}</b>
      <span>
        {t['com.notesgraph.payment.cloud.pricing-plan.select.caption']()}
      </span>
    </div>
  );
