...
import { UserFeatureService } from '@notesgraph/core/modules/cloud/services/user-feature';
...
import { NotesGraphPricingPlans } from './plans';
...
export const useGeneralSettingList = (): GeneralSettingList => {
  ...
  return useMemo(() => {
    const settings: GeneralSettingList = [
      {
        key: 'appearance',
        title: t['com.notesgraph.settings.appearance'](),
        icon: <AppearanceIcon />,
        testId: 'appearance-panel-trigger',
      },
      {
        key: 'shortcuts',
        title: t['com.notesgraph.keyboardShortcuts.title'](),
        icon: <KeyboardIcon />,
    ...
    if (loggedIn) {
      settings.push({
        key: 'notifications',
        title: t['com.notesgraph.setting.notifications'](),
    ...
    if (enableEditorSettings) {
      ...
      settings.splice(1, 0, {
        key: 'editor',
        title: t['com.notesgraph.settings.editorSettings'](),
        icon: <PenIcon />,
    ...
    if (hasPaymentFeature) {
      settings.splice(4, 0, {
        key: 'plans',
        title: t['com.notesgraph.payment.title'](),
        icon: <UpgradeIcon />,
      ...
      if (loggedIn) {
        settings.splice(4, 0, {
          key: 'billing',
          title: t['com.notesgraph.payment.billing-setting.title'](),
          icon: <PaymentIcon />,
    ...
    settings.push(
      ...
      },
      {
        ...
        title: t['com.notesgraph.settings.workspace.experimental-features'](),
        icon: <ExperimentIcon />,
...
export const GeneralSetting = ({
  ...
  switch (activeTab) {
    ...
    case 'about':
      return <AboutNotesGraph />;
    case 'plans':
      return <NotesGraphPricingPlans />;
    case 'billing':
