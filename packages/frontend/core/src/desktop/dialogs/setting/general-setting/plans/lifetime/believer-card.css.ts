...
export const notesgraphIconGradientStart = createVar();
export const notesgraphIconGradientStop = createVar();
...
globalStyle(`.${bg} > svg.notesgraph-svg`, {
  vars: {
    [notesgraphIconGradientStart]: colorSchemes.light.notesgraph.start,
    [notesgraphIconGradientStop]: colorSchemes.light.notesgraph.stop,
  },
  position: 'absolute',
  zIndex: 0,
});
globalStyle(`[data-theme='dark'] .${bg} > svg.notesgraph-svg`, {
  vars: {
    [notesgraphIconGradientStart]: colorSchemes.dark.notesgraph.start,
    [notesgraphIconGradientStop]: colorSchemes.dark.notesgraph.stop,
  },
});
...
// --------- style1 ---------
globalStyle(`.${card}[data-type="1"] .${bg} > svg.notesgraph-svg`, {
  right: -150,
  top: -100,
});
...
// --------- style2 ---------
globalStyle(`.${card}[data-type="2"] .${bg} > svg.notesgraph-svg`, {
  position: 'absolute',
  right: -140,
  bottom: -130,
