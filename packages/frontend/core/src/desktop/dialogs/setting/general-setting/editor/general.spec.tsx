...
vi.mock('@notesgraph/i18n', () => {
  const translations: Record<string, string> = {
    ...
    'com.notesgraph.settings.editorSettings.general.auto-date-title.format.dd-mm-yyyy':
      'DD-MM-YYYY',
    'com.notesgraph.settings.editorSettings.general.auto-date-title.format.mm-dd-yyyy':
      'MM-DD-YYYY',
    'com.notesgraph.settings.editorSettings.general.auto-date-title.format.yyyy-mm-dd':
      'YYYY-MM-DD',
    'com.notesgraph.settings.editorSettings.general.auto-date-title.format.journal':
