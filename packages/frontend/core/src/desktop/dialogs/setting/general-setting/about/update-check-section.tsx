...
const useUpdateStatusLabels = (checkUpdateStatus: CheckUpdateStatus) => {
  ...
  const buttonLabel = useMemo(() => {
    if (updateReady) {
      return t['com.notesgraph.aboutNotesGraph.checkUpdate.button.restart']();
    }
    if (updateAvailable && downloadProgress === null) {
      return t['com.notesgraph.aboutNotesGraph.checkUpdate.button.download']();
    }
    if (
      checkUpdateStatus === CheckUpdateStatus.LATEST ||
      checkUpdateStatus === CheckUpdateStatus.ERROR
    ) {
      return t['com.notesgraph.aboutNotesGraph.checkUpdate.button.retry']();
    }
    return t['com.notesgraph.aboutNotesGraph.checkUpdate.button.check']();
  }, [checkUpdateStatus, downloadProgress, t, updateAvailable, updateReady]);

  const subtitleLabel = useMemo(() => {
    if (updateReady) {
      return t['com.notesgraph.aboutNotesGraph.checkUpdate.subtitle.restart']();
    } else if (updateAvailable && downloadProgress === null) {
      return t[
        'com.notesgraph.aboutNotesGraph.checkUpdate.subtitle.update-available'
      ]({
        version: updateAvailable.version,
      });
    } else if (checkingForUpdates) {
      return t[
        'com.notesgraph.aboutNotesGraph.checkUpdate.subtitle.checking'
      ]();
    } else if (updateAvailable && downloadProgress !== null) {
      return t[
        'com.notesgraph.aboutNotesGraph.checkUpdate.subtitle.downloading'
      ]();
    } else if (checkUpdateStatus === CheckUpdateStatus.ERROR) {
      return t['com.notesgraph.aboutNotesGraph.checkUpdate.subtitle.error']();
    } else if (checkUpdateStatus === CheckUpdateStatus.LATEST) {
      return t['com.notesgraph.aboutNotesGraph.checkUpdate.subtitle.latest']();
    }
    return t['com.notesgraph.aboutNotesGraph.checkUpdate.subtitle.check']();
  }, [
    checkUpdateStatus,
    downloadProgress,
    checkingForUpdates,
...
export const UpdateCheckSection = () => {
  ...
  return (
    <SettingRow
      name={t['com.notesgraph.aboutNotesGraph.checkUpdate.title']()}
      desc={subtitle}
    >
      <Button
