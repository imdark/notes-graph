...
import { MenuItem, MenuTrigger, Slider } from '@notesgraph/component';
...
export const PenSettings = () => {
  ...
  return (
    <>
      <EdgelessSnapshot
        title={t['com.notesgraph.settings.editorSettings.edgeless.pen']()}
        docName="pen"
        keyName="brush"
        getElements={getElements}
      />
      <SettingRow
        name={t['com.notesgraph.settings.editorSettings.edgeless.pen.color']()}
        desc={''}
      >
        {currentColor ? (
          <DropdownMenu
      ...
      <SettingRow
        name={t[
          'com.notesgraph.settings.editorSettings.edgeless.pen.thickness'
        ]()}
        desc={''}
      >
        <Slider
