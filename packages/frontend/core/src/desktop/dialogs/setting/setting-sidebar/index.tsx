...
import { UserPlanButton } from '@notesgraph/core/components/notesgraph/auth/user-plan-button';
...
export const SignInButton = () => {
  ...
  return (
    ...
    >
      ...
      <div className="content">
        <div className="name" title={t['com.notesgraph.settings.sign']()}>
          {t['com.notesgraph.settings.sign']()}
        </div>
        <div
          className="email"
          title={t['com.notesgraph.setting.sign.message']()}
        >
          {t['com.notesgraph.setting.sign.message']()}
        </div>
      </div>
    </div>
  );
...
export const SettingSidebar = ({
  ...
  const groups = useMemo(() => {
    const res = [
      {
        key: 'setting:general',
        title: t['com.notesgraph.settingSidebar.settings.general'](),
        items: generalList,
      },
      {
