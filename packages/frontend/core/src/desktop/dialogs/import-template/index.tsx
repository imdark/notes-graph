...
import { Button, Modal } from '@notesgraph/component';
...
} from '@notesgraph/core/modules/import-template';
import {
    ...
    <>
      <div className={styles.dialogContainer}>
        ...
        <h6 className={styles.mainTitle}>
          {t['com.notesgraph.import-template.dialog.createDocWithTemplate']({
            templateName,
          })}
        </h6>
        {noWorkspace ? (
      ...
      {importingError && (
        <span style={{ color: cssVar('warningColor') }}>
          {t['com.notesgraph.import-template.dialog.errorImport']()}
        </span>
      )}
      {downloadError ? (
        <span style={{ color: cssVar('warningColor') }}>
          {t['com.notesgraph.import-template.dialog.errorLoad']()}
        </span>
      ) : selectedWorkspace ? (
        <Button
        ...
        >
          {selectedWorkspaceName &&
            t['com.notesgraph.import-template.dialog.createDocToWorkspace']({
        ...
        >
          {t['com.notesgraph.import-template.dialog.createDocToNewWorkspace']()}
        </Button>
      )}
    </>
  );
