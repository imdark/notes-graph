...
import { ServerSelector } from '@notesgraph/core/components/server-selector';
import {
  AuthService,
  type Server,
  ServersService,
    ...
    <div className={styles.root}>
      ...
      <div className={styles.textContainer}>
        <div className={styles.title}>
          {t['com.notesgraph.enableNotesGraphCloudModal.custom-server.title']({
            workspaceName: workspace?.name$.value || 'untitled',
          })}
        </div>
        <div className={styles.description}>
          {t[
            'com.notesgraph.enableNotesGraphCloudModal.custom-server.description'
          ]()}
        </div>
      </div>
      ...
      <Button
        ...
        variant="primary"
      >
        {t['com.notesgraph.enableNotesGraphCloudModal.custom-server.enable']()}
      </Button>
    </div>
  );
};
