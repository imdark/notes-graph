...
import type { useDropTarget } from '@notesgraph/component';
...
export const DropEffect = ({
  ...
  return createPortal(
    ...
    >
      ...
      {dropEffect === 'copy'
        ? t['com.notesgraph.rootAppSidebar.explorer.drop-effect.copy']()
        : dropEffect === 'move'
          ? t['com.notesgraph.rootAppSidebar.explorer.drop-effect.move']()
          : t['com.notesgraph.rootAppSidebar.explorer.drop-effect.link']()}
    </div>,
    document.body
  );
};
