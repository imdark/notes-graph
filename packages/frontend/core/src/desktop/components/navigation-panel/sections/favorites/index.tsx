...
import type { FavoriteSupportTypeUnion } from '@notesgraph/core/modules/favorite';
import {
  FavoriteService,
...
export const NavigationPanelFavorites = () => {
  ...
  return (
    <CollapsibleSection
      path={path}
      title={t['com.notesgraph.rootAppSidebar.favorites']()}
      ...
      actions={
        <>
          <IconButton
            ...
            size="16"
            tooltip={t[
              'com.notesgraph.rootAppSidebar.explorer.fav-section-add-tooltip'
            ]()}
          >
            <PlusIcon />
          </IconButton>
