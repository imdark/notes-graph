...
import { IconButton, useConfirmModal } from '@notesgraph/component';
import { DocsService } from '@notesgraph/core/modules/doc';
import { MigrationFavoriteItemsAdapter } from '@notesgraph/core/modules/favorite';
...
export const NavigationPanelMigrationFavorites = () => {
  ...
  const handleClickClear = useCallback(() => {
    openConfirmModal({
      title: t['com.notesgraph.rootAppSidebar.migration-data.clean-all'](),
      description: (
        <Trans
          i18nKey="com.notesgraph.rootAppSidebar.migration-data.clean-all.description"
          components={{
      ...
      confirmText:
        t['com.notesgraph.rootAppSidebar.migration-data.clean-all.confirm'](),
      confirmButtonOptions: {
        variant: 'primary',
      },
      cancelText:
        t['com.notesgraph.rootAppSidebar.migration-data.clean-all.cancel'](),
      onConfirm() {
  ...
  const handleClickHelp = useCallback(() => {
    openConfirmModal({
      title: t['com.notesgraph.rootAppSidebar.migration-data.help'](),
      description: (
        <Trans
          i18nKey="com.notesgraph.rootAppSidebar.migration-data.help.description"
          components={{
            b: <b className={styles.descriptionHighlight} />,
          }}
        />
      ...
      confirmText:
        t['com.notesgraph.rootAppSidebar.migration-data.help.confirm'](),
      confirmButtonOptions: {
        variant: 'primary',
      },
      cancelText:
        t['com.notesgraph.rootAppSidebar.migration-data.help.clean-all'](),
      cancelButtonOptions: {
        prefix: <BroomIcon />,
        onClick: () => {
  ...
  return (
    <CollapsibleSection
      ...
      title={t['com.notesgraph.rootAppSidebar.migration-data']()}
      actions={
        <>
          <IconButton
