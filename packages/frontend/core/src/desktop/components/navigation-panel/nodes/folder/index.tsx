...
import {
  type FolderNode,
  OrganizeService,
} from '@notesgraph/core/modules/organize';
...
const NavigationPanelFolderNodeFolder = ({
  ...
  const handleDelete = useCallback(() => {
    ...
    notify.success({
      title: t['com.notesgraph.rootAppSidebar.organize.delete.notify-title']({
        name,
      }),
      message:
        t['com.notesgraph.rootAppSidebar.organize.delete.notify-message'](),
    });
  }, [name, node, t]);
  ...
  const handleDropOnChildren = useCallback(
    (data: DropTargetDropEvent<NotesGraphDNDData>, dropAtNode?: FolderNode) => {
  ...
  const handleCreateSubfolder = useCallback(() => {
    const newFolderId = node.createFolder(
      t['com.notesgraph.rootAppSidebar.organize.new-folders'](),
      node.indexAt('before')
    );
    ...
    return [
      {
        ...
        view: (
          <IconButton
            ...
            tooltip={t[
              'com.notesgraph.rootAppSidebar.explorer.organize-add-tooltip'
            ]()}
          >
            <PlusIcon />
          </IconButton>
      ...
      },
      {
        ...
        view: (
          <MenuItem prefixIcon={<FolderIcon />} onClick={handleCreateSubfolder}>
            {t[
              'com.notesgraph.rootAppSidebar.organize.folder.create-subfolder'
            ]()}
          </MenuItem>
        ),
      },
      {
        ...
        view: (
          ...
          >
            {t['com.notesgraph.rootAppSidebar.organize.folder.add-docs']()}
          </MenuItem>
        ),
      },
      {
          ...
          <MenuSub
            ...
            items={
              <>
                ...
                >
                  {t[
                    'com.notesgraph.rootAppSidebar.organize.folder.add-tags'
                  ]()}
                </MenuItem>
                <MenuItem
                ...
                >
                  {t[
                    'com.notesgraph.rootAppSidebar.organize.folder.add-collections'
                  ]()}
                </MenuItem>
              </>
            }
          >
            {t['com.notesgraph.rootAppSidebar.organize.folder.add-others']()}
          </MenuSub>
        ),
      },
      ...
      },
      {
        ...
        view: (
          ...
          >
            {t['com.notesgraph.rootAppSidebar.organize.delete']()}
          </MenuItem>
        ),
      },
    ];
        ...
        return [
          {
            ...
            view: (
              ...
              >
                {t[
                  'com.notesgraph.rootAppSidebar.organize.delete-from-folder'
                ]()}
              </MenuItem>
            ),
          },
