...
// https://github.com/toeverything/blocksuite/blob/master/packages/notesgraph/components/src/icons/file-icons.ts
...
export const AttachmentFallback = ({ model, ext }: ErrorProps) => {
  ...
  const title = t['com.notesgraph.attachment.preview.error.title']();
  const subtitle = `.${ext} ${t['com.notesgraph.attachment.preview.error.subtitle']()}`;
