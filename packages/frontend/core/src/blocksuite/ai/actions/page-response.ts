...
import { addSiblingImageBlocks } from '@blocksuite/notesgraph/blocks/image';
import {
  getSurfaceBlock,
  SurfaceBlockModel,
...
import {
  ...
  getCommonBound,
  type XYWH,
} from '@blocksuite/notesgraph/global/gfx';
import type {
  MindmapElementModel,
  ShapeElementModel,
} from '@blocksuite/notesgraph/model';
import { TelemetryProvider } from '@blocksuite/notesgraph/shared/services';
import { type EditorHost, TextSelection } from '@blocksuite/notesgraph/std';
import {
  GfxBlockElementModel,
  type GfxModel,
  LayerManager,
} from '@blocksuite/notesgraph/std/gfx';
import { type BlockProps, Text } from '@blocksuite/notesgraph/store';
import * as Y from 'yjs';

import { getAIPanelWidget } from '../utils/ai-widgets';
import type { AIContext, NotesGraphNode } from '../utils/context';
...
function findFrameObject(obj: NotesGraphNode): NotesGraphNode | null {
  if (obj.flavour === 'notesgraph:frame') {
    return obj;
  }
