import { splitElements } from '@blocksuite/notesgraph/blocks/root';
...
import { type BlockModel, Slice } from '@blocksuite/notesgraph/store';
...
>(
  aiPanel: NotesGraphAIPanelWidget,
