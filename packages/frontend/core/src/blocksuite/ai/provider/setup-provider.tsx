import { toggleGeneralAIOnboarding } from '@notesgraph/core/components/notesgraph/ai-onboarding/apis';
import type {
  AuthAccountInfo,
  AuthService,
} from '@notesgraph/core/modules/cloud';
import type { GlobalDialogService } from '@notesgraph/core/modules/dialogs';
