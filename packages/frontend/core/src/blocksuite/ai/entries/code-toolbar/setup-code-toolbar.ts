...
import type { NotesGraphCodeToolbarWidget } from '@blocksuite/notesgraph/blocks/code';
import { BlockSelection } from '@blocksuite/notesgraph/std';

import { buildAICodeItemGroups } from '../../_common/config';
import type { AskAIButtonOptions } from '../../components/ask-ai-button';

export function setupCodeToolbarAIEntry(
  codeToolbar: NotesGraphCodeToolbarWidget
) {
