...
import { IS_MAC } from '@blocksuite/notesgraph/global/env';
import {
  Bound,
  getCommonBoundWithRotation,
} from '@blocksuite/notesgraph/global/gfx';
import type { PointerEventState } from '@blocksuite/notesgraph/std';
import {
  BaseTool,
  type GfxModel,
  MouseButton,
} from '@blocksuite/notesgraph/std/gfx';
import { on } from '@blocksuite/notesgraph-shared/utils';
