...
export function buildErrorResponseConfig(panel: NotesGraphAIPanelWidget) {
  return [
    {
      name: '',
      items: [
...
export function buildErrorConfig(panel: NotesGraphAIPanelWidget) {
  return {
    upgrade: () => {
...
export function buildCopyConfig(panel: NotesGraphAIPanelWidget) {
  return {
    allowed: true,
    onCopy: () => {
