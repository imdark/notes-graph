...
import { Tooltip } from '@blocksuite/notesgraph/components/tooltip';
import { WithDisposable } from '@blocksuite/notesgraph/global/lit';
import { noop } from '@blocksuite/notesgraph/global/utils';
import { unsafeCSSVarV2 } from '@blocksuite/notesgraph/shared/theme';
import { createButtonPopper } from '@blocksuite/notesgraph/shared/utils';
import type {
  BlockSelection,
  EditorHost,
  TextSelection,
        ...
        ${content
          ? html`<div
            ...
            >
              ...
              <notesgraph-tooltip>Copy</notesgraph-tooltip>
            </div>`
          : nothing}
        ${isLast
          ? html`<div
            ...
            >
              ...
              <notesgraph-tooltip .autoShift=${true}>Retry</notesgraph-tooltip>
            </div>`
          : nothing}
        ${showMoreIcon && host
          ? html`<div
