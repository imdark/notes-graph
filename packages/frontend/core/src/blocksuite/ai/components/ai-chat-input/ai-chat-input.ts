...
import track, { type EventArgs } from '@notesgraph/track';
...
export class AIChatInput extends SignalWatcher(
  ...
  static override styles = css`
    ...
    .chat-panel-input {
      ...
      --input-border-color: var(--notesgraph-v2-layer-insideBorder-border);
      ...
      background-color: var(--notesgraph-v2-input-background);
    ...
    .chat-panel-input {
      ...
      textarea::placeholder {
        ...
        font-weight: 400;
        font-family: var(--notesgraph-font-family);
        color: var(--notesgraph-v2-text-placeholder);
      }
    ...
    .chat-panel-input[data-if-focused='true'] {
      ...
      --input-border-color: var(
        --notesgraph-v2-layer-insideBorder-primaryBorder
      );
      user-select: none;
    }
    ...
    .chat-panel-input-drop-overlay {
      ...
      background-color: color-mix(
        in srgb,
        var(--notesgraph-v2-layer-background-primary) 92%,
        transparent
      );
      z-index: 1;
    }
    ...
    .chat-panel-send {
      ...
      border-radius: 50%;
      font-size: 20px;
      background: var(--notesgraph-v2-icon-activated);
      color: var(--notesgraph-v2-layer-pureWhite);
      border: none;
      padding: 0;
      cursor: pointer;
    }
    .chat-panel-send[aria-disabled='true'] {
      cursor: not-allowed;
      background: var(--notesgraph-v2-button-disable);
    }
    .chat-panel-stop {
      cursor: pointer;
      width: 28px;
      ...
      border-radius: 50%;
      font-size: 24px;
      color: var(--notesgraph-v2-icon-activated);
      border: none;
      padding: 0;
  ...
  send = async (text: string) => {
    ...
    const enableSendDetailedObject =
      this.notesgraphFeatureFlagService.flags.enable_send_detailed_object_to_ai
        .value;
