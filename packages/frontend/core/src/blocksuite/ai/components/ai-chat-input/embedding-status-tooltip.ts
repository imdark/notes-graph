import { SignalWatcher } from '@blocksuite/notesgraph/global/lit';
...
export class AIChatEmbeddingStatusTooltip extends SignalWatcher(LitElement) {
  static override styles = css`
    ...
    .check-status:hover {
      background-color: ${unsafeCSSVar('--notesgraph-hover-color')};
    }
  `;
  ...
  private readonly _handleCheckStatusClick = debounce(
    () => {
      this.notesgraphWorkspaceDialogService.open('setting', {
