...
export class ImagePreviewGrid extends LitElement {
  static override styles = css`
    ...
    .image-container {
      ...
      align-items: center;
      flex: 0 0 auto;
      border: 1px solid var(--notesgraph-v2-layer-insideBorder-border);
    ...
    .close-wrapper {
      ...
      height: 16px;
      border-radius: 4px;
      border: 0.5px solid var(--notesgraph-v2-layer-insideBorder-border);
      justify-content: center;
      align-items: center;
      display: none;
      position: absolute;
      background-color: var(--notesgraph-v2-layer-background-primary);
      color: var(--notesgraph-v2-icon-primary);
      z-index: 1;
      cursor: pointer;
      top: -6px;
      right: -6px;
    ...
    .close-wrapper:hover {
      background-color: var(--notesgraph-v2-layer-background-error);
      border: 0.5px solid var(--notesgraph-v2-button-error);
      color: var(--notesgraph-v2-button-error);
    }
  `;
