...
import { type EditorHost, ShadowlessElement } from '@blocksuite/notesgraph/std';
...
import type { AIDraftState } from '@notesgraph/core/modules/ai-button/services/ai-draft';
...
import type { PeekViewService } from '@notesgraph/core/modules/peek-view';
import type { AppThemeService } from '@notesgraph/core/modules/theme';
...
export class AIChatContent extends SignalWatcher(
  ...
  @property({ attribute: false })
  accessor notesgraphThemeService!: AppThemeService;
  ...
  override render() {
    const left = html` <ai-chat-messages
        ...
        .notesgraphThemeService=${this.notesgraphThemeService}
