import { BlockComponent, BlockViewExtension } from '@blocksuite/notesgraph/std';
import type { ExtensionType } from '@blocksuite/notesgraph/store';
import type { TranscriptionBlockModel } from '@notesgraph/core/blocksuite/ai/blocks/transcription-block/model';
...
export const AITranscriptionBlockSpec: ExtensionType[] = [
  BlockViewExtension('notesgraph:transcription', () => {
