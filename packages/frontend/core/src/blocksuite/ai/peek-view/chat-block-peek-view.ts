...
import { ConnectorMode } from '@blocksuite/notesgraph/model';
import {
  DocModeProvider,
...
import type { AIModelService } from '@notesgraph/core/modules/ai-button/services/models';
import type {
  ServerService,
  SubscriptionService,
} from '@notesgraph/core/modules/cloud';
import type { WorkspaceDialogService } from '@notesgraph/core/modules/dialogs';
...
export class AIChatBlockPeekView extends LitElement {
  ...
  private readonly _createForkChatBlock = async () => {
    ...
    const surfaceBlock = store
      .getAllModels()
      .find(block => block.flavour === 'notesgraph:surface');
    if (!surfaceBlock) {
      return;
    }
  ...
  override render() {
    ...
    return html`<div class="ai-chat-block-peek-view-container">
      ...
      <ai-chat-composer
        ...
        .notesgraphWorkspaceDialogService=${this
  ...
  @property({ attribute: false })
  accessor notesgraphWorkspaceDialogService!: WorkspaceDialogService;
...
export const AIChatBlockPeekViewTemplate = (
  ...
  notesgraphWorkspaceDialogService: WorkspaceDialogService,
  ...
  return html`<ai-chat-block-peek-view
    ...
    .serverService=${serverService}
    .notesgraphFeatureFlagService=${notesgraphFeatureFlagService}
    .notesgraphWorkspaceDialogService=${notesgraphWorkspaceDialogService}
    .aiDraftService=${aiDraftService}
    .aiToolsConfigService=${aiToolsConfigService}
    .subscriptionService=${subscriptionService}
    .aiModelService=${aiModelService}
