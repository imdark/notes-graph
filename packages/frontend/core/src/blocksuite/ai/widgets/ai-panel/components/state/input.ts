...
import { AIStarIcon } from '@blocksuite/notesgraph/components/icons';
import {
  SignalWatcher,
  WithDisposable,
...
import { stopPropagation } from '@blocksuite/notesgraph/shared/utils';
import {
  darkCssVariablesV2,
  lightCssVariablesV2,
...
export class AIPanelInput extends SignalWatcher(WithDisposable(LitElement)) {
  static override styles = css`
    ...
    :host([data-app-theme='light']) {
      .network svg {
        color: ${unsafeCSS(
          lightCssVariablesV2['--notesgraph-v2-icon-primary']
        )};
      }

      .network[data-active='true'] svg {
        color: ${unsafeCSS(
          lightCssVariablesV2['--notesgraph-v2-icon-activated']
        )};
      }
      ...
      textarea::placeholder {
        color: ${unsafeCSS(
          lightCssVariablesV2['--notesgraph-v2-text-placeholder']
        )};
      }
      ...
      .arrow {
        background: ${unsafeCSS(
          lightCssVariablesV2['--notesgraph-v2-icon-disable']
        )};
      }
      ...
      .arrow svg {
        color: ${unsafeCSS(
          lightCssVariablesV2['--notesgraph-v2-pure-white-text']
        )};
      }
    }
    ...
    :host([data-app-theme='dark']) {
      ...
      .network[data-active='true'] svg {
        color: ${unsafeCSS(
          darkCssVariablesV2['--notesgraph-v2-icon-activated']
        )};
      }
      ...
      textarea::placeholder {
        color: ${unsafeCSS(
          darkCssVariablesV2['--notesgraph-v2-text-placeholder']
        )};
      }
      ...
      .arrow {
        background: ${unsafeCSS(
          darkCssVariablesV2['--notesgraph-v2-icon-disable']
        )};
      }
      ...
      .arrow svg {
        color: ${unsafeCSS(
          darkCssVariablesV2['--notesgraph-v2-pure-white-text']
        )};
      }
    }
  `;
    ...
    return html`<div class="root">
      ...
      <div class="textarea-container">
        ...
        >
          ${SendIcon()}
          ${this._hasContent
            ? html`<notesgraph-tooltip .offsetY=${12}
                >Send to AI</notesgraph-tooltip
              >`
            : nothing}
        </div>
      </div>
