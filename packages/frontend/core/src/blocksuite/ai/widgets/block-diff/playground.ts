...
export const NOTESGRAPH_BLOCK_DIFF_PLAYGROUND =
  'notesgraph-block-diff-playground';
export const NOTESGRAPH_BLOCK_DIFF_PLAYGROUND_MODAL =
  'notesgraph-block-diff-playground-modal';
...
export const blockDiffPlayground = WidgetViewExtension(
  ...
  literal`${unsafeStatic(NOTESGRAPH_BLOCK_DIFF_PLAYGROUND)}`
);
