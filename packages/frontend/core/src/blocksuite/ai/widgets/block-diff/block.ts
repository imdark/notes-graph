...
export const NOTESGRAPH_BLOCK_DIFF_WIDGET_FOR_BLOCK =
  'notesgraph-block-diff-widget-for-block';

export class NotesGraphBlockDiffWidgetForBlock extends WidgetComponent {
...
export const blockDiffWidgetForBlock = WidgetViewExtension(
  ...
  literal`${unsafeStatic(NOTESGRAPH_BLOCK_DIFF_WIDGET_FOR_BLOCK)}`
);
