...
import { EmbedSyncedDocBlockComponent } from '@blocksuite/notesgraph/blocks/embed-doc';
import { isPeekable, peek } from '@blocksuite/notesgraph/components/peek';
import type { EmbedSyncedDocModel } from '@blocksuite/notesgraph-model';
import type { BlockStdScope } from '@blocksuite/std';
import { Button, IconButton, Menu, MenuItem } from '@notesgraph/component';
...
import { stopPropagation } from '@notesgraph/core/utils';
...
const ToggleButton = ({ model }: { model: EmbedSyncedDocModel }) => {
  ...
  return (
    <IconButton
      ...
      tooltip={
        isFolded
          ? t['com.notesgraph.editor.edgeless-embed-synced-doc-header.unfold']()
          : t['com.notesgraph.editor.edgeless-embed-synced-doc-header.fold']()
      }
    ...
    <div>
      ...
      >
        <span className={styles.buttonText}>
          {t['com.notesgraph.editor.edgeless-embed-synced-doc-header.open']()}
        </span>
      </Button>
    ...
    return [
      {
        ...
        label: t['com.notesgraph.peek-view-controls.open-doc'](),
        icon: <ExpandFullIcon />,
        onClick: () => {
      ...
      },
      {
        ...
        label: t['com.notesgraph.peek-view-controls.open-doc-in-center-peek'](),
        icon: <CenterPeekIcon />,
        onClick: () => {
      ...
      },
      {
        ...
        label: t['com.notesgraph.peek-view-controls.open-doc-in-split-view'](),
        icon: <SplitViewIcon />,
        onClick: () => {
      ...
      },
      {
        ...
        label: t['com.notesgraph.peek-view-controls.open-doc-in-new-tab'](),
        icon: <OpenInNewIcon />,
        onClick: () => {
          workbench.openDoc(model.props.pageId, {
            at: 'new-tab',
