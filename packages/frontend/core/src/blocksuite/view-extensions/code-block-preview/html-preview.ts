import { CodeBlockPreviewExtension } from '@blocksuite/notesgraph/blocks/code';
import {
  SignalWatcher,
  WithDisposable,
...
export const CodeBlockHtmlPreview = CodeBlockPreviewExtension(
  'html',
  model =>
    html`<notesgraph-html-preview .model=${model}></notesgraph-html-preview>`
);
          ...
          [
            ...
            () =>
              html`<div class="html-preview-fallback">
                ...
                the NotesGraph Desktop App to use it.
              </div>`,
          ],
        ])}
        <iframe
...
export function effects() {
  customElements.define('notesgraph-html-preview', HTMLPreview);
}

declare global {
  interface HTMLElementTagNameMap {
    'notesgraph-html-preview': HTMLPreview;
  }
}
