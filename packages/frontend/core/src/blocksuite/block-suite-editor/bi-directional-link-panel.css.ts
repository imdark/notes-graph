...
export const container = style({
  ...
  fontSize: cssVar('--notesgraph-font-base'),
  '@container': {
...
export const title = style({
  ...
  fontSize: '15px',
  lineHeight: '24px',
  color: cssVar('--notesgraph-text-primary-color'),
});

export const showButton = style({
  height: '28px',
  borderRadius: '8px',
  border: '1px solid ' + cssVar('--notesgraph-border-color'),
...
export const linksTitles = style({
  color: cssVar('--notesgraph-text-secondary-color'),
  height: '32px',
  lineHeight: '32px',
});
...
globalStyle(`${link} .notesgraph-reference-title`, {
  borderBottom: 'none',
});
