...
} from '@notesgraph/core/blocksuite/view-extensions/editor-view/reference-renderer';
...
import {
  ...
  DocLinksService,
  type Link,
} from '@notesgraph/core/modules/doc-link';
import { toDocSearchParams } from '@notesgraph/core/modules/navigation/utils';
import { GlobalSessionStateService } from '@notesgraph/core/modules/storage';
...
} from '../../components/notesgraph/reference-link';
...
const usePreviewExtensions = () => {
  ...
  const referenceRenderer: ReferenceReactRenderer = useMemo(() => {
    return function customReference(reference) {
      ...
      return <NotesGraphPageReference pageId={pageId} params={params} />;
    };
  }, [workspaceService]);
  ...
  return (
    <div className={styles.linksContainer} ref={containerRef}>
      <div className={styles.linksTitles}>
        {t['com.notesgraph.page-properties.backlinks']()}{' '}
  ...
  return (
    <div className={styles.linkPreviewContainer}>
      {linkGroup.links.map(link => {
        ...
        if (
          link.parentFlavour === 'notesgraph:database' &&
          link.parentBlockId
        ) {
          // if parentBlockFlavour is 'notesgraph:database',
    ...
    <div className={styles.container}>
      ...
      <div className={styles.titleLine}>
        ...
        <Button className={styles.showButton} onClick={handleClickShow}>
          {show
            ? t['com.notesgraph.editor.bi-directional-link-panel.hide']()
            : t['com.notesgraph.editor.bi-directional-link-panel.show']()}
        </Button>
      </div>
      ...
      {show && (
        <>
          ...
          <div className={styles.linksContainer}>
            <div className={styles.linksTitles}>
              {t['com.notesgraph.page-properties.outgoing-links']()} ·{' '}
              {links.length}
            </div>
            {links.map((link, i) => (
              <div
