...
import { DocRole, WorkspaceMemberStatus } from '@notesgraph/graphql';
  ...
  return (
    <div className={styles.containerStyle}>
      <div className={styles.headerStyle} onClick={onClickCancel}>
        ...
        {t['com.notesgraph.share-menu.invite-editor.header']()}
      </div>
            ...
            <RowInput
              ...
              placeholder={
                selectedMembers.length
                  ? ''
                  : t['com.notesgraph.share-menu.invite-editor.placeholder']()
              }
            />
          </div>
      ...
      <div className={styles.footerStyle}>
        ...
        >
          {t['com.notesgraph.share-menu.invite-editor.manage-members']()}
        </span>
        <div className={styles.buttonsContainer}>
          ...
          <Button
            ...
            onClick={onInvite}
          >
            {t['com.notesgraph.share-menu.invite-editor.invite']()}
          </Button>
        </div>
      </div>
    </div>
  ...
  if (!activeMembers || activeMembers.length === 0) {
    ...
    return (
      <div className={styles.noFound}>
        {t['com.notesgraph.share-menu.invite-editor.no-found']()}
      </div>
    );
  }
      ...
      <Menu
        ...
        items={
          <>
            ...
            >
              {t['com.notesgraph.share-menu.option.permission.can-manage']()}
            </MenuItem>
            <MenuItem
            ...
            >
              <div className={styles.planTagContainer}>
                {t['com.notesgraph.share-menu.option.permission.can-edit']()}
            ...
            >
              <div className={styles.planTagContainer}>
                {t['com.notesgraph.share-menu.option.permission.can-read']()}
                {hittingPaywall ? <PlanTag /> : null}
              </div>
            </MenuItem>
          </>
