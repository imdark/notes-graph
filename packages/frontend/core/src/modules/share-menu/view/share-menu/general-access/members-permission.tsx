...
import { DocGrantedUsersService } from '@notesgraph/core/modules/permissions';
import { ShareInfoService } from '@notesgraph/core/modules/share-doc';
import { UserFriendlyError } from '@notesgraph/error';
import { DocRole } from '@notesgraph/graphql';
...
const getRoleName = (t: ReturnType<typeof useI18n>, role?: DocRole) => {
  switch (role) {
    case DocRole.Manager:
      return t['com.notesgraph.share-menu.option.permission.can-manage']();
    case DocRole.Editor:
      return t['com.notesgraph.share-menu.option.permission.can-edit']();
    case DocRole.Reader:
      return t['com.notesgraph.share-menu.option.permission.can-read']();
    case DocRole.None:
      return t['com.notesgraph.share-menu.option.permission.no-access']();
    default:
      return '';
  }
};
  ...
  return (
    <div className={styles.rowContainerStyle}>
      <div className={styles.labelStyle}>
        {t['com.notesgraph.share-menu.option.permission.label']()}
      </div>
      {disabled ? (
            ...
            <>
              ...
              >
                <div className={styles.publicItemRowStyle}>
                  {t[
                    'com.notesgraph.share-menu.option.permission.can-manage'
                  ]()}
                </div>
              </MenuItem>
              <MenuItem
              ...
              >
                <div className={styles.publicItemRowStyle}>
                  <div className={styles.tagContainerStyle}>
                    {t[
                      'com.notesgraph.share-menu.option.permission.can-edit'
                    ]()}
              ...
              >
                <div className={styles.publicItemRowStyle}>
                  <div className={styles.tagContainerStyle}>
                    {t[
                      'com.notesgraph.share-menu.option.permission.can-read'
                    ]()}
                    {hittingPaywall ? <PlanTag /> : null}
                  </div>
                </div>
              ...
              >
                <div className={styles.publicItemRowStyle}>
                  <div className={styles.tagContainerStyle}>
                    {t[
                      'com.notesgraph.share-menu.option.permission.no-access'
                    ]()}
                    {hittingPaywall ? <PlanTag /> : null}
                  </div>
                </div>
...
export const Tips = ({ disable }: { disable?: boolean }) => {
  ...
  return (
    <Tooltip content={t['com.notesgraph.share-menu.option.permission.tips']()}>
      <InformationIcon
