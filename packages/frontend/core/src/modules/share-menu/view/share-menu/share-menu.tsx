...
import { Tabs, Tooltip, useConfirmModal } from '@notesgraph/component';
...
export const ShareMenuContent = (props: ShareMenuProps) => {
  ...
  const openPaywallModal = useCallback(() => {
    openConfirmModal({
      title:
        t[
          `com.notesgraph.share-menu.paywall.${isOwner ? 'owner' : 'member'}.title`
        ](),
      description:
        t[
          `com.notesgraph.share-menu.paywall.${isOwner ? 'owner' : 'member'}.description`
        ](),
      confirmText:
        t[
          `com.notesgraph.share-menu.paywall.${isOwner ? 'owner' : 'member'}.confirm`
        ](),
      onConfirm: onConfirm,
      cancelText: t['Cancel'](),
      cancelButtonOptions: {
...
const DefaultShareButton = forwardRef(function DefaultShareButton(
  ...
  const tooltip =
    props.tooltip ??
    (shared
      ? t['com.notesgraph.share-menu.option.link.readonly.description']()
      : t['com.notesgraph.share-menu.option.link.no-access.description']());
