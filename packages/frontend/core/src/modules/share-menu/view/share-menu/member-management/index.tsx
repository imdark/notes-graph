...
import { Avatar, Skeleton, Tooltip } from '@notesgraph/component';
...
export const MembersRow = ({ onClick }: { onClick: () => void }) => {
  ...
  const description = useMemo(() => {
    ...
    switch (grantedUserCount) {
      case 2:
        return t['com.notesgraph.share-menu.member-management.member-count-2']({
          member1: topThreeMembers[0].name,
          member2: topThreeMembers[1].name,
        });
      case 3:
        return t['com.notesgraph.share-menu.member-management.member-count-3']({
          member1: topThreeMembers[0].name,
          member2: topThreeMembers[1].name,
      ...
      default:
        return t[
          'com.notesgraph.share-menu.member-management.member-count-more'
        ]({
          member1: topThreeMembers[0].name,
          member2: topThreeMembers[1].name,
