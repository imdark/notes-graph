...
import { DocModeRegistryService } from '../doc-mode-registry';
...
import { VirtualViewsService } from '../virtual-views';
...
import { VirtualItemsQuickSearchSession } from './impls/virtual-items';
...
export function configureQuickSearchModule(framework: Framework) {
  framework
    ...
    .entity(CreationQuickSearchSession, [DocModeRegistryService])
    ...
    .entity(VirtualItemsQuickSearchSession, [VirtualViewsService]);
}
