...
import { IconButton, notify } from '@notesgraph/component';
...
export const DefaultPeekViewControls = ({
  ...
  const controls = useMemo(() => {
    return [
      {
        nameKey: 'close',
        name: t['com.notesgraph.peek-view-controls.close'](),
        icon: <CloseIcon />,
...
export const DocPeekViewControls = ({
  ...
  const controls = useMemo(() => {
    return [
      ...
      {
        nameKey: 'open',
        name: t['com.notesgraph.peek-view-controls.open-doc'](),
        icon: <ExpandFullIcon />,
        onClick: () => {
      ...
      {
        nameKey: 'new-tab',
        name: t['com.notesgraph.peek-view-controls.open-doc-in-new-tab'](),
        icon: <OpenInNewIcon />,
        onClick: () => {
      ...
      {
        nameKey: 'split-view',
        name: t['com.notesgraph.peek-view-controls.open-doc-in-split-view'](),
        icon: <SplitViewIcon />,
        onClick: () => {
      ...
      {
        nameKey: 'copy-link',
        name: t['com.notesgraph.peek-view-controls.copy-link'](),
        icon: <LinkIcon />,
        onClick: async () => {
      ...
      {
        nameKey: 'info',
        name: t['com.notesgraph.peek-view-controls.open-info'](),
...
export const AttachmentPeekViewControls = ({
  ...
  const controls = useMemo(() => {
    ...
    return [
      ...
      {
        nameKey: 'open',
        name: t['com.notesgraph.peek-view-controls.open-attachment'](),
        icon: <ExpandFullIcon />,
        onClick: () => {
      ...
      },
      {
        nameKey: 'new-tab',
        name: t[
          'com.notesgraph.peek-view-controls.open-attachment-in-new-tab'
        ](),
        icon: <OpenInNewIcon />,
        onClick: () => {
      ...
      },
      {
        nameKey: 'split-view',
        name: t[
          'com.notesgraph.peek-view-controls.open-attachment-in-split-view'
        ](),
        icon: <SplitViewIcon />,
        onClick: () => {
