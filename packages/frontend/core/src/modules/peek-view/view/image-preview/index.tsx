...
import type { BlockModel, Workspace } from '@blocksuite/notesgraph/store';
import { Divider, Loading, toast } from '@notesgraph/component';
...
const filterImageBlock = (block: BlockModel): block is ImageBlockModel => {
  return block.flavour === 'notesgraph:image';
};
