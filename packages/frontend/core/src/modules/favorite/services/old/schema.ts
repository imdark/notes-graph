...
const WorkspaceNotesGraphPropertiesSchemaSchema = z.object({
...
export const WorkspaceNotesGraphPropertiesSchema = z.object({
  schema: WorkspaceNotesGraphPropertiesSchemaSchema.optional(),
...
export type WorkspaceNotesGraphProperties = z.infer<
  typeof WorkspaceNotesGraphPropertiesSchema
>;
...
export type WorkspaceNotesGraphPageProperties = z.infer<
