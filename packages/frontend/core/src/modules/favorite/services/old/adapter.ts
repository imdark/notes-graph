...
import { createYProxy } from '@blocksuite/notesgraph/store';
import type { WorkspaceService } from '@notesgraph/core/modules/workspace';
...
import {
  ...
  type WorkspaceNotesGraphProperties,
} from './schema';

const NOTESGRAPH_PROPERTIES_ID = 'notesgraph:workspace-properties';
...
class WorkspacePropertiesAdapter {
  ...
  public readonly proxy: WorkspaceNotesGraphProperties;
  public readonly properties: Y.Map<any>;
  public readonly properties$: LiveData<WorkspaceNotesGraphProperties>;
  ...
  constructor(public readonly workspaceService: WorkspaceService) {
    ...
    this.properties = rootDoc.getMap(NOTESGRAPH_PROPERTIES_ID);
