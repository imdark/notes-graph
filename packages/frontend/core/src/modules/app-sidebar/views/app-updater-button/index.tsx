    ...
    <div className={styles.updateAvailableWrapper}>
      <div className={styles.installLabelNormal}>
        ...
        <span className={styles.ellipsisTextOverflow}>
          {t['com.notesgraph.appUpdater.downloadUpdate']()}
        </span>
  ...
  return (
    <div className={styles.updateAvailableWrapper}>
      <div className={styles.installLabelNormal}>
        ...
        <span className={styles.ellipsisTextOverflow}>
          {t['com.notesgraph.appUpdater.updateAvailable']()}
        </span>
        <span className={styles.versionLabel}>{updateAvailable?.version}</span>
      </div>
      ...
      <div className={styles.installLabelHover}>
        ...
        <span className={styles.ellipsisTextOverflow}>
          {t[
            appQuitting ? 'Loading' : 'com.notesgraph.appUpdater.installUpdate'
          ]()}
        </span>
      </div>
    </div>
  ...
  return (
    <div className={clsx([styles.updateAvailableWrapper])}>
      <div className={clsx([styles.installLabelNormal])}>
        <span className={styles.ellipsisTextOverflow}>
          {t['com.notesgraph.appUpdater.downloading']()}
        </span>
        <span className={styles.versionLabel}>{updateAvailable?.version}</span>
      </div>
  ...
  return (
    <>
      ...
      <div className={styles.installLabelHover}>
        <DownloadIcon className={styles.icon} />
        <span className={styles.ellipsisTextOverflow}>
          {t['com.notesgraph.appUpdater.openDownloadPage']()}
        </span>
      </div>
    </>
  );
  ...
  return (
    <>
      <div className={clsx([styles.whatsNewLabel])}>
        ...
        <span className={styles.ellipsisTextOverflow}>
          {t['com.notesgraph.appUpdater.whatsNew']()}
        </span>
      </div>
    ...
    if (updateReady) {
      ...
      if (updateAvailable.allowAutoUpdate) {
        ...
        urlService.openPopupWindow(
          `https://github.com/notesgraph/notesgraph/releases/tag/v${updateAvailable.version}`
        );
      }
