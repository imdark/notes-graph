...
import { Button, Checkbox, IconButton } from '@notesgraph/component';
import {
  OpenInAppService,
  OpenLinkMode,
} from '@notesgraph/core/modules/open-in-app';
    ...
    >
      ...
      <div className={styles.contentCol}>
        <div className={styles.titleRow}>
          {t.t('com.notesgraph.open-in-app.card.title')}
        ...
        <div className={styles.subtitleRow}>
          <Trans i18nKey="com.notesgraph.open-in-app.card.subtitle">
            Don&apos;t have the app?
            <a
              href="https://notesgraph.com/download"
              target="_blank"
              rel="noreferrer"
        ...
        <div className={styles.controlsRow}>
          <label className={styles.rememberLabel}>
            ...
            />
            {t.t('com.notesgraph.open-in-app.card.remember')}
          </label>
          <div className={styles.spacer} />
          <div className={styles.buttonGroup}>
            <Button
              ...
              onClick={onDismiss}
            >
              {t.t('com.notesgraph.open-in-app.card.button.dismiss')}
            </Button>
            <Button
              variant="primary"
              size="custom"
              ...
              onClick={onOpen}
            >
              {t.t('com.notesgraph.open-in-app.card.button.open')}
            </Button>
          </div>
        </div>
      </div>
