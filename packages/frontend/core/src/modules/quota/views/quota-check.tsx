...
import { type I18nString, useI18n } from '@notesgraph/i18n';
...
> = {
  owner: {
    both: {
      title: 'com.notesgraph.payment.sync-paused.title',
      description: 'com.notesgraph.payment.sync-paused.owner.both.description',
      tips: [
        'com.notesgraph.payment.sync-paused.owner.both.tips-1',
        'com.notesgraph.payment.sync-paused.owner.both.tips-2',
      ],
      cancelText: 'Cancel',
      confirmText: 'com.notesgraph.payment.upgrade',
    },
    storage: {
      title: 'com.notesgraph.payment.sync-paused.title',
      description:
        'com.notesgraph.payment.sync-paused.owner.storage.description',
      tips: [
        'com.notesgraph.payment.sync-paused.owner.storage.tips-1',
        'com.notesgraph.payment.sync-paused.owner.storage.tips-2',
      ],
      cancelText: 'Cancel',
      confirmText: 'com.notesgraph.payment.upgrade',
    },
    member: {
      title: 'com.notesgraph.payment.sync-paused.title',
      description:
        'com.notesgraph.payment.sync-paused.owner.member.description',
      tips: [
        'com.notesgraph.payment.sync-paused.owner.member.tips-1',
        'com.notesgraph.payment.sync-paused.owner.member.tips-2',
      ],
      cancelText: 'Cancel',
      confirmText: 'com.notesgraph.payment.upgrade',
    },
  ...
  member: {
    both: {
      title: 'com.notesgraph.payment.sync-paused.title',
      description: 'com.notesgraph.payment.sync-paused.member.both.description',
      confirmText: 'com.notesgraph.payment.sync-paused.member.member.confirm',
    },
    storage: {
      title: 'com.notesgraph.payment.sync-paused.title',
      description:
        'com.notesgraph.payment.sync-paused.member.storage.description',
      confirmText: 'com.notesgraph.payment.sync-paused.member.member.confirm',
    },
    member: {
      title: 'com.notesgraph.payment.sync-paused.title',
      description:
        'com.notesgraph.payment.sync-paused.member.member.description',
      confirmText: 'com.notesgraph.payment.sync-paused.member.member.confirm',
    },
  },
};
