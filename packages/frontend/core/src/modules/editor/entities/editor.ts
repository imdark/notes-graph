...
import { findCommentedTexts } from '@blocksuite/notesgraph/inlines/comment';
import type { DocMode, ReferenceParams } from '@blocksuite/notesgraph/model';
import { HighlightSelection } from '@blocksuite/notesgraph/shared/selection';
import {
  DocModeProvider,
  findCommentedBlocks,
...
export class Editor extends Entity {
  ...
  readonly editorContainer$ = new LiveData<NotesGraphEditorContainer | null>(
    null
  );
