...
beforeEach(() => {
  vi.stubGlobal('location', { origin: 'http://notesgraph.com' });
});
...
const testCases: [string, ReturnType<typeof resolveLinkToDoc>][] = [
  ...
  [
    'http://notesgraph.com/workspace/48__RTCSwASvWZxyAk3Jw/-Uge-K6SYcAbcNYfQ5U-j?blockIds=xxxx',
    {
      workspaceId: '48__RTCSwASvWZxyAk3Jw',
      docId: '-Uge-K6SYcAbcNYfQ5U-j',
      blockIds: ['xxxx'],
  ...
  ['http://notesgraph.com/workspace/48__RTCSwASvWZxyAk3Jw/all', null],
  ['http://notesgraph.com/workspace/48__RTCSwASvWZxyAk3Jw/collection', null],
  ['http://notesgraph.com/workspace/48__RTCSwASvWZxyAk3Jw/tag', null],
  ['http://notesgraph.com/workspace/48__RTCSwASvWZxyAk3Jw/trash', null],
  [
