...
import type { TagMeta } from '@notesgraph/core/components/page-list';
...
export class SearchMenuService extends Service {
  ...
  private getRecentDocMenuGroup(action: SearchDocMenuAction): LinkedMenuGroup {
    ...
    return {
      name: I18n.t('com.notesgraph.editor.at-menu.recent-docs'),
      items: recentDocs
        .map(doc => {
  ...
  private getSearchDocMenuGroup(
    ...
    const overflowText = computed(() => {
      ...
      return I18n.t('com.notesgraph.editor.at-menu.more-docs-hint', {
    ...
    return {
      name: I18n.t('com.notesgraph.editor.at-menu.link-to-doc', {
        query,
      }),
      loading: loading,
      items: docsSignal,
  ...
  getTagMenuGroup(
    ...
    if (query.trim().length === 0) {
      return {
        name: I18n.t('com.notesgraph.editor.at-menu.tags', {
          query,
        }),
  ...
  getCollectionMenuGroup(
    ...
    if (query.trim().length === 0) {
      return {
        name: I18n.t('com.notesgraph.editor.at-menu.collections', {
          query,
        }),
