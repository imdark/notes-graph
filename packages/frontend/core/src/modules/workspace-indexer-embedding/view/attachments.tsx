...
import { getAttachmentFileIconRC } from '@blocksuite/notesgraph/components/icons';
import { cssVarV2 } from '@blocksuite/notesgraph/shared/theme';
import { Loading, Tooltip, useConfirmModal } from '@notesgraph/component';
...
const AttachmentItem: React.FC<AttachmentItemProps> = ({
  ...
  const handleDelete = useCallback(() => {
    ...
    openConfirmModal({
      title:
        t[
          'com.notesgraph.settings.workspace.indexer-embedding.embedding.additional-attachments.remove-attachment.title'
        ](),
      description:
        t[
          'com.notesgraph.settings.workspace.indexer-embedding.embedding.additional-attachments.remove-attachment.description'
        ](),
    ...
    >
      ...
      {!disabled && (
        <div className={attachmentOperation}>
          <Tooltip
            content={t[
              'com.notesgraph.settings.workspace.indexer-embedding.embedding.additional-attachments.remove-attachment.tooltip'
            ]()}
          >
            <CloseIcon
