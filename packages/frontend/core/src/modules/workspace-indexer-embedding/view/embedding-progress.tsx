import { Progress } from '@notesgraph/component';
    ...
    <div className={embeddingProgress} data-testid="embedding-progress-wrapper">
      ...
      >
        <div>
          {loading
            ? t[
                'com.notesgraph.settings.workspace.indexer-embedding.embedding.progress.loading-sync-status'
              ]()
            : synced
              ? t[
                  'com.notesgraph.settings.workspace.indexer-embedding.embedding.progress.synced'
                ]()
              : t[
                  'com.notesgraph.settings.workspace.indexer-embedding.embedding.progress.syncing'
                ]()}
        </div>
        {loading ? null : (
