import { Button, notify, Switch, Tooltip } from '@notesgraph/component';
import {
  SettingHeader,
  SettingRow,
  SettingWrapper,
...
import { EnableCloudPanel } from '@notesgraph/core/desktop/dialogs/setting/workspace-setting/preference/enable-cloud';
...
const EmbeddingCloud: React.FC<{ disabled: boolean }> = ({ disabled }) => {
      ...
      embeddingService.embeddingEnabled
        ...
        .catch(error => {
          ...
          notify.error({
            title:
              t[
                'com.notesgraph.settings.workspace.indexer-embedding.embedding.switch.error'
              ](),
      ...
      embeddingService.additionalAttachments
        ...
        .catch(error => {
          ...
          notify.error({
            title:
              t[
                'com.notesgraph.settings.workspace.indexer-embedding.embedding.remove-attachment.error'
              ](),
            message: t[`error.${err.name}`](err.data),
          });
        });
        ...
        embeddingService.ignoredDocs
          ...
          .catch(error => {
            ...
            notify.error({
              title:
                t[
                  'com.notesgraph.settings.workspace.indexer-embedding.embedding.update-ignored-docs.error'
                ](),
              message: t[`error.${err.name}`](err.data),
            });
          });
  ...
  return (
    ...
    >
      <SettingRow
        name={t[
          'com.notesgraph.settings.workspace.indexer-embedding.embedding.switch.title'
        ]()}
        desc={t[
          'com.notesgraph.settings.workspace.indexer-embedding.embedding.switch.description'
        ]()}
      >
        <Switch
      ...
      </SettingRow>
      {
        <>
          <SettingRow
            name={t[
              'com.notesgraph.settings.workspace.indexer-embedding.embedding.progress.title'
            ]()}
      ...
      <SettingRow
        name={t[
          'com.notesgraph.settings.workspace.indexer-embedding.embedding.additional-attachments.title'
        ]()}
        desc={t[
          'com.notesgraph.settings.workspace.indexer-embedding.embedding.additional-attachments.description'
        ]()}
      >
        <Upload fileChange={handleAttachmentUpload}>
          ...
          >
            {t[
              'com.notesgraph.settings.workspace.indexer-embedding.embedding.upload-file'
            ]()}
          </Button>
        </Upload>
      </SettingRow>
      ...
      <SettingRow
        name={t[
          'com.notesgraph.settings.workspace.indexer-embedding.embedding.ignore-docs.title'
        ]()}
        desc={t[
          'com.notesgraph.settings.workspace.indexer-embedding.embedding.ignore-docs.description'
        ]()}
      >
        <Button
        ...
        >
          {t[
            'com.notesgraph.settings.workspace.indexer-embedding.embedding.select-doc'
          ]()}
        </Button>
      </SettingRow>
    ...
    <>
      <Tooltip
        content={
          !isEmbeddingEnabled &&
          t[
            'com.notesgraph.settings.workspace.indexer-embedding.embedding.disabled-tooltip'
          ]()
        }
      >
        <SettingHeader
          ...
          subtitle={t[
            'com.notesgraph.settings.workspace.indexer-embedding.embedding.description'
          ]()}
        />
      </Tooltip>
