...
import type { TranscriptionBlockProps } from '@notesgraph/core/blocksuite/ai/blocks/transcription-block/model';
import { RealtimeLiveQuery } from '@notesgraph/core/modules/cloud/realtime/live-query';
import { DebugLogger } from '@notesgraph/debug';
import { UserFriendlyError } from '@notesgraph/error';
import { AiJobStatus, type TranscriptionResultType } from '@notesgraph/graphql';
import { Entity, LiveData } from '@notesgraph/infra';
import type { RealtimeTopicEventOf } from '@notesgraph/realtime';
