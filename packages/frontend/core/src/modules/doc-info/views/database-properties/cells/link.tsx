...
import { resolveLinkToDoc } from '@notesgraph/core/modules/navigation';
import { useI18n } from '@notesgraph/i18n';
import type { LiveData } from '@notesgraph/infra';
  ...
  const editingElement = (
    <>
      <textarea
        ...
        placeholder={t[
          'com.notesgraph.page-properties.property-value-placeholder'
        ]()}
      />
      <div
        className={
