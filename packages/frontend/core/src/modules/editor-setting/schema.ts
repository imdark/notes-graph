import { GeneralSettingSchema } from '@blocksuite/notesgraph/shared/services';
import { z } from 'zod';
...
export const fontStyleOptions = [
  { key: 'Sans', value: 'var(--notesgraph-font-sans-family)' },
  { key: 'Serif', value: 'var(--notesgraph-font-serif-family)' },
  { key: 'Mono', value: 'var(--notesgraph-font-mono-family)' },
  { key: 'Custom', value: 'var(--notesgraph-font-sans-family)' },
] satisfies {
  key: FontFamily;
  value: string;
}[];

const NotesGraphEditorSettingSchema = z.object({
