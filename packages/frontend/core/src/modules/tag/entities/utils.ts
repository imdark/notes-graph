...
// map var(--notesgraph-tag-xxx) colors to var(--notesgraph-chip-label-xxx)
...
// hack: map var(--notesgraph-tag-xxx)/var(--notesgraph-chip-label-xxx) colors to var(--notesgraph-palette-line-xxx)
export const databaseTagColorToNotesGraphLabel = (color: string) => {
...
export const notesgraphLabelToDatabaseTagColor = (color: string) => {
