import type { DNDData } from '@notesgraph/component';

export type NotesGraphDNDEntity =
  | {
      type: 'doc';
      id: string;
    }
...
export interface NotesGraphDNDData extends DNDData {
  draggable: {
    entity?: NotesGraphDNDEntity;
    from?:
      | {
