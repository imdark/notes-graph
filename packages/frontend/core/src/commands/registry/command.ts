...
export interface NotesGraphCommandOptions {
  id: string;
...
export interface NotesGraphCommand {
  readonly id: string;
...
export function createNotesGraphCommand(
  options: NotesGraphCommandOptions
): NotesGraphCommand {
  return {
    id: options.id,
    run: options.run,
    ...
    category: options.category ?? 'notesgraph:general',
    get label() {
