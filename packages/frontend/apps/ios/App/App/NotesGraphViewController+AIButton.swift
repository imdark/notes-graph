//
//  NotesGraphViewController+AIButton.swift
//  App
//
...
extension NotesGraphViewController: IntelligentsButtonDelegate {
  private static let aiConsentKey = "com.notesgraph.intelligents.userConsented"
