...
class MainHeaderView: UIView {
  ...
  private lazy var closeButton = UIButton(type: .system).then {
    ...
    $0.setImage(UIImage.notesgraphClose, for: .normal)
    $0.tintColor = UIColor.notesgraphIconPrimary
    $0.backgroundColor = UIColor.notesgraphLayerBackgroundSecondary
  ...
  private lazy var titleLabel = UILabel().then {
    $0.text = "NotesGraph AI"
    $0.font = .systemFont(ofSize: 16, weight: .medium)
    $0.textColor = UIColor.notesgraphTextPrimary
  ...
  private lazy var dropdownButton = UIButton(type: .system).then {
    $0.imageView?.contentMode = .scaleAspectFit
    $0.setImage(UIImage.notesgraphArrowDown, for: .normal)
    $0.tintColor = UIColor.notesgraphIconPrimary
  ...
  private lazy var menuButton = UIButton(type: .system).then {
    $0.imageView?.contentMode = .scaleAspectFit
    $0.setImage(UIImage.notesgraphMore, for: .normal)
    $0.tintColor = UIColor.notesgraphIconPrimary
    $0.backgroundColor = UIColor.notesgraphLayerBackgroundSecondary
    $0.layer.cornerRadius = 8
    ...
    $0.menu = .init(options: [.displayInline], children: [
      UIAction(title: "Clear History", image: .notesgraphBroom, handler: { _ in
  ...
  init() {
    ...
    backgroundColor = UIColor.notesgraphLayerBackgroundPrimary
