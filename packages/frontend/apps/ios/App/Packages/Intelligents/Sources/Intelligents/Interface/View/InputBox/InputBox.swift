...
class InputBox: UIView {
  ...
  lazy var containerView = UIView().then {
    $0.backgroundColor = UIColor.notesgraphLayerBackgroundPrimary
  ...
  lazy var placeholderLabel = UILabel().then {
    ...
    $0.font = .systemFont(ofSize: 16)
    $0.textColor = UIColor.notesgraphTextPlaceholder
    $0.isHidden = true
  }
  ...
  func updateColors() {
    containerView.layer.borderColor = UIColor.notesgraphLayerBorder.cgColor
  }
