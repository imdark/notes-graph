...
/*
  ...
  userAvatarKey: https://avatar.notesgraphassets.com/82a5a6f0-xxxx-xxxx-xxxx-0de4be320696-avatar-1733191099480
  userSettingsKey: {
  ...
  subscriptionStatusKey: case(NotesGraphGraphQL.SubscriptionStatus.active)
  subscriptionPlanKey: case(NotesGraphGraphQL.SubscriptionPlan.pro)
  ...
  currentServerBaseUrl: https://canary.notesgraph.com
