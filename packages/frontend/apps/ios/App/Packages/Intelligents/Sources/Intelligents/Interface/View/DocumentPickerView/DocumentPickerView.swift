...
class DocumentPickerView: UIView {
  ...
  private let updateQueue = DispatchQueue(label: "com.notesgraph.documentpicker.update", qos: .userInitiated)
  ...
  lazy var searchIconImageView = UIImageView().then {
    ...
    $0.tintColor = .notesgraphIconPrimary
  ...
  lazy var searchTextField = UITextField().then {
    ...
    $0.textColor = .notesgraphTextPrimary
