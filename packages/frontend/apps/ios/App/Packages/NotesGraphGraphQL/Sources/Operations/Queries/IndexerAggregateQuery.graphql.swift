...
public class IndexerAggregateQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct Workspace: NotesGraphGraphQL.SelectionSet {
      ...
      public struct Aggregate: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.AggregateResultObjectType }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Bucket: NotesGraphGraphQL.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.AggregateBucketObjectType }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          public struct Hits: NotesGraphGraphQL.SelectionSet {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }

            public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.AggregateBucketHitsObjectType }
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
            ...
            public struct Node: NotesGraphGraphQL.SelectionSet {
              ...
              public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.SearchNodeObjectType }
              public static var __selections: [ApolloAPI.Selection] { [
                .field("__typename", String.self),
                .field("fields", NotesGraphGraphQL.JSONObject.self),
                .field("highlights", NotesGraphGraphQL.JSONObject?.self),
              ] }
              public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              ...
              public var fields: NotesGraphGraphQL.JSONObject { __data["fields"] }
              /// The search result fields, see UnionSearchItemObjectType
              public var highlights: NotesGraphGraphQL.JSONObject? { __data["highlights"] }
            }
          }
        }
        ...
        public struct Pagination: NotesGraphGraphQL.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.SearchResultPagination }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            .field("count", Int.self),
