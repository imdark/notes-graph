...
public class ListNotificationsQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct CurrentUser: NotesGraphGraphQL.SelectionSet {
      ...
      public struct Notifications: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.PaginatedNotificationObjectType }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Edge: NotesGraphGraphQL.SelectionSet {
          ...
          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.NotificationObjectTypeEdge }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          public struct Node: NotesGraphGraphQL.SelectionSet {
            ...
            public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.NotificationObjectType }
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
              .field("id", NotesGraphGraphQL.ID.self),
              .field("type", GraphQLEnum<NotesGraphGraphQL.NotificationType>.self),
              .field("level", GraphQLEnum<NotesGraphGraphQL.NotificationLevel>.self),
              .field("read", Bool.self),
              .field("createdAt", NotesGraphGraphQL.DateTime.self),
              .field("updatedAt", NotesGraphGraphQL.DateTime.self),
              .field("body", NotesGraphGraphQL.JSONObject.self),
            ] }
            public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            ...
            public var type: GraphQLEnum<NotesGraphGraphQL.NotificationType> { __data["type"] }
            /// The level of the notification
            public var level: GraphQLEnum<NotesGraphGraphQL.NotificationLevel> { __data["level"] }
            ...
            public var body: NotesGraphGraphQL.JSONObject { __data["body"] }
          }
        }
