...
public class CalendarEventsQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct Workspace: NotesGraphGraphQL.SelectionSet {
      ...
      public struct Calendar: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.WorkspaceCalendarObjectType }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Event: NotesGraphGraphQL.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.CalendarEventObjectType }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            .field("id", String.self),
            ...
            .field("startAtUtc", NotesGraphGraphQL.DateTime.self),
            .field("endAtUtc", NotesGraphGraphQL.DateTime.self),
          ...
          public var startAtUtc: NotesGraphGraphQL.DateTime { __data["startAtUtc"] }
          public var endAtUtc: NotesGraphGraphQL.DateTime { __data["endAtUtc"] }
