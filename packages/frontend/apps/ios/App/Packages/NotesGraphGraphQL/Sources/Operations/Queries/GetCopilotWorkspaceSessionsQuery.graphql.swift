...
public class GetCopilotWorkspaceSessionsQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
      GetCopilotWorkspaceSessionsQuery.Data.self
    ] }
    ...
    public struct CurrentUser: NotesGraphGraphQL.SelectionSet {
      ...
      public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GetCopilotWorkspaceSessionsQuery.Data.CurrentUser.self
      ] }
      ...
      public struct Copilot: NotesGraphGraphQL.SelectionSet {
        ...
        public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GetCopilotWorkspaceSessionsQuery.Data.CurrentUser.Copilot.self
        ] }
        ...
        public struct Chats: NotesGraphGraphQL.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.PaginatedCopilotHistoriesType }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            .fragment(PaginatedCopilotChats.self),
          ] }
          public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GetCopilotWorkspaceSessionsQuery.Data.CurrentUser.Copilot.Chats.self,
