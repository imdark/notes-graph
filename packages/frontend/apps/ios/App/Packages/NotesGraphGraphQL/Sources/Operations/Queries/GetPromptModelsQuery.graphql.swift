  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct CurrentUser: NotesGraphGraphQL.SelectionSet {
      ...
      public struct Copilot: NotesGraphGraphQL.SelectionSet {
        ...
        public struct Models: NotesGraphGraphQL.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.CopilotModelsType }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          public struct OptionalModel: NotesGraphGraphQL.SelectionSet {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }

            public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.CopilotModelType }
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
          ...
          ///
          /// Parent Type: `CopilotModelType`
          public struct ProModel: NotesGraphGraphQL.SelectionSet {
            public let __data: DataDict
            public init(_dataDict: DataDict) { __data = _dataDict }
