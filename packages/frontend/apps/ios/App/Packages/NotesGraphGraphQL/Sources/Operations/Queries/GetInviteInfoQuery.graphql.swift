...
public class GetInviteInfoQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct GetInviteInfo: NotesGraphGraphQL.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.InvitationType }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct Workspace: NotesGraphGraphQL.SelectionSet {
        ...
        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.InvitationWorkspaceType }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
      ...
      ///
      /// Parent Type: `WorkspaceUserType`
      public struct Invitee: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
