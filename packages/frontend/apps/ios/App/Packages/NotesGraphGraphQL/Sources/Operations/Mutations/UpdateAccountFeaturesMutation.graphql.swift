...
public class UpdateAccountFeaturesMutation: GraphQLMutation {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("updateUserFeatures", [GraphQLEnum<NotesGraphGraphQL.FeatureType>].self, arguments: [
        "id": .variable("userId"),
    ...
    public var updateUserFeatures: [GraphQLEnum<NotesGraphGraphQL.FeatureType>] { __data["updateUserFeatures"] }
  }
}
