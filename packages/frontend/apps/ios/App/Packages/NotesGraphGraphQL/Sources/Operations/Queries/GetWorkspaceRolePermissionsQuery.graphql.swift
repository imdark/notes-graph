...
public class GetWorkspaceRolePermissionsQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct WorkspaceRolePermissions: NotesGraphGraphQL.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.WorkspaceRolePermissions }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct Permissions: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.WorkspacePermissions }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
