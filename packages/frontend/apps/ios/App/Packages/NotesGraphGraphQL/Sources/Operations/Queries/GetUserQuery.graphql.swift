...
public class GetUserQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct User: NotesGraphGraphQL.SelectionSet {
      ...
      public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Unions.UserOrLimitedUser }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct AsLimitedUserType: NotesGraphGraphQL.InlineFragment {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public typealias RootEntityType = GetUserQuery.Data.User
        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.LimitedUserType }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("email", String.self),
          .field("hasPassword", Bool?.self),
        ] }
