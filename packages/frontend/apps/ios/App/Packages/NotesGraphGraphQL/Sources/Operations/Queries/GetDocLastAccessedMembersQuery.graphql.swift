  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct Workspace: NotesGraphGraphQL.SelectionSet {
      ...
      public struct Doc: NotesGraphGraphQL.SelectionSet {
        ...
        public struct LastAccessedMembers: NotesGraphGraphQL.SelectionSet {
          public let __data: DataDict
          public init(_dataDict: DataDict) { __data = _dataDict }

          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.PaginatedDocMemberLastAccess }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
          ...
          public struct Edge: NotesGraphGraphQL.SelectionSet {
            ...
            public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.DocMemberLastAccessEdge }
            public static var __selections: [ApolloAPI.Selection] { [
              .field("__typename", String.self),
            ...
            public struct Node: NotesGraphGraphQL.SelectionSet {
              ...
              public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.DocMemberLastAccess }
              public static var __selections: [ApolloAPI.Selection] { [
                .field("__typename", String.self),
