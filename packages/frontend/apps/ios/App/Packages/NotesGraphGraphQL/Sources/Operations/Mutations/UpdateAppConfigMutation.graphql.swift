...
public class UpdateAppConfigMutation: GraphQLMutation {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("updateAppConfig", NotesGraphGraphQL.JSONObject.self, arguments: ["updates": .variable("updates")]),
    ] }
    ...
    public var updateAppConfig: NotesGraphGraphQL.JSONObject { __data["updateAppConfig"] }
  }
}
