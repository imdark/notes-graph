...
public class CalendarAccountsQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct CurrentUser: NotesGraphGraphQL.SelectionSet {
      ...
      public struct CalendarAccount: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        public struct Calendar: NotesGraphGraphQL.SelectionSet {
          ...
          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.CalendarSubscriptionObjectType }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            .field("id", String.self),
            ...
            .field("lastSyncAt", NotesGraphGraphQL.DateTime?.self),
          ] }
          public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          ...
          public var lastSyncAt: NotesGraphGraphQL.DateTime? { __data["lastSyncAt"] }
        }
      }
    }
  }
