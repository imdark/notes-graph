...
public class ValidateConfigQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct ValidateAppConfig: NotesGraphGraphQL.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.AppConfigValidateResult }
      public static var __selections: [ApolloAPI.Selection] { [
        .field("__typename", String.self),
        .field("module", String.self),
        .field("key", String.self),
        .field("value", NotesGraphGraphQL.JSON.self),
      ...
      public var value: NotesGraphGraphQL.JSON { __data["value"] }
