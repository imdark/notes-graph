...
public class AdminWorkspaceQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct AdminWorkspace: NotesGraphGraphQL.SelectionSet {
      ...
      public struct SharedLink: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.AdminWorkspaceSharedLink }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
      ...
      public struct Member: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.AdminWorkspaceMember }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
          .field("id", String.self),
          .field("name", String.self),
          .field("email", String.self),
          .field("avatarUrl", String?.self),
          .field("role", GraphQLEnum<NotesGraphGraphQL.Permission>.self),
          .field("status", GraphQLEnum<NotesGraphGraphQL.WorkspaceMemberStatus>.self),
        ] }
        public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        ...
        public var email: String { __data["email"] }
        public var avatarUrl: String? { __data["avatarUrl"] }
        public var role: GraphQLEnum<NotesGraphGraphQL.Permission> { __data["role"] }
        public var status: GraphQLEnum<NotesGraphGraphQL.WorkspaceMemberStatus> { __data["status"] }
      }
    }
  }
}
