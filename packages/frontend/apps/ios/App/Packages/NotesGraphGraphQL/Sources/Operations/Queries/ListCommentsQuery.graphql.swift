...
public class ListCommentsQuery: GraphQLQuery {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct Workspace: NotesGraphGraphQL.SelectionSet {
      ...
      public struct Comments: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.PaginatedCommentObjectType }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Edge: NotesGraphGraphQL.SelectionSet {
          ...
          public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.CommentObjectTypeEdge }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
