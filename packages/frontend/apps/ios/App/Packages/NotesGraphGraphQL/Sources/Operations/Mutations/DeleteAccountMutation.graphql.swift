...
public class DeleteAccountMutation: GraphQLMutation {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct DeleteAccount: NotesGraphGraphQL.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.DeleteAccount }
      public static var __selections: [ApolloAPI.Selection] { [
