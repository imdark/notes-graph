...
public struct CredentialsRequirements: NotesGraphGraphQL.SelectionSet, Fragment {
  ...
  public struct Password: NotesGraphGraphQL.SelectionSet {
    public let __data: DataDict
    public init(_dataDict: DataDict) { __data = _dataDict }

    public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.PasswordLimitsType }
    public static var __selections: [ApolloAPI.Selection] { [
      .field("__typename", String.self),
