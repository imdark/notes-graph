...
public class CreateBlobUploadMutation: GraphQLMutation {
  ...
  public struct Data: NotesGraphGraphQL.SelectionSet {
    ...
    public struct CreateBlobUpload: NotesGraphGraphQL.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.BlobUploadInit }
      public static var __selections: [ApolloAPI.Selection] { [
        .field("__typename", String.self),
        .field("method", GraphQLEnum<NotesGraphGraphQL.BlobUploadMethod>.self),
        .field("blobKey", String.self),
        .field("alreadyUploaded", Bool?.self),
        .field("uploadUrl", String?.self),
        .field("headers", NotesGraphGraphQL.JSONObject?.self),
      ...
      public var method: GraphQLEnum<NotesGraphGraphQL.BlobUploadMethod> { __data["method"] }
      ...
      public var headers: NotesGraphGraphQL.JSONObject? { __data["headers"] }
      ...
      public struct UploadedPart: NotesGraphGraphQL.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { NotesGraphGraphQL.Objects.BlobUploadedPart }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
