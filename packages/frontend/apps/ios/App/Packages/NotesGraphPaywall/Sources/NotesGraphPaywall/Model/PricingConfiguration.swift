...
enum PricingConfiguration {
  static let proMonthly = ProductConfiguration(
    productIdentifier: "app.notesgraph.pro.Monthly",
    revenueCatIdentifier: "app.notesgraph.pro.Monthly",
    description: "Monthly",
    isDefaultSelected: false
  )

  static let proAnnual = ProductConfiguration(
    productIdentifier: "app.notesgraph.pro.Annual",
    revenueCatIdentifier: "app.notesgraph.pro.Annual",
    description: "Annual",
    badge: "Save 15%",
