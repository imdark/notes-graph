...
@Immutable
data class NotesGraphColorScheme(
...
val notesgraphLightScheme = NotesGraphColorScheme(
    textPrimary = NotesGraphColorTokens.Grey900,
    textSecondary = NotesGraphColorTokens.Grey600,
    textDisable = NotesGraphColorTokens.Grey400,
    textEmphasis = NotesGraphColorTokens.NotesGraph600,
    backgroundPrimary = NotesGraphColorTokens.BaseWhite,
    backgroundSecondary = NotesGraphColorTokens.Grey100,
    backgroundOverlayPanel = NotesGraphColorTokens.Grey50,
    backgroundTertiary = NotesGraphColorTokens.Grey300,
    backgroundCodeBlock = NotesGraphColorTokens.Grey50,
    backgroundModal = NotesGraphColorTokens.TransparentBlack700,
    backgroundSuccess = NotesGraphColorTokens.Emerald50,
    backgroundError = NotesGraphColorTokens.Rose50,
    backgroundWarning = NotesGraphColorTokens.Orange25,
    backgroundProgressing = NotesGraphColorTokens.Indigo50,
    iconPrimary = NotesGraphColorTokens.Grey600,
    iconSecondary = NotesGraphColorTokens.Grey400,
    iconTertiary = NotesGraphColorTokens.Grey300,
    iconDisable = NotesGraphColorTokens.Grey400,
    iconActivated = NotesGraphColorTokens.NotesGraph600,
    divider = NotesGraphColorTokens.TransparentGrey400,
)

val notesgraphDarkScheme = NotesGraphColorScheme(
    textPrimary = NotesGraphColorTokens.Grey200,
    textSecondary = NotesGraphColorTokens.Grey500,
    textDisable = NotesGraphColorTokens.Grey700,
    textEmphasis = NotesGraphColorTokens.NotesGraph500,
    backgroundPrimary = NotesGraphColorTokens.Grey950,
    backgroundSecondary = NotesGraphColorTokens.Grey900,
    backgroundOverlayPanel = NotesGraphColorTokens.Grey900,
    backgroundTertiary = NotesGraphColorTokens.Grey700,
    backgroundCodeBlock = NotesGraphColorTokens.Grey900,
    backgroundModal = NotesGraphColorTokens.TransparentBlack400,
    backgroundSuccess = NotesGraphColorTokens.Emerald950,
    backgroundError = NotesGraphColorTokens.Rose950,
    backgroundWarning = NotesGraphColorTokens.Orange950,
    backgroundProgressing = NotesGraphColorTokens.Indigo950,
    iconPrimary = NotesGraphColorTokens.Grey100,
    iconSecondary = NotesGraphColorTokens.Grey300,
    iconTertiary = NotesGraphColorTokens.Grey700,
    iconDisable = NotesGraphColorTokens.Grey800,
    iconActivated = NotesGraphColorTokens.NotesGraph600,
    divider = NotesGraphColorTokens.TransparentGrey300,
)

val LocalNotesGraphColors = staticCompositionLocalOf { notesgraphLightScheme }

object NotesGraphColorTokens {
    ...
    val NotesGraph25 = Color(0XFFE2F4FF)
    val NotesGraph50 = Color(0XFFCAE9FF)
    val NotesGraph100 = Color(0XFF8FD1FF)
    val NotesGraph200 = Color(0XFF79C8FF)
    val NotesGraph300 = Color(0XFF5EBCFF)
    val NotesGraph400 = Color(0XFF49B1FA)
    val NotesGraph500 = Color(0XFF29A2FA)
    val NotesGraph600 = Color(0XFF1D96EB)
    val NotesGraph700 = Color(0XFF158ADE)
    val NotesGraph800 = Color(0XFF035F9F)
    val NotesGraph900 = Color(0XFF003C67)
    val NotesGraph950 = Color(0XFF002742)
