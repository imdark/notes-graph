...
import app.notesgraph.pro.Prompt
import app.notesgraph.pro.utils.getCurrentServerBaseUrl
import com.notesgraph.pro.graphql.CreateCopilotMessageMutation
import com.notesgraph.pro.graphql.CreateCopilotSessionMutation
import com.notesgraph.pro.graphql.GetCopilotHistoriesQuery
import com.notesgraph.pro.graphql.GetCopilotHistoryIdsQuery
import com.notesgraph.pro.graphql.GetCopilotSessionsQuery
import com.notesgraph.pro.graphql.type.CreateChatMessageInput
import com.notesgraph.pro.graphql.type.CreateChatSessionInput
import com.notesgraph.pro.graphql.type.PaginationInput
import com.notesgraph.pro.graphql.type.QueryChatHistoriesInput
...
class GraphQLService @Inject constructor() {
    ...
    suspend fun createCopilotSession(
        workspaceId: String,
        docId: String,
        prompt: Prompt = Prompt.ChatWithNotesGraphAI
    ) = mutation(
