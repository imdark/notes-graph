...
const log = debug('notesgraph:make-env');
...
const productName = !stableBuild ? `NotesGraph-${buildType}` : 'NotesGraph';
...
const iconUrl = `https://cdn.notesgraph.com/app-icons/icon_${buildType}.ico`;
...
const appIdMap = {
  internal: 'pro.notesgraph.internal',
  canary: 'pro.notesgraph.canary',
  beta: 'pro.notesgraph.beta',
  stable: 'pro.notesgraph.app',
};
