...
import { NOTESGRAPH_API_CHANNEL_NAME } from '../shared/type';
import { authHandlers } from './auth/handlers';
import { byokStorageHandlers } from './byok-storage/handlers';
import { clipboardHandlers } from './clipboard';
import { configStorageHandlers } from './config-storage';
import { doordashHandlers } from './doordash';
import { findInPageHandlers } from './find-in-page';
import { linkCardHandlers } from './link-card';
...
export const registerHandlers = () => {
  ...
  ipcMain.handle(NOTESGRAPH_API_CHANNEL_NAME, async (e, ...args: any[]) => {
    try {
  ...
  ipcMain.on(NOTESGRAPH_API_CHANNEL_NAME, (e, ...args: any[]) => {
