pub(super) const PAGE_FLAVOUR: &str = "notesgraph:page";
pub(super) const NOTE_FLAVOUR: &str = "notesgraph:note";
pub(super) const SURFACE_FLAVOUR: &str = "notesgraph:surface";
