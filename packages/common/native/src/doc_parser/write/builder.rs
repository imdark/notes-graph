...
pub(super) fn block_version(flavour: &str) -> i32 {
  match flavour {
    "notesgraph:page" => 2,
    "notesgraph:surface" => 5,
    "notesgraph:note" => 1,
    "notesgraph:paragraph" => 1,
    "notesgraph:list" => 1,
    "notesgraph:code" => 1,
    "notesgraph:divider" => 1,
    "notesgraph:image" => 1,
    "notesgraph:table" => 1,
    "notesgraph:bookmark" => 1,
    "notesgraph:embed-youtube" => 1,
    "notesgraph:embed-iframe" => 1,
    "notesgraph:callout" => 1,
    _ => 1,
  }
}
