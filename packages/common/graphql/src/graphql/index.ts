...
export const addProjectMemberMutation = {
  id: 'addProjectMemberMutation' as const,
  op: 'addProjectMember',
  query: `mutation addProjectMember($projectId: String!, $userId: String!, $role: ProjectMemberRole) {
  addProjectMember(input: {projectId: $projectId, userId: $userId, role: $role})
}`,
};
...
export const assignDocToProjectMutation = {
  id: 'assignDocToProjectMutation' as const,
  op: 'assignDocToProject',
  query: `mutation assignDocToProject($workspaceId: String!, $docId: String!, $projectId: String!) {
  assignDocToProject(
    input: {workspaceId: $workspaceId, docId: $docId, projectId: $projectId}
  )
}`,
};
...
export const createAnonymousCommentMutation = {
  id: 'createAnonymousCommentMutation' as const,
  op: 'createAnonymousComment',
  query: `mutation createAnonymousComment($input: AnonymousCommentCreateInput!) {
  createAnonymousComment(input: $input) {
    id
    content
    createdAt
    user {
...
export const connectDirectoryAccountMutation = {
  id: 'connectDirectoryAccountMutation' as const,
  op: 'connectDirectoryAccount',
  query: `mutation connectDirectoryAccount($input: ConnectDirectoryAccountInput!) {
  connectDirectoryAccount(input: $input)
}`,
};

export const convertDocToProjectMutation = {
  id: 'convertDocToProjectMutation' as const,
  op: 'convertDocToProject',
  query: `mutation convertDocToProject($input: ConvertDocToProjectInput!) {
  convertDocToProject(input: $input) {
    id
    workspaceId
    name
    createdBy
...
export const createDirectorySyncScopeMutation = {
  id: 'createDirectorySyncScopeMutation' as const,
  op: 'createDirectorySyncScope',
  query: `mutation createDirectorySyncScope($input: CreateDirectorySyncScopeInput!) {
  createDirectorySyncScope(input: $input) {
    id
    directoryAccountId
    projectId
    scopeType
...
export const createProjectMutation = {
  id: 'createProjectMutation' as const,
  op: 'createProject',
  query: `mutation createProject($workspaceId: String!, $name: String!) {
  createProject(input: {workspaceId: $workspaceId, name: $name}) {
    id
    workspaceId
    name
    createdBy
...
export const deleteDirectorySyncScopeMutation = {
  id: 'deleteDirectorySyncScopeMutation' as const,
  op: 'deleteDirectorySyncScope',
  query: `mutation deleteDirectorySyncScope($scopeId: String!) {
  deleteDirectorySyncScope(scopeId: $scopeId)
}`,
};

export const deleteProjectMutation = {
  id: 'deleteProjectMutation' as const,
  op: 'deleteProject',
...
export const directoryAvailableGroupsQuery = {
  id: 'directoryAvailableGroupsQuery' as const,
  op: 'directoryAvailableGroups',
  query: `query directoryAvailableGroups($workspaceId: String!) {
  workspace(id: $workspaceId) {
    directoryAccount {
      id
      availableGroups {
...
export const directoryAvailableOrgUnitsQuery = {
  id: 'directoryAvailableOrgUnitsQuery' as const,
  op: 'directoryAvailableOrgUnits',
  query: `query directoryAvailableOrgUnits($workspaceId: String!) {
  workspace(id: $workspaceId) {
    directoryAccount {
      id
      availableOrgUnits {
...
export const disconnectDirectoryAccountMutation = {
  id: 'disconnectDirectoryAccountMutation' as const,
  op: 'disconnectDirectoryAccount',
  query: `mutation disconnectDirectoryAccount($accountId: String!) {
  disconnectDirectoryAccount(accountId: $accountId)
}`,
};
...
export const publicDocCommentsQuery = {
  id: 'publicDocCommentsQuery' as const,
  op: 'publicDocComments',
  query: `query publicDocComments($workspaceId: String!, $docId: String!, $pagination: PaginationInput) {
  publicDocComments(
    workspaceId: $workspaceId
    docId: $docId
    pagination: $pagination
...
export const publishPageMutation = {
  ...
  op: 'publishPage',
  query: `mutation publishPage($workspaceId: String!, $pageId: String!, $mode: PublicDocMode = Page, $publicRole: DocRole = Reader) {
  publishDoc(
    workspaceId: $workspaceId
    docId: $pageId
    mode: $mode
...
export const removeDocFromProjectMutation = {
  id: 'removeDocFromProjectMutation' as const,
  op: 'removeDocFromProject',
  query: `mutation removeDocFromProject($projectId: String!, $docId: String!) {
  removeDocFromProject(projectId: $projectId, docId: $docId)
}`,
};

export const removeProjectMemberMutation = {
  id: 'removeProjectMemberMutation' as const,
  op: 'removeProjectMember',
  query: `mutation removeProjectMember($projectId: String!, $userId: String!) {
  removeProjectMember(projectId: $projectId, userId: $userId)
}`,
};

export const renameProjectMutation = {
  id: 'renameProjectMutation' as const,
  op: 'renameProject',
...
export const syncDirectoryScopeNowMutation = {
  id: 'syncDirectoryScopeNowMutation' as const,
  op: 'syncDirectoryScopeNow',
  query: `mutation syncDirectoryScopeNow($scopeId: String!) {
  syncDirectoryScopeNow(scopeId: $scopeId)
}`,
};
...
export const workspaceDirectoryAccountQuery = {
  id: 'workspaceDirectoryAccountQuery' as const,
  op: 'workspaceDirectoryAccount',
  query: `query workspaceDirectoryAccount($workspaceId: String!) {
  workspace(id: $workspaceId) {
    directoryAccount {
      id
      provider
...
export const inviteByEmailsMutation = {
  ...
  op: 'inviteByEmails',
  query: `mutation inviteByEmails($workspaceId: String!, $emails: [String!]!, $role: WorkspaceRole) {
...
export const workspaceProjectsQuery = {
  id: 'workspaceProjectsQuery' as const,
  op: 'workspaceProjects',
