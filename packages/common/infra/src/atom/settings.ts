...
const logger = new DebugLogger('notesgraph:settings');
...
export const APP_SETTINGS_STORAGE_KEY = 'notesgraph-settings';
...
const appSettingEffect = atomEffect(get => {
  ...
  if (BUILD_CONFIG.isElectron) {
    ...
    // this api type in @notesgraph/electron-api, but it is circular dependency this package, use any here
