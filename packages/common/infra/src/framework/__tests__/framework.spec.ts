...
describe('framework', () => {
  ...
  test('scope', () => {
    ...
    expect(root.get(SystemService).appName).toEqual('notesgraph');
    ...
    expect(workspaceService.system.appName).toEqual('notesgraph');
    ...
    expect(pageService.system.appName).toEqual('notesgraph');
