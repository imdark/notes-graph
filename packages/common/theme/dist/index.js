import { lightCssVariablesV2 as b, darkCssVariablesV2 as l } from "./v2/index.js";
function x(r) {
  const a = r.replace(/\n/g, "").replace(/[\s]{2,}/g, " ");
...
`), s = (r) => typeof r != "string" ? "" : r.replace(/-/g, "_").replace(/([a-z0-9])([A-Z])/g, "$1-$2").replace(/([A-Z])([A-Z])(?=[a-z])/g, "$1-$2").toLowerCase().replace(/(\D+)(\d+)$/g, "$1-$2").replace(/\s|_/g, "-"), p = (r, a) => `url(${r}), ${a.join(", ")}`, n = (r) => `--notesgraph-${s(r)}`, S = (r) => Object.entries(r), e = "apple-system, BlinkMacSystemFont, 'Helvetica Neue', Tahoma, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji','Segoe UI Symbol', 'Noto Color Emoji'", o = "'Helvetica Neue', Tahoma, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji','Segoe UI Symbol', 'Noto Color Emoji'", i = {
  // font
  ...
  fontCodeFamily: `'IBM Plex Mono', 'Space Mono', Consolas, Menlo, Monaco, Courier, monospace, ${e}`,
  fontTitle: "36px",
  fontH1: "28px",
  fontH2: "26px",
  fontH3: "24px",
  ...
  noteShadowSticker: "0px 6px 16px 0px rgba(0, 0, 0, 0.08), 0px 26px 18px -20px rgba(0, 0, 0, 0.10)",
  noteShadowPaper: "0px 2px 4px 0px rgba(0, 0, 0, 0.05), 0px 0px 0px 10px #FFF, 0px 3px 6px 12px rgba(0, 0, 0, 0.14)",
  ...
  floatButtonShadow2: "0px 4px 4px -2px rgba(15, 15, 15, 0.1), 0px 6px 8px 1px rgba(15, 15, 15, 0.05)",
  ...
  noteShadowSticker: "0px 24px 26px -10px rgba(0, 0, 0, 0.22), 0px 26px 18px -18px rgba(0, 0, 0, 0.52)",
  noteShadowPaper: "0px 2px 4px 0px rgba(0, 0, 0, 0.30), 0px 0px 10px #7A7A7A, 0px 6px 12px rgba(0, 0, 0, 0.40)",
  noteShadowFloat: "0px 0px 32px 0px rgba(0, 0, 0, 0.30), 0px 0px 2px 0px rgba(255, 255, 255, 0.44)",
  ...
  fontSerifFamily: `'Source Serif 4', 'Noto Serif' , serif, 'Cambria', ${o}`,
  fontMonoFamily: `'Source Code Pro', 'IBM Plex Mono', 'Roboto Mono','Noto Sans Mono', 'Noto Sans CJK',  ${o}`,
  fontSansFamily: `'Inter', 'Source Sans 3', Poppins, ${o}`,
  fontNumberFamily: `'Roboto Mono', 'Noto Sans Mono', ${o}`,
  fontCodeFamily: `'IBM Plex Mono', 'Space Mono', Consolas, Menlo, Monaco, Courier, monospace, ${o}`
}, g = (r) => S(r).reduce((a, [t, h]) => ({ ...a, [n(t)]: h }), {}), B = g(w), y = g(k), V = g(m), f = {
  ...B,
  ...b
}, P = {
  ...y,
...
function v(r, a) {
  return `var(${r.startsWith("--") ? r : n(r)}${a ? `, ${a}` : ""})`;
}
export {
  i as baseTheme,
  s as camelToKebab,
  P as combinedDarkCssVariables,
  f as combinedLightCssVariables,
  v as cssVar,
  y as darkCssVariables,
  k as darkTheme,
  B as lightCssVariables,
  w as lightTheme,
  V as printCssVariables,
  m as printTheme,
  M as scopedDarkCssVariables,
  H as scopedLightCssVariables,
  n as themeToVar
};
