...
export class NotesGraphLogger extends ConsoleLogger {
  ...
  override error(
    ...
    super.error(message, NotesGraphLogger.formatStack(stackOrError), context);
  }
}
