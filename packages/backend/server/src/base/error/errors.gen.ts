...
@ObjectType()
class DirectoryProviderRequestErrorDataType {
  @Field() status!: number
  @Field() message!: string
}

export class DirectoryProviderRequestError extends UserFriendlyError {
  constructor(args: DirectoryProviderRequestErrorDataType, message?: string | ((args: DirectoryProviderRequestErrorDataType) => string)) {
    super('internal_server_error', 'directory_provider_request_error', message, args);
  }
}
...
export enum ErrorNames {
  ...
  DIRECTORY_PROVIDER_REQUEST_ERROR,
