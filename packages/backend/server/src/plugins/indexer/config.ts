...
defineModuleConfig('indexer', {
  ...
  'provider.apiKey': {
    ...
    default: '',
    env: ['NOTESGRAPH_INDEXER_SEARCH_API_KEY', 'string'],
  },
  'provider.username': {
