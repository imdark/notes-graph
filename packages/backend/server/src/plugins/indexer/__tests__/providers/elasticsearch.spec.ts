...
const test =
  process.env.NOTESGRAPH_INDEXER_SEARCH_PROVIDER === 'elasticsearch'
    ? _test
    : _test.skip;
  ...
  await searchProvider.write(
    ...
    [
      ...
      },
      {
        ...
        block_id: 'blockId8',
        content:
          'title8 hello hello hello hello hello hello hello hello hello hello, hello hello hello hello hello hello hello hello some link https://linear.app/notesgraph-design/issue/AF-1379/slash-commands-%E6%BF%80%E6%B4%BB%E6%8F%92%E5%85%A5-link-%E7%9A%84%E5%BC%B9%E7%AA%97%E9%87%8C%EF%BC%8C%E8%BE%93%E5%85%A5%E9%93%BE%E6%8E%A5%E4%B9%8B%E5%90%8E%E4%B8%8D%E5%BA%94%E8%AF%A5%E7%9B%B4%E6%8E%A5%E5%AF%B9%E9%93%BE%E6%8E%A5%E8%BF%9B%E8%A1%8C%E5%88%86%E8%AF%8D%E6%90%9C%E7%B4%A2',
        flavour: 'flavour8',
        ref_doc_id: 'docId1',
        ref: [
      ...
      {
        workspace_id: 'workspaceId1',
        doc_id: 'docId2-notesgraph',
        block_id: 'blockId8',
        content: 'NotesGraph 是一个基于云端的笔记应用',
        flavour: 'flavour8',
        ref_doc_id: 'docId1',
        ref: [
          '{"docId":"docId1","mode":"page"}',
    ...
    [
      {
        ...
        flavour_indexed: 'notesgraph:page',
      },
      {
        workspace_id: workspaceId,
        doc_id: 'a',
        ...
        parent_flavour: 'notesgraph:page',
        ...
        created_at: '2025-05-26T05:16:23.128Z',
        updated_at: '2025-05-26T05:15:53.091Z',
        flavour_indexed: 'notesgraph:surface',
        parent_flavour_indexed: 'notesgraph:page',
...
test('should search block table query match url work', async t => {
  let result = await searchProvider.search(SearchTable.block, {
    ...
    query: {
      match: {
        content:
          'https://linear.app/notesgraph-design/issue/AF-1379/slash-commands-%E6%BF%80%E6%B4%BB%E6%8F%92%E5%85%A5-link-%E7%9A%84%E5%BC%B9%E7%AA%97%E9%87%8C%EF%BC%8C%E8%BE%93%E5%85%A5%E9%93%BE%E6%8E%A5%E4%B9%8B%E5%90%8E%E4%B8%8D%E5%BA%94%E8%AF%A5%E7%9B%B4%E6%8E%A5%E5%AF%B9%E9%93%BE%E6%8E%A5%E8%BF%9B%E8%A1%8C%E5%88%86%E8%AF%8D%E6%90%9C%E7%B4%A2',
      },
    },
    fields: [
      'doc_id',
    ...
    [
      {
        ...
        flavour: 'notesgraph:page',
        parent_flavour: 'notesgraph:database',
      ...
      },
      {
        ...
        flavour: 'notesgraph:page',
        parent_flavour: 'notesgraph:database1',
        parent_block_id: 'parentBlockId1',
        ref_doc_id: refDocId1,
        ref: '{"docId":"docId1","mode":"page"}',
        additional: '{"foo": "bar0"}',
      ...
      },
      {
        ...
        flavour: 'notesgraph:text',
        parent_flavour: 'notesgraph:text',
        parent_block_id: 'parentBlockId1',
        ref_doc_id: refDocId1,
        ref: '{"docId":"docId1","mode":"page"}',
        additional: '{"foo": "bar0"}',
        ...
        must: [
          ...
          },
          {
            bool: {
              must: [
                {
                  term: { parent_flavour: { value: 'notesgraph:database' } },
                },
                {
