  ...
  await indexerService.write(
    ...
    [
      ...
      },
      {
        ...
        flavour: 'notesgraph:page',
        refDocId: [docId1],
        ref: ['{"type": "notesgraph:page", "id": "docId1"}'],
      },
      {
        workspaceId: workspace.id,
        docId: docId3,
        ...
        ref: [
          '{"type": "notesgraph:page", "id": "docId2"}',
          '{"type": "notesgraph:page", "id": "docId1"}',
        ],
      },
    ],
    {
