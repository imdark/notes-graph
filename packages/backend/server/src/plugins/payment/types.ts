...
export const DEFAULT_PRICES = new Map([
  ...
  [
    ...
    {
      product: 'NotesGraph Pro Believer',
      price: 49900,
    },
  ],
  // ai
  [
    ...
    { product: 'NotesGraph AI', price: 10680 },
  ],

  // team
  [
    `${SubscriptionPlan.Team}_${SubscriptionRecurring.Monthly}`,
    { product: 'NotesGraph Team(per seat)', price: 1200 },
  ],
  [
    `${SubscriptionPlan.Team}_${SubscriptionRecurring.Yearly}`,
    { product: 'NotesGraph Team(per seat)', price: 12000 },
  ],

  // selfhost team
  [
    `${SubscriptionPlan.SelfHostedTeam}_${SubscriptionRecurring.Monthly}`,
    { product: 'NotesGraph Self-hosted Team(per seat)', price: 1200 },
  ],
  [
    `${SubscriptionPlan.SelfHostedTeam}_${SubscriptionRecurring.Yearly}`,
    { product: 'NotesGraph Self-hosted Team(per seat)', price: 12000 },
  ],
]);
