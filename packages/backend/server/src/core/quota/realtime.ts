...
type UserQuotaStateSnapshot =
  import('@notesgraph/realtime').UserQuotaStateSnapshot;
type WorkspaceQuotaStateSnapshot =
  import('@notesgraph/realtime').WorkspaceQuotaStateSnapshot;

declare module '@notesgraph/realtime' {
