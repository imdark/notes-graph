// This is a totally copy of definitions in [@notesgraph/space-store]
// because currently importing cross workspace package from [@notesgraph/server] is not yet supported
// should be kept updated with the original definitions in [@notesgraph/space-store]
