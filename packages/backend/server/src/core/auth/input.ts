...
export const CLIENT_KIND_HEADER = 'x-notesgraph-client-kind';
export const SESSION_COOKIE_NAME = 'notesgraph_session';
export const USER_COOKIE_NAME = 'notesgraph_user_id';
export const CSRF_COOKIE_NAME = 'notesgraph_csrf_token';
