...
defineModuleConfig('auth', {
  ...
  newAccountShareActionDelay: {
    desc: 'Minimum account age in seconds before new accounts can invite members or create share links. 0 disables this (default) — it is a public-cloud anti-abuse gate and is inappropriate for self-hosted instances, where the just-created admin must be able to share immediately.',
    default: 0,
