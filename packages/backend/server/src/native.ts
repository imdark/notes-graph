...
export const NOTESGRAPH_PRO_PUBLIC_KEY =
  serverNativeModule.NOTESGRAPH_PRO_PUBLIC_KEY;
export const NOTESGRAPH_PRO_LICENSE_AES_KEY =
  serverNativeModule.NOTESGRAPH_PRO_LICENSE_AES_KEY;
...
export const listBoardScopes = serverNativeModule.listBoardScopes;
export const updateTaskBlock = serverNativeModule.updateTaskBlock;
export const updateBlockText = serverNativeModule.updateBlockText;
...
const LLM_STREAM_END_MARKER = '__NOTESGRAPH_LLM_STREAM_END__';
