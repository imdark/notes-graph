...
import { DirectoryAccountModel } from './directory-account';
import { DirectorySyncScopeModel } from './directory-sync-scope';
import { DirectorySyncedUserModel } from './directory-synced-user';
...
const MODELS = {
  ...
  directoryAccount: DirectoryAccountModel,
  directorySyncScope: DirectorySyncScopeModel,
  directorySyncedUser: DirectorySyncedUserModel,
};
...
export * from './directory-account';
export * from './directory-sync-scope';
export * from './directory-synced-user';
export * from './doc';
