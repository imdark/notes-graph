    ...
    >
          ...
          {['Github', 'Twitter', 'Discord', 'Youtube', 'Reddit'].map(
            platform => (
              <td key={platform} style={{ padding: '0 10px' }}>
                <Link href={`https://notesgraph.com/${platform.toLowerCase()}`}>
                  <Img
                    src={`https://cdn.notesgraph.com/mail/2023-8-9/${platform}.png`}
                    alt={`notesgraph ${platform.toLowerCase()} link`}
                    height="16px"
                  />
                </Link>
              </td>
      ...
      <Section align="center" width="auto">
        <Row style={TextStyles}>
          ...
          <td>
            <Img
              src="https://cdn.notesgraph.com/mail/2023-8-9/copyright.png"
              alt="copyright"
              height="14px"
