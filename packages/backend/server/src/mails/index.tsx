...
export const Renderers = {
  //#region Test
  TestMail: make(TestMail, 'Test Email from NotesGraph'),
  //#endregion

  //#region User
  SignIn: make(SignIn, 'Sign in to NotesGraph'),
  SignUp: make(SignUp, 'Your NotesGraph account is waiting for you!'),
  SetPassword: make(SetPassword, 'Set your NotesGraph password'),
  ChangePassword: make(ChangePassword, 'Modify your NotesGraph password'),
  ...
  MemberInvitation: make(
    Invitation,
    'You were invited to join a workspace on NotesGraph'
  ),
  MemberAccepted: make(
    InvitationAccepted,
  ...
  TeamLicense: make(
    TeamLicense,
    'Your NotesGraph Self-Hosted Team Workspace license is ready'
  ),
  //#endregion
} as const;
