...
export default function SignUp(props: SignUpProps) {
  return (
    <Template>
      <Title>Sign up to NotesGraph Cloud</Title>
      <Content>
        <P>You are signing up to NotesGraph. Here is your code:</P>
...
SignUp.PreviewProps = {
  url: 'https://app.notesgraph.com/magic-link?token=123456&email=test@test.com',
  otp: '123456',
};
