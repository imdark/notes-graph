...
fn builtin_from_token(name: &str) -> Option<PromptBuiltin> {
  match name {
    "notesgraph::date" => Some(PromptBuiltin::Date),
    "notesgraph::language" => Some(PromptBuiltin::Language),
    "notesgraph::timezone" => Some(PromptBuiltin::Timezone),
    "notesgraph::hasDocsRef" => Some(PromptBuiltin::HasDocs),
    "notesgraph::hasFilesRef" => Some(PromptBuiltin::HasFiles),
    "notesgraph::hasSelected" => Some(PromptBuiltin::HasSelected),
    "notesgraph::hasCurrentDoc" => Some(PromptBuiltin::HasCurrentDoc),
    _ => None,
  }
}
