...
export const NOTESGRAPH_PRO_LICENSE_AES_KEY: string | undefined | null

export const NOTESGRAPH_PRO_PUBLIC_KEY: string | undefined | null
 ...
 */
export declare function listBoardScopes(docBin: Buffer, docId: string): string
 ...
 * A Buffer containing only the delta (changes) as a y-octo update binary
 */
export declare function updateTaskBlock(existingBinary: Buffer, docId: string, blockId: string, nowNaiveIso: string, status?: string | undefined | null, note?: string | undefined | null, agent?: string | undefined | null): Buffer
 ...
 * A Buffer containing only the delta (changes) as a y-octo update binary
 */
export declare function updateBlockText(existingBinary: Buffer, docId: string, blockId: string, newText: string, nowNaiveIso: string, agent?: string | undefined | null): Buffer
