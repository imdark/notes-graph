...
export const getPublicPath = (BUILD_CONFIG: BUILD_CONFIG_TYPE) => {
  ...
  switch (BUILD_TYPE) {
    case 'stable':
      return 'https://prod.notesgraphassets.com/';
    case 'beta':
      return 'https://beta.notesgraphassets.com/';
    default:
      return 'https://dev.notesgraphassets.com/';
  }
};

const DESCRIPTION = `There can be more than Notion and Miro. NotesGraph is a next-gen knowledge base that brings planning, sorting and creating all together.`;
