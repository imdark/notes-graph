...
test.describe('pasting URLs', () => {
  ...
  test('pasting github pr url', async ({ page }) => {
    ...
    await expect(
      page.locator('notesgraph-embed-edgeless-github-block')
    ).toBeVisible();
  });
  ...
  test('pasting internal link', async ({ page }) => {
    ...
    await expect(
      page.locator('notesgraph-embed-edgeless-linked-doc-block')
    ).toBeVisible();

    await expect(
      page.locator('.notesgraph-embed-linked-doc-content-title')
