...
test('image loading but failed', async ({ page }) => {
  ...
  const title = page.locator(
    '.notesgraph-image-fallback-card .notesgraph-image-fallback-card-title-text'
  );
  ...
  const desc = page.locator(
    '.notesgraph-image-fallback-card .notesgraph-image-fallback-card-description'
  );
...
test('image loading but success', async ({ page }) => {
  ...
  const img = page.locator('.notesgraph-image-container img');
