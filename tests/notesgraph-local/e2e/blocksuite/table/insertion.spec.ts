...
test.describe('Table insertion operations', () => {
  test('should correctly insert columns', async ({ page }) => {
    ...
    const initialCells = table.locator('notesgraph-table-cell');
    ...
    const cellsAfterRightInsert = table.locator('notesgraph-table-cell');
    ...
    const cellsAfterLeftInsert = table.locator('notesgraph-table-cell');
  ...
  test('should correctly insert rows', async ({ page }) => {
    ...
    const cellsAfterBelowInsert = table.locator('notesgraph-table-cell');
    ...
    const cellsAfterAboveInsert = table.locator('notesgraph-table-cell');
