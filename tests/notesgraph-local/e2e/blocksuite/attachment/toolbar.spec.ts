...
import {
  importAttachment,
  importFile,
} from '@notesgraph-test/kit/utils/attachment';
import {
...
test.describe('Replaces attachment', () => {
  test('should replace attachment in page', async ({ page }) => {
    ...
    const attachment = page.locator('notesgraph-attachment').first();
    await attachment.click();

    const name = attachment.locator(
  ...
  test('should replace attachment in edgeless', async ({ page }) => {
    ...
    const attachment = page.locator('notesgraph-edgeless-attachment').first();
    await attachment.click();
