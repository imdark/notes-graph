...
export class EditorUtils {
  ...
  public static async getNoteContent(page: Page) {
    const edgelessNode = await page.waitForSelector(
      'notesgraph-edgeless-note .edgeless-note-page-content'
    );
  ...
  public static async createEdgelessText(page: Page, text: string) {
    ...
    await page
      .locator('notesgraph-edgeless-text')
  ...
  public static async askAIWithCode(
    ...
    await page.locator('notesgraph-code').blur();
    await page.locator('notesgraph-code').hover();
    await page.getByTestId('ask-ai-button').click();
    return {
  ...
  public static async askAIWithImage(
    ...
    await page.locator('notesgraph-slash-menu').getByTestId('Image').click();

    const fileChooser = await fileChooserPromise;
    await fileChooser.setFiles(image);

    await page.locator('notesgraph-page-image').click();
    await page.getByTestId('ask-ai-button').click();
      ...
      generateImage: this.createAction(
        ...
        async () => {
          ...
          const input = page.locator(
            'notesgraph-ai-panel-widget .ai-panel-container textarea'
          );
